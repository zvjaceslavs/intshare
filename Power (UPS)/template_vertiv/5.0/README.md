...
|----|-----------|----------|--------|
|{#DESCR} - CRITICAL|<p>-</p>|<p>**Expression**: {Template-Vertiv:if[{#DESCR}].last()}=6</p><p>**Recovery expression**: </p>|high|
|{#DESCR} - WARNING|<p>-</p>|<p>**Expression**: {Template-Vertiv:if[{#DESCR}].last()}=3</p><p>**Recovery expression**: </p>|average|
|Falha no Retificador|<p>-</p>|<p>**Expression**: {Template-Vertiv:ifFailRectifyer[{#IFDESCR}].last()}<>2</p><p>**Recovery expression**: </p>|high|
|{#DESCR} - CRITICAL (LLD)|<p>-</p>|<p>**Expression**: {Template-Vertiv:if[{#DESCR}].last()}=6</p><p>**Recovery expression**: </p>|high|
|{#DESCR} - WARNING (LLD)|<p>-</p>|<p>**Expression**: {Template-Vertiv:if[{#DESCR}].last()}=3</p><p>**Recovery expression**: </p>|average|
|Falha no Retificador (LLD)|<p>-</p>|<p>**Expression**: {Template-Vertiv:ifFailRectifyer[{#IFDESCR}].last()}<>2</p><p>**Recovery expression**: </p>|high|
