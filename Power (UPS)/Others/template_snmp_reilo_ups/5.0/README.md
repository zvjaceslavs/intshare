...
|----|-----------|----------|--------|
|Bypass voltage on line {#SNMPVALUE} below {$NOMINAL_VOLTAGE}|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsBypassVoltage[{#SNMPVALUE}].max(#2)}<(230*0.9)</p><p>**Recovery expression**: </p>|high|
|Input line {#SNMPVALUE} frequency not {$NOMINAL_FREQUENCY}|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsInputFrequency[{#SNMPVALUE}].min(#2)}>50+1 or {Template SNMP Reillo UPS:upsInputFrequency[{#SNMPVALUE}].max(#2)}<(50-1)</p><p>**Recovery expression**: </p>|high|
|Input line {#SNMPVALUE} voltage below {$NOMINAL_VOLTAGE}|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsInputVoltage[{#SNMPVALUE}].max(#2)}<(230*0.9)</p><p>**Recovery expression**: </p>|high|
|Load of output line {#SNMPVALUE} is over 80%|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsOutputPercentLoad[{#SNMPVALUE}].min(300)}>80 and {Template SNMP Reillo UPS:upsOutputPercentLoad[{#SNMPVALUE}].min(300)}<=90</p><p>**Recovery expression**: </p>|warning|
|Load of output line {#SNMPVALUE} is over 90%|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsOutputPercentLoad[{#SNMPVALUE}].min(300)}>90 and {Template SNMP Reillo UPS:upsOutputPercentLoad[{#SNMPVALUE}].min(300)}<=95</p><p>**Recovery expression**: </p>|average|
|Load of output line {#SNMPVALUE} is over 95%|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsOutputPercentLoad[{#SNMPVALUE}].min(300)}>95</p><p>**Recovery expression**: </p>|high|
|Output line {#SNMPVALUE} voltage below {$NOMINAL_VOLTAGE}|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsOutputVoltage[{#SNMPVALUE}].max(#2)}<(230*0.9)</p><p>**Recovery expression**: </p>|high|
|Load of output line {#SNMPVALUE} is over 80% (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsOutputPercentLoad[{#SNMPVALUE}].min(300)}>80 and {Template SNMP Reillo UPS:upsOutputPercentLoad[{#SNMPVALUE}].min(300)}<=90</p><p>**Recovery expression**: </p>|warning|
|Load of output line {#SNMPVALUE} is over 90% (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsOutputPercentLoad[{#SNMPVALUE}].min(300)}>90 and {Template SNMP Reillo UPS:upsOutputPercentLoad[{#SNMPVALUE}].min(300)}<=95</p><p>**Recovery expression**: </p>|average|
|Load of output line {#SNMPVALUE} is over 95% (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsOutputPercentLoad[{#SNMPVALUE}].min(300)}>95</p><p>**Recovery expression**: </p>|high|
|Output line {#SNMPVALUE} voltage below {$NOMINAL_VOLTAGE} (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsOutputVoltage[{#SNMPVALUE}].max(#2)}<(230*0.9)</p><p>**Recovery expression**: </p>|high|
|Input line {#SNMPVALUE} frequency not {$NOMINAL_FREQUENCY} (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsInputFrequency[{#SNMPVALUE}].min(#2)}>50+1 or {Template SNMP Reillo UPS:upsInputFrequency[{#SNMPVALUE}].max(#2)}<(50-1)</p><p>**Recovery expression**: </p>|high|
|Input line {#SNMPVALUE} voltage below {$NOMINAL_VOLTAGE} (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsInputVoltage[{#SNMPVALUE}].max(#2)}<(230*0.9)</p><p>**Recovery expression**: </p>|high|
|Bypass voltage on line {#SNMPVALUE} below {$NOMINAL_VOLTAGE} (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Reillo UPS:upsBypassVoltage[{#SNMPVALUE}].max(#2)}<(230*0.9)</p><p>**Recovery expression**: </p>|high|
