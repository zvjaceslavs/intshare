...
|XTM Series | clientIfAdminStatus $1 (LLD)|<p>-</p>|`SNMP agent`|clientIfAdminStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Description on interface $1 (LLD)|<p>-</p>|`SNMP agent`|clientIfDescr[{#SNMPVALUE}]<p>Update: 300</p>|
|TM-3000/II Chassis | clientIfLossOfSignal $1 (LLD)|<p>-</p>|`SNMP agent`|clientIfLossOfSignal[{#SNMPVALUE}]<p>Update: 300</p>|
|TM-3000/II Chassis | clientIfName $1 (LLD)|<p>-</p>|`SNMP agent`|clientIfName[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | clientIfOperStatus $1 (LLD)|<p>-</p>|`SNMP agent`|clientIfOperStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | clientIfPowerLevelLowRelativeThreshold $1 (LLD)|<p>-</p>|`SNMP agent`|clientIfPowerLevelLowRelativeThreshold[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | clientIfPowerLevel $1 (LLD)|<p>-</p>|`SNMP agent`|clientIfPowerLevel[{#SNMPVALUE}]<p>Update: 300</p>|
|TM-3000/II Chassis | clientIfReceivedPowerHigh $1 (LLD)|<p>-</p>|`SNMP agent`|clientIfReceivedPowerHigh[{#SNMPVALUE}]<p>Update: 300</p>|
|TM-3000/II Chassis | clientIfReceivedPowerLow on $1 (LLD)|<p>-</p>|`SNMP agent`|clientIfReceivedPowerLow[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | clientIfReceiverSensitivity $1 (LLD)|<p>LUM-CLIENT-MIB::clientIfReceiverSensitivity The lowest power that the receiver is guaranteed to handle, in units of 0.1 dBm.</p>|`SNMP agent`|clientIfReceiverSensitivity[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | clientIfRxSignalStatus $1 (LLD)|<p>-</p>|`SNMP agent`|clientIfRxSignalStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|TM-3000/II Chassis | CU SFP/II | dcnIfDescr $1 (LLD)|<p>-</p>|`SNMP agent`|dcnIfDescr[{#SNMPVALUE}]<p>Update: 3600</p>|
|TM-3000/II Chassis | CU SFP/II | dcnIfName $1 (LLD)|<p>-</p>|`SNMP agent`|dcnIfName[{#SNMPVALUE}]<p>Update: 3600</p>|
|TM-3000/II Chassis | CU SFP/II | dcnIfOperStatus $1 (LLD)|<p>-</p>|`SNMP agent`|dcnIfOperStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|TM-3000/II Chassis | CU SFP/II | dcnIfPowerLevel $1 (LLD)|<p>-</p>|`SNMP agent`|dcnIfPowerLevel[{#SNMPVALUE}]<p>Update: 300</p>|
|TM-3000/II Chassis | CU SFP/II | dcnIfReceivedPowerHigh $1 (LLD)|<p>-</p>|`SNMP agent`|dcnIfReceivedPowerHigh[{#SNMPVALUE}]<p>Update: 300</p>|
|TM-3000/II Chassis | CU SFP/II | dcnIfReceivedPowerLow $1 (LLD)|<p>-</p>|`SNMP agent`|dcnIfReceivedPowerLow[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | CU-SFP/II | Communication Failure on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentBoardCommunicationFailure[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | equipmentBoardName $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentBoardName[{#SNMPVALUE}]<p>Update: 86400</p>|
|XTM Series | equipmentBoardOperStatus $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentBoardOperStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Secondary DC Power Failed on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentBoardSecondaryPowerFailed[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | High Board Temperature on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentBoardTempHighExceeded[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Equipment Board Temp Low Threshold on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentBoardTempLowThreshold[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Equipment Board Temp Low on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentBoardTempLow[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Equipment Board Temp Threshold on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentBoardTempThreshold[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Equipment Board Temp Very High on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentBoardTempVeryHigh[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | equipmentBoardUnderMaintenance $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentBoardUnderMaintenance[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | equipmentFanName $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentFanName[{#SNMPVALUE}]<p>Update: 86400</p>|
|XTM Series | equipmentFanOperStatus $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentFanOperStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | equipmentFanUnitFailed $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentFanUnitFailed[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | equipmentPowerDCPowerFailedSeverity $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentPowerDCPowerFailedSeverity[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | equipmentPowerDCPowerFailed $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentPowerDCPowerFailed[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | equipmentPowerName $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentPowerName[{#SNMPVALUE}]<p>Update: 86400</p>|
|XTM Series | equipmentPowerOperStatus $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentPowerOperStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | equipmentPowerType $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentPowerType[{#SNMPVALUE}]<p>Update: 86400</p>|
|XTM Series | equipmentSubrackName $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentSubrackName[{#SNMPVALUE}]<p>Update: 86400</p>|
|XTM Series | equipmentSubrackOperStatus on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentSubrackOperStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | equipmentSubrackTempHighExceeded on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentSubrackTempHighExceeded[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Equipment Subrack Temperature Threshold on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentSubrackTempThreshold[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Equipment Subrack Temperature on $1 (LLD)|<p>-</p>|`SNMP agent`|equipmentSubrackTemp[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | MES Error Propagation Fault on $1 (LLD)|<p>-</p>|`SNMP agent`|mesErrorPropFault[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Adminintrative State for the interface  $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfAdminStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA interface Description for $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfDescr[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Laser Bias High on $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfLaserBiasHigh[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Loss Of Signal on $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfLossOfSignal[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA interface $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfName.me[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Operational State for the interface  $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfOperStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Output Power Fail on $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfOutputPowerFail[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Pump Laser Temp Low on $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfPumpLaserTempLow[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Received Power Low on $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfReceivedPowerLow[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Rx Power Level Low Threshold on $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfRxPowerLevelLowThreshold[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Rx power level on $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfRxPowerLevel[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Saturation Fault on $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfSaturationFault[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Tx Power Level Low Threshold on $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfTxPowerLevelLowThreshold[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | OA Tx power level on $1 (LLD)|<p>-</p>|`SNMP agent`|oaIfTxPowerLevel[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Rx Ethernet Traffic Data on $1 (LLD)|<p>-</p>|`SNMP agent`|pmEthTdCurrentContRxOctets[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Tx Ethernet Traffic Data on $1 (LLD)|<p>-</p>|`SNMP agent`|pmEthTdCurrentContTxOctets[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | pmEthTdName $1 (LLD)|<p>-</p>|`SNMP agent`|pmEthTdName[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | pmIfAdminStatus $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfAdminStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | pmIfName $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfName[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | pmIfOperStatus $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfOperStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | pmIfRx24hCurrentUAS on $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfRx24hCurrentUAS[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | pmIfRx24hUASThreshold on $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfRx24hUASThreshold[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | pmIfRx24hUAS on $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfRx24hUAS[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Rx Power Level on $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfRxPowerLevel[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | pmIfTx24hCurrentUAS on $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfTx24hCurrentUAS[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | pmIfTx24hUASThreshold on $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfTx24hUASThreshold[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | pmIfTx24hUAS on $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfTx24hUAS[{#SNMPVALUE}]<p>Update: 300</p>|
|XTM Series | Tx Power Level on $1 (LLD)|<p>-</p>|`SNMP agent`|pmIfTxPowerLevel[{#SNMPVALUE}]<p>Update: 300</p>|
## Triggers
