...
|----|-----------|----------|--------|
|{HOST.NAME} unit {#SNMPVALUE} - 1st fan failed|<p>-</p>|<p>**Expression**: {Template SNMP D-link DGS-3120-xx:swFanSpeed.1.[{#SNMPVALUE}].max(30m)}=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} unit {#SNMPVALUE} - 2nd fan failed|<p>-</p>|<p>**Expression**: {Template SNMP D-link DGS-3120-xx:swFanSpeed.2.[{#SNMPVALUE}].max(30m)}=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} unit {#SNMPVALUE} - temperature high|<p>-</p>|<p>**Expression**: {Template SNMP D-link DGS-3120-xx:swTemperatureCurrent[{#SNMPVALUE}].avg(#3)}=40</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} unit {#SNMPVALUE} - 1st fan failed (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP D-link DGS-3120-xx:swFanSpeed.1.[{#SNMPVALUE}].max(30m)}=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} unit {#SNMPVALUE} - 2nd fan failed (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP D-link DGS-3120-xx:swFanSpeed.2.[{#SNMPVALUE}].max(30m)}=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} unit {#SNMPVALUE} - temperature high (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP D-link DGS-3120-xx:swTemperatureCurrent[{#SNMPVALUE}].avg(#3)}=40</p><p>**Recovery expression**: </p>|high|
