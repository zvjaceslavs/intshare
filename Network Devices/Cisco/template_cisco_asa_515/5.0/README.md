...
|{#ENT_NAME}: Hardware serial number (LLD)|<p>MIB: ENTITY-MIB</p>|`SNMP agent`|system.hw.serialnumber[entPhysicalSerialNum.{#SNMPINDEX}]<p>Update: 30s</p>|
|Interface {#IFNAME}({#IFALIAS}): Duplex status (LLD)|<p>MIB: EtherLike-MIB The current mode of operation of the MAC entity. 'unknown' indicates that the current duplex mode could not be determined. Management control of the duplex mode is accomplished through the MAU MIB. When an interface does not support autonegotiation, or when autonegotiation is not enabled, the duplex mode is controlled using ifMauDefaultType. When autonegotiation is supported and enabled, duplex mode is controlled using ifMauAutoNegAdvertisedBits. In either case, the currently operating duplex mode is reflected both in this object and in ifMauType. Note that this object provides redundant information with ifMauType. Normally, redundant objects are discouraged. However, in this instance, it allows a management application to determine the duplex status of an interface without having to know every possible value of ifMauType. This was felt to be sufficiently valuable to justify the redundancy. Reference: [IEEE 802.3 Std.], 30.3.1.1.32,aDuplexStatus.</p>|`SNMP agent`|net.if.duplex[dot3StatsDuplexStatus.{#SNMPINDEX}]<p>Update: 30s</p>|
|{#SNMPVALUE}: CPU utilization (LLD)|<p>MIB: CISCO-PROCESS-MIB The overall CPU busy percentage in the last 5 minute period. This object deprecates the avgBusy5 object from the OLD-CISCO-SYSTEM-MIB. This object is deprecated by cpmCPUTotal5minRev which has the changed range of value (0..100) Reference: http://www.cisco.com/c/en/us/support/docs/ip/simple-network-management-protocol-snmp/15215-collect-cpu-util-snmp.html</p>|`SNMP agent`|system.cpu.util[cpmCPUTotal5min.{#SNMPINDEX}]<p>Update: 30s</p>|
|{#SENSOR_INFO}: Fan status (LLD)|<p>MIB: CISCO-ENVMON-MIB</p>|`SNMP agent`|sensor.fan.status[ciscoEnvMonFanState.{#SNMPINDEX}]<p>Update: 30s</p>|
|$1 AdminStatus (LLD)|<p>The desired state of the interface.</p>|`SNMP agent`|ifAdminStatus[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 Description (LLD)|<p>A textual string containing information about the interface. This string should include the name of the manufacturer, the product name and the version of the interface hardware/software.</p>|`SNMP agent`|ifDescr[{#SNMPVALUE}]<p>Update: 3600</p>|
|$1 InBroadcastPkts (LLD)|<p>-</p>|`SNMP agent`|ifInBroadcastPkts[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 InErrors (LLD)|<p>For packet-oriented interfaces, the number of inbound packets that contained errors preventing them from being deliverable to a higher-layer protocol. For character-oriented or fixed-length interfaces, the number of inbound transmission units that contained errors preventing them from being deliverable to a higher-layer protocol.</p>|`SNMP agent`|ifInErrors[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 InMulticastPkts (LLD)|<p>-</p>|`SNMP agent`|ifInMulticastPkts[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 InOctets (LLD)|<p>The number of octets in valid MAC frames received on this interface, including the MAC header and FCS.</p>|`SNMP agent`|ifInOctets[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 InUcastPkts (LLD)|<p>-</p>|`SNMP agent`|ifInUcastPkts[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 OperStatus (LLD)|<p>The current operational state of the interface.</p>|`SNMP agent`|ifOperStatus[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 OutBroadcastPkts (LLD)|<p>-</p>|`SNMP agent`|ifOutBroadcastPkts[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 OutErrors (LLD)|<p>For packet-oriented interfaces, the number of outbound packets that could not be transmitted because of errors. For character-oriented or fixed-length interfaces, the number of outbound transmission units that could not be transmitted because of errors.</p>|`SNMP agent`|ifOutErrors[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 OutMulticastPkts (LLD)|<p>-</p>|`SNMP agent`|ifOutMulticastPkts[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 OutOctets (LLD)|<p>The number of octets transmitted in MAC frames on this interface, including the MAC header and FCS.</p>|`SNMP agent`|ifOutOctets[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 OutUcastPkts (LLD)|<p>-</p>|`SNMP agent`|ifOutUcastPkts[{#SNMPVALUE}]<p>Update: 60</p>|
|$1 Speed (LLD)|<p>-</p>|`SNMP agent`|ifSpeed[{#SNMPVALUE}]<p>Update: 60</p>|
|{#SENSOR_INFO}: Power supply status (LLD)|<p>MIB: CISCO-ENVMON-MIB</p>|`SNMP agent`|sensor.psu.status[ciscoEnvMonSupplyState.{#SNMPINDEX}]<p>Update: 30s</p>|
|{#SNMPVALUE}: Temperature status (LLD)|<p>MIB: CISCO-ENVMON-MIB The current state of the test point being instrumented.</p>|`SNMP agent`|sensor.temp.status[ciscoEnvMonTemperatureState.{#SNMPINDEX}]<p>Update: 180s</p>|
|{#SNMPVALUE}: Temperature (LLD)|<p>MIB: CISCO-ENVMON-MIB The current measurement of the test point being instrumented.</p>|`SNMP agent`|sensor.temp.value[ciscoEnvMonTemperatureValue.{#SNMPINDEX}]<p>Update: 180s</p>|
## Triggers

|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|{#SNMPVALUE}: High CPU utilization|<p>Last value: {ITEM.LASTVALUE1}.</p>|<p>**Expression**: {Template Cisco ASA 515:system.cpu.util[cpmCPUTotal5min.{#SNMPINDEX}].avg(5m)}>{$CPU_UTIL_MAX}</p><p>**Recovery expression**: </p>|high|
|{#ENT_NAME}: Device has been replaced (new serial number received)|<p>Last value: {ITEM.LASTVALUE1}. Device serial number has changed. Ack to close</p>|<p>**Expression**: {Template Cisco ASA 515:system.hw.serialnumber[entPhysicalSerialNum.{#SNMPINDEX}].diff()}=1 and {Template Cisco ASA 515:system.hw.serialnumber[entPhysicalSerialNum.{#SNMPINDEX}].strlen()}>0</p><p>**Recovery expression**: </p>|information|
|{#SENSOR_INFO}: Fan is in critical state|<p>Last value: {ITEM.LASTVALUE1}. Please check the fan unit</p>|<p>**Expression**: {Template Cisco ASA 515:sensor.fan.status[ciscoEnvMonFanState.{#SNMPINDEX}].count(#1,{$FAN_CRIT_STATUS:"critical"},eq)}=1 or {Template Cisco ASA 515:sensor.fan.status[ciscoEnvMonFanState.{#SNMPINDEX}].count(#1,{$FAN_CRIT_STATUS:"shutdown"},eq)}=1</p><p>**Recovery expression**: </p>|disaster|
|{#SENSOR_INFO}: Fan is in warning state|<p>Last value: {ITEM.LASTVALUE1}. Please check the fan unit</p>|<p>**Expression**: {Template Cisco ASA 515:sensor.fan.status[ciscoEnvMonFanState.{#SNMPINDEX}].count(#1,{$FAN_WARN_STATUS:"warning"},eq)}=1 or {Template Cisco ASA 515:sensor.fan.status[ciscoEnvMonFanState.{#SNMPINDEX}].count(#1,{$FAN_WARN_STATUS:"notFunctioning"},eq)}=1</p><p>**Recovery expression**: </p>|warning|
|Errors on {#SNMPVALUE}|<p>More than 100 in/out errors detected on {#SNMPVALUE}</p>|<p>**Expression**: {Template Cisco ASA 515:ifInErrors[{#SNMPVALUE}].last(0)}>100 or {Template Cisco ASA 515:ifOutErrors[{#SNMPVALUE}].last(0)}>100</p><p>**Recovery expression**: </p>|warning|
|Interface {#IFNAME}({#IFALIAS}): In half-duplex mode|<p>Last value: {ITEM.LASTVALUE1}. Please check autonegotiation settings and cabling</p>|<p>**Expression**: {Template Cisco ASA 515:net.if.duplex[dot3StatsDuplexStatus.{#SNMPINDEX}].last()}=2</p><p>**Recovery expression**: </p>|high|
|{#SENSOR_INFO}: Power supply is in critical state|<p>Last value: {ITEM.LASTVALUE1}. Please check the power supply unit for errors</p>|<p>**Expression**: {Template Cisco ASA 515:sensor.psu.status[ciscoEnvMonSupplyState.{#SNMPINDEX}].count(#1,{$PSU_CRIT_STATUS:"critical"},eq)}=1 or {Template Cisco ASA 515:sensor.psu.status[ciscoEnvMonSupplyState.{#SNMPINDEX}].count(#1,{$PSU_CRIT_STATUS:"shutdown"},eq)}=1</p><p>**Recovery expression**: </p>|disaster|
|{#SENSOR_INFO}: Power supply is in warning state|<p>Last value: {ITEM.LASTVALUE1}. Please check the power supply unit for errors</p>|<p>**Expression**: {Template Cisco ASA 515:sensor.psu.status[ciscoEnvMonSupplyState.{#SNMPINDEX}].count(#1,{$PSU_WARN_STATUS:"warning"},eq)}=1 or {Template Cisco ASA 515:sensor.psu.status[ciscoEnvMonSupplyState.{#SNMPINDEX}].count(#1,{$PSU_WARN_STATUS:"notFunctioning"},eq)}=1</p><p>**Recovery expression**: </p>|warning|
|{#SNMPVALUE}: Temperature is above critical threshold: >{$TEMP_CRIT:""}|<p>Last value: {ITEM.LASTVALUE1}. This trigger uses temperature sensor values as well as temperature sensor status if available</p>|<p>**Expression**: {Template Cisco ASA 515:sensor.temp.value[ciscoEnvMonTemperatureValue.{#SNMPINDEX}].avg(5m)}>{$TEMP_CRIT:""} or {Template Cisco ASA 515:sensor.temp.status[ciscoEnvMonTemperatureState.{#SNMPINDEX}].last(0)}={$TEMP_CRIT_STATUS} or {Template Cisco ASA 515:sensor.temp.status[ciscoEnvMonTemperatureState.{#SNMPINDEX}].last(0)}={$TEMP_DISASTER_STATUS}</p><p>**Recovery expression**: {Template Cisco ASA 515:sensor.temp.value[ciscoEnvMonTemperatureValue.{#SNMPINDEX}].max(5m)}<{$TEMP_CRIT:""}-3</p>|disaster|
|{#SNMPVALUE}: Temperature is above warning threshold: >{$TEMP_WARN:""}|<p>Last value: {ITEM.LASTVALUE1}. This trigger uses temperature sensor values as well as temperature sensor status if available</p>|<p>**Expression**: {Template Cisco ASA 515:sensor.temp.value[ciscoEnvMonTemperatureValue.{#SNMPINDEX}].avg(5m)}>{$TEMP_WARN:""} or {Template Cisco ASA 515:sensor.temp.status[ciscoEnvMonTemperatureState.{#SNMPINDEX}].last(0)}={$TEMP_WARN_STATUS}</p><p>**Recovery expression**: {Template Cisco ASA 515:sensor.temp.value[ciscoEnvMonTemperatureValue.{#SNMPINDEX}].max(5m)}<{$TEMP_WARN:""}-3</p>|warning|
|{#SNMPVALUE}: Temperature is too low: <{$TEMP_CRIT_LOW:""}|<p>Last value: {ITEM.LASTVALUE1}.</p>|<p>**Expression**: {Template Cisco ASA 515:sensor.temp.value[ciscoEnvMonTemperatureValue.{#SNMPINDEX}].avg(5m)}<{$TEMP_CRIT_LOW:""}</p><p>**Recovery expression**: {Template Cisco ASA 515:sensor.temp.value[ciscoEnvMonTemperatureValue.{#SNMPINDEX}].min(5m)}>{$TEMP_CRIT_LOW:""}+3</p>|average|
|{#ENT_NAME}: Device has been replaced (new serial number received) (LLD)|<p>Last value: {ITEM.LASTVALUE1}. Device serial number has changed. Ack to close</p>|<p>**Expression**: {Template Cisco ASA 515:system.hw.serialnumber[entPhysicalSerialNum.{#SNMPINDEX}].diff()}=1 and {Template Cisco ASA 515:system.hw.serialnumber[entPhysicalSerialNum.{#SNMPINDEX}].strlen()}>0</p><p>**Recovery expression**: </p>|information|
|Interface {#IFNAME}({#IFALIAS}): In half-duplex mode (LLD)|<p>Last value: {ITEM.LASTVALUE1}. Please check autonegotiation settings and cabling</p>|<p>**Expression**: {Template Cisco ASA 515:net.if.duplex[dot3StatsDuplexStatus.{#SNMPINDEX}].last()}=2</p><p>**Recovery expression**: </p>|high|
|{#SNMPVALUE}: High CPU utilization (LLD)|<p>Last value: {ITEM.LASTVALUE1}.</p>|<p>**Expression**: {Template Cisco ASA 515:system.cpu.util[cpmCPUTotal5min.{#SNMPINDEX}].avg(5m)}>{$CPU_UTIL_MAX}</p><p>**Recovery expression**: </p>|high|
...
|Errors on {#SNMPVALUE} (LLD)|<p>More than 100 in/out errors detected on {#SNMPVALUE}</p>|<p>**Expression**: {Template Cisco ASA 515:ifInErrors[{#SNMPVALUE}].last(0)}>100 or {Template Cisco ASA 515:ifOutErrors[{#SNMPVALUE}].last(0)}>100</p><p>**Recovery expression**: </p>|warning|
