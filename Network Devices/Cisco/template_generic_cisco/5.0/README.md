...
|Device Model Name at OID [{#SNMPINDEX}] (LLD)|<p>-</p>|`SNMP agent`|modelName[{#SNMPINDEX}]<p>Update: 1d</p>|
|Device Serial Number at OID [{#SNMPINDEX}] (LLD)|<p>-</p>|`SNMP agent`|SerialNumber[{#SNMPINDEX}]<p>Update: 1d</p>|
## Triggers
