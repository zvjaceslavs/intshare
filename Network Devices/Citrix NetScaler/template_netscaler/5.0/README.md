...
This template allows to monitor Citrix Netscaler load-balancers. It uses SNMP and low-level discovery to discover services, vservers and interfaces.


It requires the following value mappings :




| [Netscaler haCurState](https://zabbix/adm.valuemapping.php?form=update&valuemapid=75&sid=f8a763efbdf5da9c) | 3 ⇒ Up |
| [Netscaler haCurStatus](https://zabbix/adm.valuemapping.php?form=update&valuemapid=76&sid=f8a763efbdf5da9c) | 0 ⇒ No1 ⇒ Yes2 ⇒ No |
