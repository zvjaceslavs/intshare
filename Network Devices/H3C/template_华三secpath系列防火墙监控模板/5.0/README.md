...
|并发会话数 CPU[{#SNMPINDEX}] (LLD)|<p>-</p>|`SNMP agent`|CurrentSessionNumber.[{#SNMPINDEX}]<p>Update: 3m</p>|
|其他新建会话速率 CPU[{#SNMPINDEX}] (LLD)|<p>-</p>|`SNMP agent`|OtherSessionCreatedRate.[{#SNMPINDEX}]<p>Update: 3m</p>|
|其他并发会话数 CPU[{#SNMPINDEX}] (LLD)|<p>-</p>|`SNMP agent`|OtherSessionNumber.[{#SNMPINDEX}]<p>Update: 3m</p>|
|新建会话速率 CPU[{#SNMPINDEX}] (LLD)|<p>-</p>|`SNMP agent`|SessionCreatedRate.[{#SNMPINDEX}]<p>Update: 3m</p>|
|TCP新建会话速率 CPU[{#SNMPINDEX}] (LLD)|<p>-</p>|`SNMP agent`|TCPSessionCreatedRate[{#SNMPINDEX}]<p>Update: 3m</p>|
|TCP并发会话数 CPU[{#SNMPINDEX}] (LLD)|<p>-</p>|`SNMP agent`|TCPSessionNumber.[{#SNMPINDEX}]<p>Update: 3m</p>|
|UDP新建会话速率 CPU[{#SNMPINDEX}] (LLD)|<p>-</p>|`SNMP agent`|UDPSessionCreatedRate.[{#SNMPINDEX}]<p>Update: 3m</p>|
|UDP并发会话数 CPU[{#SNMPINDEX}] (LLD)|<p>-</p>|`SNMP agent`|UDPSessionNumber.[{#SNMPINDEX}]<p>Update: 3m</p>|
