...
|Admin status of interface $1 (LLD)|<p>The desired state of the interface.</p>|`SNMP agent`|onuifAdminStatus[{#SNMPVALUE}]<p>Update: 60</p>|
|Alias of interface $1 (LLD)|<p>-</p>|`SNMP agent`|onuifAlias[{#SNMPVALUE}]<p>Update: 3600</p>|
|Description of interface $1 (LLD)|<p>A textual string containing information about the interface. This string should include the name of the manufacturer, the product name and the version of the interface hardware/software.</p>|`SNMP agent`|onuifDescr[{#SNMPVALUE}]<p>Update: 3600</p>|
...
|Incoming traffic on interface $1 (LLD)|<p>The number of octets in valid MAC frames received on this interface, including the MAC header and FCS.</p>|`SNMP agent`|onuifInOctets[{#SNMPVALUE}]<p>Update: 60</p>|
|Power RX on $1 (LLD)|<p>Values of power reported by the ONU.</p>|`SNMP agent`|onuIfOnuPowerRx[{#SNMPVALUE}]<p>Update: 60</p>|
|Power TX on $1 (LLD)|<p>Values of power reported by the ONU.</p>|`SNMP agent`|onuIfOnuPowerTx[{#SNMPVALUE}]<p>Update: 60</p>|
|Operational status of interface $1 (LLD)|<p>The current operational state of the interface.</p>|`SNMP agent`|onuifOperStatus[{#SNMPVALUE}]<p>Update: 60</p>|
...
|Outgoing traffic on interface $1 (LLD)|<p>The number of octets transmitted in MAC frames on this interface, including the MAC header and FCS.</p>|`SNMP agent`|onuifOutOctets[{#SNMPVALUE}]<p>Update: 60</p>|
## Triggers
