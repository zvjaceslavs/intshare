...
|----|-----------|----------|--------|
|Interface {#IFNAME}({#IFALIAS}): Link down|<p>-</p>|<p>**Expression**: ({aa Template SNMP Mikrotik RB2011UiAS:net.if.status[ifOperStatus.{#SNMPINDEX}].last()}=2 and {aa Template SNMP Mikrotik RB2011UiAS:net.if.status[ifOperStatus.{#SNMPINDEX}].diff()}=1)</p><p>**Recovery expression**: </p>|average|
|Interface {#IFNAME}({#IFALIAS}): Link down (LLD)|<p>-</p>|<p>**Expression**: ({aa Template SNMP Mikrotik RB2011UiAS:net.if.status[ifOperStatus.{#SNMPINDEX}].last()}=2 and {aa Template SNMP Mikrotik RB2011UiAS:net.if.status[ifOperStatus.{#SNMPINDEX}].diff()}=1)</p><p>**Recovery expression**: </p>|average|
