...
|Fan #{#FANINDEX} rpm (LLD)|<p>-</p>|`SNMP agent`|pico.fan.rpm.[{#FANINDEX}]<p>Update: 5m</p>|
|Fan #{#FANINDEX} Status (LLD)|<p>-</p>|`SNMP agent`|pico.fan.status.[{#FANINDEX}]<p>Update: 5m</p>|
|NAPT Cache Creates - {#IFNAME} (LLD)|<p>-</p>|`SNMP agent`|naptCache.creates.[{#IFNAME}]<p>Update: 1m</p>|
|NAPT Cache Entries - {#IFNAME} (LLD)|<p>-</p>|`SNMP agent`|naptCache.entries.[{#IFNAME}]<p>Update: 1m</p>|
|NAPT Cache Overflows - {#IFNAME} (LLD)|<p>-</p>|`SNMP agent`|naptCache.overflows.[{#IFNAME}]<p>Update: 1m</p>|
|NAPT Cache Peak - {#IFNAME} (LLD)|<p>-</p>|`SNMP agent`|naptCache.peak.[{#IFNAME}]<p>Update: 1m</p>|
