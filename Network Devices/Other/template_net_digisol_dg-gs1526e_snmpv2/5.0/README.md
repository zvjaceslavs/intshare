...
|----|-----------|----------|--------|
|Interface {#IFNAME}({#IFALIAS}): Ethernet has changed to lower speed than it was before|<p>This Ethernet connection has transitioned down from its known maximum speed. This might be a sign of autonegotiation issues. Ack to close.</p>|<p>**Expression**: {Template Net Digisol DG-GS1526E SNMPv2:net.if.speed[ifSpeed.{#SNMPINDEX}].change()}<0 and {Template Net Digisol DG-GS1526E SNMPv2:net.if.speed[ifSpeed.{#SNMPINDEX}].last()}>0 and ( {Template Net Digisol DG-GS1526E SNMPv2:net.if.type[ifType.{#SNMPINDEX}].last()}=6 or {Template Net Digisol DG-GS1526E SNMPv2:net.if.type[ifType.{#SNMPINDEX}].last()}=7 or {Template Net Digisol DG-GS1526E SNMPv2:net.if.type[ifType.{#SNMPINDEX}].last()}=11 or {Template Net Digisol DG-GS1526E SNMPv2:net.if.type[ifType.{#SNMPINDEX}].last()}=62 or {Template Net Digisol DG-GS1526E SNMPv2:net.if.type[ifType.{#SNMPINDEX}].last()}=69 or {Template Net Digisol DG-GS1526E SNMPv2:net.if.type[ifType.{#SNMPINDEX}].last()}=117 ) and ({Template Net Digisol DG-GS1526E SNMPv2:net.if.status[ifOperStatus.{#SNMPINDEX}].last()}<>2)</p><p>**Recovery expression**: ({Template Net Digisol DG-GS1526E SNMPv2:net.if.speed[ifSpeed.{#SNMPINDEX}].change()}>0 and {Template Net Digisol DG-GS1526E SNMPv2:net.if.speed[ifSpeed.{#SNMPINDEX}].prev()}>0) or ({Template Net Digisol DG-GS1526E SNMPv2:net.if.status[ifOperStatus.{#SNMPINDEX}].last()}=2)</p>|information|
|Interface {#IFNAME}({#IFALIAS}): High bandwidth usage ( > {$IF.UTIL.MAX:"{#IFNAME}"}% )|<p>The network interface utilization is close to its estimated maximum bandwidth.</p>|<p>**Expression**: ({Template Net Digisol DG-GS1526E SNMPv2:net.if.in[ifInOctets.{#SNMPINDEX}].avg(15m)}>(95/100)*{Template Net Digisol DG-GS1526E SNMPv2:net.if.speed[ifSpeed.{#SNMPINDEX}].last()} or {Template Net Digisol DG-GS1526E SNMPv2:net.if.out[ifOutOctets.{#SNMPINDEX}].avg(15m)}>(95/100)*{Template Net Digisol DG-GS1526E SNMPv2:net.if.speed[ifSpeed.{#SNMPINDEX}].last()}) and {Template Net Digisol DG-GS1526E SNMPv2:net.if.speed[ifSpeed.{#SNMPINDEX}].last()}>0</p><p>**Recovery expression**: {Template Net Digisol DG-GS1526E SNMPv2:net.if.in[ifInOctets.{#SNMPINDEX}].avg(15m)}<((95-3)/100)*{Template Net Digisol DG-GS1526E SNMPv2:net.if.speed[ifSpeed.{#SNMPINDEX}].last()} and {Template Net Digisol DG-GS1526E SNMPv2:net.if.out[ifOutOctets.{#SNMPINDEX}].avg(15m)}<((95-3)/100)*{Template Net Digisol DG-GS1526E SNMPv2:net.if.speed[ifSpeed.{#SNMPINDEX}].last()}</p>|warning|
...
|Interface {#IFNAME}({#IFALIAS}): In half-duplex mode|<p>Check autonegotiation settings and cabling</p>|<p>**Expression**: {Template Net Digisol DG-GS1526E SNMPv2:net.if.duplex[dot3StatsDuplexStatus.{#SNMPINDEX}].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Interface {#IFNAME}({#IFALIAS}): In half-duplex mode (LLD)|<p>Check autonegotiation settings and cabling</p>|<p>**Expression**: {Template Net Digisol DG-GS1526E SNMPv2:net.if.duplex[dot3StatsDuplexStatus.{#SNMPINDEX}].last()}=2</p><p>**Recovery expression**: </p>|warning|
