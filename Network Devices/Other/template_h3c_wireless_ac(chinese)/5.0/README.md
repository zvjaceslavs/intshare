...
|----|-----------|----------|--------|
|AP {#APNAME} 一天不在线|<p>-</p>|<p>**Expression**: {Template Device H3C AC:ap.onlinetime[{#APNAME}].max(1d)}=0</p><p>**Recovery expression**: </p>|average|
|AC 地址池 {#DHCPPOOL} 快满|<p>地址池 {#DHCPPOOL} 使用率超过{$DHCP_POOL_H}%</p>|<p>**Expression**: {Template Device H3C AC:dhcp.pool[{#DHCPPOOL}].last()}>95</p><p>**Recovery expression**: </p>|high|
|AC 地址池 {#DHCPPOOL} 快满 (LLD)|<p>地址池 {#DHCPPOOL} 使用率超过{$DHCP_POOL_H}%</p>|<p>**Expression**: {Template Device H3C AC:dhcp.pool[{#DHCPPOOL}].last()}>95</p><p>**Recovery expression**: </p>|high|
|AP {#APNAME} 一天不在线 (LLD)|<p>-</p>|<p>**Expression**: {Template Device H3C AC:ap.onlinetime[{#APNAME}].max(1d)}=0</p><p>**Recovery expression**: </p>|average|
