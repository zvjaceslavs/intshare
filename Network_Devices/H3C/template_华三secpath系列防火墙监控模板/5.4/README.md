...
|----|-----------|----------|--------|
|CPU利用率高|<p>2个周期CPU利用率均大于宏{$CPU_USAGE_THRESHOLD}</p>|<p>**Expression**: min(/monitor_Firewall_H3C_SecPath/MONITOR_CPUUsage.[{#SNMPINDEX},{#ENTITYDESCR}],#2)>60</p><p>**Recovery expression**: </p>|high|
|内存利用率高|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_H3C_SecPath/MONITOR_MemoryUsage.[{#SNMPINDEX},{#ENTITYDESCR}],#2)>60</p><p>**Recovery expression**: </p>|high|
|TCP并发会话数高|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_H3C_SecPath/TCPSessionNumber.[{#SNMPINDEX}],#2)>500000</p><p>**Recovery expression**: </p>|high|
|UDP并发会话数高|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_H3C_SecPath/UDPSessionNumber.[{#SNMPINDEX}],#2)>500000</p><p>**Recovery expression**: </p>|high|
|{#ENTITYDESCR} 实体失效|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/EntityOperationStatus.[{#SNMPINDEX}],#1)=2</p><p>**Recovery expression**: </p>|high|
|{#ENTITYDESCR} 实体故障|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/EntityOperationStatus.[{#SNMPINDEX}],#1)=4</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} down|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceOperationStatus.[{#SNMPINDEX}],#2)=1 and last(/monitor_Firewall_H3C_SecPath/InterfaceOperationStatus.[{#SNMPINDEX}],#1)=2</p><p>**Recovery expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceOperationStatus.[{#SNMPINDEX}],#2)=1 and last(/monitor_Firewall_H3C_SecPath/InterfaceOperationStatus.[{#SNMPINDEX}],#1)=1</p>|high|
|{#IFDESCR} 入方向带宽利用率高|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceInBandwidthUsage.[{#SNMPINDEX},{#IFDESCR}])>90</p><p>**Recovery expression**: </p>|high|
|{#IFDESCR} 入方向错包率高|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceInPacketError.[{#SNMPINDEX},{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|high|
|{#IFDESCR} 出方向带宽利用率高|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceOutBandwidthUsage[{#SNMPINDEX},{#IFDESCR}])>90</p><p>**Recovery expression**: </p>|high|
|{#IFDESCR} 出方向错包率高|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceOutPacketError.[{#SNMPINDEX},{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} down (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceOperationStatus.[{#SNMPINDEX}],#2)=1 and last(/monitor_Firewall_H3C_SecPath/InterfaceOperationStatus.[{#SNMPINDEX}],#1)=2</p><p>**Recovery expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceOperationStatus.[{#SNMPINDEX}],#2)=1 and last(/monitor_Firewall_H3C_SecPath/InterfaceOperationStatus.[{#SNMPINDEX}],#1)=1</p>|high|
|{#IFDESCR} 入方向带宽利用率高 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceInBandwidthUsage.[{#SNMPINDEX},{#IFDESCR}])>90</p><p>**Recovery expression**: </p>|high|
|{#IFDESCR} 入方向错包率高 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceInPacketError.[{#SNMPINDEX},{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|high|
|{#IFDESCR} 出方向带宽利用率高 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceOutBandwidthUsage[{#SNMPINDEX},{#IFDESCR}])>90</p><p>**Recovery expression**: </p>|high|
|{#IFDESCR} 出方向错包率高 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/InterfaceOutPacketError.[{#SNMPINDEX},{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|high|
|TCP并发会话数高 (LLD)|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_H3C_SecPath/TCPSessionNumber.[{#SNMPINDEX}],#2)>500000</p><p>**Recovery expression**: </p>|high|
|UDP并发会话数高 (LLD)|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_H3C_SecPath/UDPSessionNumber.[{#SNMPINDEX}],#2)>500000</p><p>**Recovery expression**: </p>|high|
|{#ENTITYDESCR} 实体失效 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/EntityOperationStatus.[{#SNMPINDEX}],#1)=2</p><p>**Recovery expression**: </p>|high|
|{#ENTITYDESCR} 实体故障 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_H3C_SecPath/EntityOperationStatus.[{#SNMPINDEX}],#1)=4</p><p>**Recovery expression**: </p>|high|
|CPU利用率高 (LLD)|<p>2个周期CPU利用率均大于宏{$CPU_USAGE_THRESHOLD}</p>|<p>**Expression**: min(/monitor_Firewall_H3C_SecPath/MONITOR_CPUUsage.[{#SNMPINDEX},{#ENTITYDESCR}],#2)>60</p><p>**Recovery expression**: </p>|high|
|内存利用率高 (LLD)|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_H3C_SecPath/MONITOR_MemoryUsage.[{#SNMPINDEX},{#ENTITYDESCR}],#2)>60</p><p>**Recovery expression**: </p>|high|
