...
|----|-----------|----------|--------|
|CPU利用率高|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_Juniper_SRX/CPUUsage.[{#SNMPVALUE},{#SNMPINDEX}],#2)>80</p><p>**Recovery expression**: </p>|high|
|CP会话利用率高|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_Juniper_SRX/CPSessionUsage.[{#SNMPVALUE},{#SNMPINDEX}],#2)>80</p><p>**Recovery expression**: </p>|high|
|flow会话利用率高|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_Juniper_SRX/FlowSessionUsage.[{#SNMPVALUE},{#SNMPINDEX}],#2)>80</p><p>**Recovery expression**: </p>|high|
|内存利用率高|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_Juniper_SRX/MemUsage.[{#SNMPVALUE},{#SNMPINDEX}],#2)>80</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} down|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceOperationStatus.[{#SNMPINDEX}],#2)=1 and last(/monitor_Firewall_Juniper_SRX/InterfaceOperationStatus.[{#SNMPINDEX}],#1)=2</p><p>**Recovery expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceOperationStatus.[{#SNMPINDEX}],#2)=1 and last(/monitor_Firewall_Juniper_SRX/InterfaceOperationStatus.[{#SNMPINDEX}],#1)=1</p>|high|
|端口 {#IFDESCR} 入方向带宽利用率高|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceInBandwidthUsage.[{#SNMPINDEX},{#IFDESCR}])>90</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} 入方向错包率高|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceInPacketError.[{#SNMPINDEX},{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} 出方向带宽利用率高|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceOutBandwidthUsage[{#SNMPINDEX},{#IFDESCR}])>90</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} 出方向错包率高|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceOutPacketError.[{#SNMPINDEX},{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|high|
|新建会话数高|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/SessionCreatedRate.[{#SNMPINDEX},{#SNMPVALUE}])>2000</p><p>**Recovery expression**: </p>|high|
|新建会话数高 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/SessionCreatedRate.[{#SNMPINDEX},{#SNMPVALUE}])>2000</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} 入方向带宽利用率高 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceInBandwidthUsage.[{#SNMPINDEX},{#IFDESCR}])>90</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} 入方向错包率高 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceInPacketError.[{#SNMPINDEX},{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} 出方向带宽利用率高 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceOutBandwidthUsage[{#SNMPINDEX},{#IFDESCR}])>90</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} 出方向错包率高 (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceOutPacketError.[{#SNMPINDEX},{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|high|
|端口 {#IFDESCR} down (LLD)|<p>-</p>|<p>**Expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceOperationStatus.[{#SNMPINDEX}],#2)=1 and last(/monitor_Firewall_Juniper_SRX/InterfaceOperationStatus.[{#SNMPINDEX}],#1)=2</p><p>**Recovery expression**: last(/monitor_Firewall_Juniper_SRX/InterfaceOperationStatus.[{#SNMPINDEX}],#2)=1 and last(/monitor_Firewall_Juniper_SRX/InterfaceOperationStatus.[{#SNMPINDEX}],#1)=1</p>|high|
|CPU利用率高 (LLD)|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_Juniper_SRX/CPUUsage.[{#SNMPVALUE},{#SNMPINDEX}],#2)>80</p><p>**Recovery expression**: </p>|high|
|CP会话利用率高 (LLD)|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_Juniper_SRX/CPSessionUsage.[{#SNMPVALUE},{#SNMPINDEX}],#2)>80</p><p>**Recovery expression**: </p>|high|
|flow会话利用率高 (LLD)|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_Juniper_SRX/FlowSessionUsage.[{#SNMPVALUE},{#SNMPINDEX}],#2)>80</p><p>**Recovery expression**: </p>|high|
|内存利用率高 (LLD)|<p>-</p>|<p>**Expression**: min(/monitor_Firewall_Juniper_SRX/MemUsage.[{#SNMPVALUE},{#SNMPINDEX}],#2)>80</p><p>**Recovery expression**: </p>|high|
