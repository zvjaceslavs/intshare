...
|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|Load Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Load].last()}=3</p><p>**Recovery expression**: </p>|high|
|Load Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Load].last()}=2</p><p>**Recovery expression**: </p>|average|
|Module "{#SNMPVALUE}" is powered down|<p>-</p>|<p>**Expression**: {Cisco_7600:cefcModuleOperStatus["{#SNMPVALUE}","Module"].last()}=15</p><p>**Recovery expression**: </p>|high|
|Module "{#SNMPVALUE}" is unstable [{ITEM.LASTVALUE1}]|<p>-</p>|<p>**Expression**: {Cisco_7600:cefcModuleOperStatus["{#SNMPVALUE}","Module"].last()}>3 and {Cisco_7600:cefcModuleOperStatus["{#SNMPVALUE}","Module"].last()}<>15</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Temperature].last()}=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Temperature].last()}=2</p><p>**Recovery expression**: </p>|average|
|Voltage Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Voltage].last()}=3</p><p>**Recovery expression**: </p>|high|
|Voltage Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Voltage].last()}=2</p><p>**Recovery expression**: </p>|average|
|Amperage Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Amperage].last()}=3</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Amperage].last()}=2</p><p>**Recovery expression**: </p>|average|
|Status of Fan Tray "{#SNMPVALUE}" is in partial failure|<p>-</p>|<p>**Expression**: {Cisco_7600:cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"].last()}=4</p><p>**Recovery expression**: </p>|warning|
|Status of Fan Tray "{#SNMPVALUE}" is powered down|<p>-</p>|<p>**Expression**: {Cisco_7600:cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"].last()}=3</p><p>**Recovery expression**: </p>|high|
|High CPU #{#SNMPINDEX} Usage|<p>-</p>|<p>**Expression**: {Cisco_7600:cpmCPUTotal5minRev[{#SNMPINDEX}].last()}>95</p><p>**Recovery expression**: </p>|high|
|Status of FAN "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|High utilization of Memory Pool "{#SNMPVALUE}"|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoMemoryPoolUsed["{#SNMPVALUE}"].last()}>{Cisco_7600:ciscoMemoryPoolTotal["{#SNMPVALUE}"].last()}*0.9</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is critical|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: {Cisco_7600:snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed|<p>-</p>|<p>**Expression**: {Cisco_7600:snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|OSPF Interface "{#SNMPVALUE}" State has been changed|<p>-</p>|<p>**Expression**: {Cisco_7600:snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|OSPF Neighbor {#SNMPVALUE} has been changed|<p>-</p>|<p>**Expression**: {Cisco_7600:snmptrap["(ospfNbrStateChange).*ospfNbrIpAddr[[:space:]]{#SNMPVALUE}[[:space:]].*[[:space:]][a-zA-Z]+[[:space:]]$"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:snmptrap["(bgpEstablished|bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|BGP Peer "{#SNMPINDEX}"->"{#SNMPVALUE}" State changed (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:snmptrap["(bgpBackwardTransition|cbgpFsmStateChange).*bgpPeerState .{#SNMPINDEX}[[:space:]][a-zA-Z]+[[:space:]]"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
|Load Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Load].last()}=3</p><p>**Recovery expression**: </p>|high|
|Load Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Load].last()}=2</p><p>**Recovery expression**: </p>|average|
...
|Status of FAN "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of FAN "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of FAN "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonFanState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|OSPF Interface "{#SNMPVALUE}" State has been changed (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:snmptrap["ospfIfStateChange.+ospfIfIpAddress[[:space:]]{#SNMPVALUE}[[:space:]].+ospfIfState[[:space:]][a-zA-Z]+"].nodata(10m)}=0</p><p>**Recovery expression**: </p>|average|
...
|Module "{#SNMPVALUE}" is powered down (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:cefcModuleOperStatus["{#SNMPVALUE}","Module"].last()}=15</p><p>**Recovery expression**: </p>|high|
|Module "{#SNMPVALUE}" is unstable [{ITEM.LASTVALUE1}] (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:cefcModuleOperStatus["{#SNMPVALUE}","Module"].last()}>3 and {Cisco_7600:cefcModuleOperStatus["{#SNMPVALUE}","Module"].last()}<>15</p><p>**Recovery expression**: </p>|high|
|Status of Fan Tray "{#SNMPVALUE}" is in partial failure (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"].last()}=4</p><p>**Recovery expression**: </p>|warning|
|Status of Fan Tray "{#SNMPVALUE}" is powered down (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:cefcFanTrayOperStatus["{#SNMPVALUE}","Fan Tray"].last()}=3</p><p>**Recovery expression**: </p>|high|
...
|Status of Power Supply "{#SNMPVALUE}" is critical (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=3</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is non-operable (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Status of Power Supply "{#SNMPVALUE}" is not functioning (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=6</p><p>**Recovery expression**: </p>|average|
|Status of Power Supply "{#SNMPVALUE}" is shutdown (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:ciscoEnvMonSupplyState["{#SNMPVALUE}"].last()}=4</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Amperage].last()}=3</p><p>**Recovery expression**: </p>|high|
|Amperage Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Amperage].last()}=2</p><p>**Recovery expression**: </p>|average|
|Temperature Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Temperature].last()}=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor "{#SNMPVALUE}" is unavailable (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Temperature].last()}=2</p><p>**Recovery expression**: </p>|average|
|Voltage Sensor "{#SNMPVALUE}" is nonoperational (LLD)|<p>-</p>|<p>**Expression**: {Cisco_7600:entSensorStatus["{#SNMPVALUE}",Voltage].last()}=3</p><p>**Recovery expression**: </p>|high|
