...
|----|-----------|----------|--------|
|High CPU #{#SNMPVALUE} Usage|<p>-</p>|<p>**Expression**: last(/Extreme_X450a/extremeCpuMonitorSystemUtilization5mins[{#SNMPINDEX}])>=last(/Extreme_X450a/extremeCpuMonitorThreshold)</p><p>**Recovery expression**: </p>|average|
|Status of FAN #{#SNMPVALUE} is failed|<p>-</p>|<p>**Expression**: last(/Extreme_X450a/extremeFanOperational[{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|average|
|High Memory #{#SNMPVALUE} Usage|<p>-</p>|<p>**Expression**: last(/Extreme_X450a/extremeMemoryMonitorSystemFree[{#SNMPVALUE}])<=last(/Extreme_X450a/extremeMemoryMonitorSystemTotal[{#SNMPVALUE}])*0.05</p><p>**Recovery expression**: </p>|average|
|High Memory #{#SNMPVALUE} Usage (LLD)|<p>-</p>|<p>**Expression**: last(/Extreme_X450a/extremeMemoryMonitorSystemFree[{#SNMPVALUE}])<=last(/Extreme_X450a/extremeMemoryMonitorSystemTotal[{#SNMPVALUE}])*0.05</p><p>**Recovery expression**: </p>|average|
|Status of FAN #{#SNMPVALUE} is failed (LLD)|<p>-</p>|<p>**Expression**: last(/Extreme_X450a/extremeFanOperational[{#SNMPVALUE}])=2</p><p>**Recovery expression**: </p>|average|
|High CPU #{#SNMPVALUE} Usage (LLD)|<p>-</p>|<p>**Expression**: last(/Extreme_X450a/extremeCpuMonitorSystemUtilization5mins[{#SNMPINDEX}])>=last(/Extreme_X450a/extremeCpuMonitorThreshold)</p><p>**Recovery expression**: </p>|average|
