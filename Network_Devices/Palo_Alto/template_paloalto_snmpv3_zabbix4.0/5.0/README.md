...
|----|-----------|----------|--------|
|{#PHY} sensor status not ok|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:entPhySensorOperStatus.["{#PHY}"].last()}<>1</p><p>**Recovery expression**: </p>|average|
|{#PHY} temperature above 65 °C|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:entPhySensorValue.["{#PHY}"].last()}>65</p><p>**Recovery expression**: </p>|average|
|{#PHY} temperature above 70 °C|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:entPhySensorValue.["{#PHY}"].last()}>70</p><p>**Recovery expression**: </p>|high|
|{#PHY} temperature above 80 °C|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:entPhySensorValue.["{#PHY}"].last()}>80</p><p>**Recovery expression**: </p>|disaster|
|{#PHY} sensor status not ok|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:entPhySensorOperStatus.fan.["{#PHY}"].last()}<>1</p><p>**Recovery expression**: </p>|average|
|CPU load on {#CPU} more than 90%|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:hrProcessorLoad.["{#CPU}"].last()}>90</p><p>**Recovery expression**: </p>|average|
|CPU load on {#CPU} more than 95%|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:hrProcessorLoad.["{#CPU}"].last()}>95</p><p>**Recovery expression**: </p>|high|
|{#CPU} status down|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:hrDeviceStatus.["{#CPU}"].last()}=5</p><p>**Recovery expression**: </p>|average|
|{#CPU} status warning|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:hrDeviceStatus.["{#CPU}"].last()}=3</p><p>**Recovery expression**: </p>|warning|
|Free disk space is less than 2% on {#STOR}|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:hrStorageUsed.["{#STOR}"].last()} / {SNMPv3 Palo alto OS 8.1:hrStorageSize.["{#STOR}"].last()} * 100 > 98</p><p>**Recovery expression**: </p>|disaster|
|Free disk space is less than 5% on {#STOR}|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:hrStorageUsed.["{#STOR}"].last()} / {SNMPv3 Palo alto OS 8.1:hrStorageSize.["{#STOR}"].last()} * 100 > 95</p><p>**Recovery expression**: </p>|high|
|Free disk space is less than 10% on {#STOR}|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:hrStorageUsed.["{#STOR}"].last()} / {SNMPv3 Palo alto OS 8.1:hrStorageSize.["{#STOR}"].last()} * 100 > 90</p><p>**Recovery expression**: </p>|average|
|{#IFNAME} interface down|<p>interface ifAdminStatus is up(1) and ifOperStatus is down(2)</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:ifAdminStatus.["{#IFNAME}"].last()}=1 and {SNMPv3 Palo alto OS 8.1:ifOperStatus.["{#IFNAME}"].last()}=2</p><p>**Recovery expression**: </p>|high|
|{#PHY} sensor status not ok (LLD)|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:entPhySensorOperStatus.["{#PHY}"].last()}<>1</p><p>**Recovery expression**: </p>|average|
|{#PHY} temperature above 65 °C (LLD)|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:entPhySensorValue.["{#PHY}"].last()}>65</p><p>**Recovery expression**: </p>|average|
|{#PHY} temperature above 70 °C (LLD)|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:entPhySensorValue.["{#PHY}"].last()}>70</p><p>**Recovery expression**: </p>|high|
|{#PHY} temperature above 80 °C (LLD)|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:entPhySensorValue.["{#PHY}"].last()}>80</p><p>**Recovery expression**: </p>|disaster|
|Free disk space is less than 2% on {#STOR} (LLD)|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:hrStorageUsed.["{#STOR}"].last()} / {SNMPv3 Palo alto OS 8.1:hrStorageSize.["{#STOR}"].last()} * 100 > 98</p><p>**Recovery expression**: </p>|disaster|
|Free disk space is less than 5% on {#STOR} (LLD)|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:hrStorageUsed.["{#STOR}"].last()} / {SNMPv3 Palo alto OS 8.1:hrStorageSize.["{#STOR}"].last()} * 100 > 95</p><p>**Recovery expression**: </p>|high|
|Free disk space is less than 10% on {#STOR} (LLD)|<p>-</p>|<p>**Expression**: {SNMPv3 Palo alto OS 8.1:hrStorageUsed.["{#STOR}"].last()} / {SNMPv3 Palo alto OS 8.1:hrStorageSize.["{#STOR}"].last()} * 100 > 90</p><p>**Recovery expression**: </p>|average|
