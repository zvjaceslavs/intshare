...
|----|-----------|----------|--------|
|FAN #{#SNMPINDEX} is nonoperational|<p>-</p>|<p>**Expression**: last(/Palo_Alto_Firewall/entPhySensorOperStatus[{#SNMPVALUE},FAN])=3</p><p>**Recovery expression**: </p>|high|
|FAN #{#SNMPINDEX} is unavailable|<p>-</p>|<p>**Expression**: last(/Palo_Alto_Firewall/entPhySensorOperStatus[{#SNMPVALUE},FAN])=2</p><p>**Recovery expression**: </p>|average|
|Temperature Sensor #{#SNMPINDEX} is nonoperational|<p>-</p>|<p>**Expression**: last(/Palo_Alto_Firewall/entPhySensorOperStatus[{#SNMPVALUE},Temperature])=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor #{#SNMPINDEX} is unavailable|<p>-</p>|<p>**Expression**: last(/Palo_Alto_Firewall/entPhySensorOperStatus[{#SNMPVALUE},Temperature])=2</p><p>**Recovery expression**: </p>|average|
|#{#SNMPVALUE} usage is high [{ITEM.LASTVALUE1}]|<p>-</p>|<p>**Expression**: avg(/Palo_Alto_Firewall/hrStorageUsed[memory,{#SNMPINDEX}],5m)>last(/Palo_Alto_Firewall/hrStorageSize[memory,{#SNMPINDEX}])*0.9</p><p>**Recovery expression**: </p>|average|
|FAN #{#SNMPINDEX} is nonoperational (LLD)|<p>-</p>|<p>**Expression**: last(/Palo_Alto_Firewall/entPhySensorOperStatus[{#SNMPVALUE},FAN])=3</p><p>**Recovery expression**: </p>|high|
|FAN #{#SNMPINDEX} is unavailable (LLD)|<p>-</p>|<p>**Expression**: last(/Palo_Alto_Firewall/entPhySensorOperStatus[{#SNMPVALUE},FAN])=2</p><p>**Recovery expression**: </p>|average|
|#{#SNMPVALUE} usage is high [{ITEM.LASTVALUE1}] (LLD)|<p>-</p>|<p>**Expression**: avg(/Palo_Alto_Firewall/hrStorageUsed[memory,{#SNMPINDEX}],5m)>last(/Palo_Alto_Firewall/hrStorageSize[memory,{#SNMPINDEX}])*0.9</p><p>**Recovery expression**: </p>|average|
|Temperature Sensor #{#SNMPINDEX} is nonoperational (LLD)|<p>-</p>|<p>**Expression**: last(/Palo_Alto_Firewall/entPhySensorOperStatus[{#SNMPVALUE},Temperature])=3</p><p>**Recovery expression**: </p>|high|
|Temperature Sensor #{#SNMPINDEX} is unavailable (LLD)|<p>-</p>|<p>**Expression**: last(/Palo_Alto_Firewall/entPhySensorOperStatus[{#SNMPVALUE},Temperature])=2</p><p>**Recovery expression**: </p>|average|
