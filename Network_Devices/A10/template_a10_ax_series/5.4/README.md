...
|----|-----------|----------|--------|
|FAN "{#SNMPVALUE}" is failed|<p>-</p>|<p>**Expression**: last(/A10_AX_Series/axFanStatus["{#SNMPVALUE}"])=0</p><p>**Recovery expression**: </p>|high|
|Power Supply "{#SNMPVALUE}" is absent|<p>-</p>|<p>**Expression**: last(/A10_AX_Series/axPowerSupplyStatus["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Power Supply "{#SNMPVALUE}" is off|<p>-</p>|<p>**Expression**: last(/A10_AX_Series/axPowerSupplyStatus["{#SNMPVALUE}"])=0</p><p>**Recovery expression**: </p>|warning|
|Power Supply Voltage "{#SNMPVALUE}" is invalid|<p>-</p>|<p>**Expression**: last(/A10_AX_Series/axPowerSupplyVoltageStatus["{#SNMPVALUE}"])=0</p><p>**Recovery expression**: </p>|average|
|Power Supply Voltage "{#SNMPVALUE}" is invalid (LLD)|<p>-</p>|<p>**Expression**: last(/A10_AX_Series/axPowerSupplyVoltageStatus["{#SNMPVALUE}"])=0</p><p>**Recovery expression**: </p>|average|
|FAN "{#SNMPVALUE}" is failed (LLD)|<p>-</p>|<p>**Expression**: last(/A10_AX_Series/axFanStatus["{#SNMPVALUE}"])=0</p><p>**Recovery expression**: </p>|high|
|Power Supply "{#SNMPVALUE}" is absent (LLD)|<p>-</p>|<p>**Expression**: last(/A10_AX_Series/axPowerSupplyStatus["{#SNMPVALUE}"])=2</p><p>**Recovery expression**: </p>|warning|
|Power Supply "{#SNMPVALUE}" is off (LLD)|<p>-</p>|<p>**Expression**: last(/A10_AX_Series/axPowerSupplyStatus["{#SNMPVALUE}"])=0</p><p>**Recovery expression**: </p>|warning|
