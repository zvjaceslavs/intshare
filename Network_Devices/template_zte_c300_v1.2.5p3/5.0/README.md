...
|----|-----------|----------|--------|
|CARD {#SNMPVALUE} {#SNMPINDEX} CPU too high!|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:cardcpu[{#SNMPINDEX}].avg(10m)}>80</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} {#SNMPINDEX} MEMORY too high!|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:cardmem[{#SNMPINDEX}].avg(10m)}>85</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} operational status changed|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:cardoperstat[{#SNMPINDEX}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} standby status changed|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:cardstandby[{#SNMPINDEX}].last()}<>1 and {Template SNMP Device GPON ZTE fw 1.2.5p3:cardstandby[{#SNMPINDEX}].last()}<>2</p><p>**Recovery expression**: </p>|high|
|Interface {#SNMPVALUE} operational status changed|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:ifOperStatus[{#SNMPVALUE}].diff(0)}=1</p><p>**Recovery expression**: </p>|high|
|SIGNAL LOW rx 1310nm {#ONUDESC}|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:rx1310[{#SNMPINDEX}].last()}<=-30 and {Template SNMP Device GPON ZTE fw 1.2.5p3:rx1310[{#SNMPINDEX}].last()}<>-80</p><p>**Recovery expression**: </p>|information|
|SIGNAL LOW rx 1490nm {#ONUDESC}|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:rx1490[{#SNMPINDEX}].last()}<=6 and {Template SNMP Device GPON ZTE fw 1.2.5p3:rx1490[{#SNMPINDEX}].last()}<>131.07</p><p>**Recovery expression**: </p>|information|
|CARD {#SNMPVALUE} {#SNMPINDEX} CPU too high! (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:cardcpu[{#SNMPINDEX}].avg(10m)}>80</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} {#SNMPINDEX} MEMORY too high! (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:cardmem[{#SNMPINDEX}].avg(10m)}>85</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} operational status changed (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:cardoperstat[{#SNMPINDEX}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|CARD {#SNMPVALUE} standby status changed (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:cardstandby[{#SNMPINDEX}].last()}<>1 and {Template SNMP Device GPON ZTE fw 1.2.5p3:cardstandby[{#SNMPINDEX}].last()}<>2</p><p>**Recovery expression**: </p>|high|
|Interface {#SNMPVALUE} operational status changed (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:ifOperStatus[{#SNMPVALUE}].diff(0)}=1</p><p>**Recovery expression**: </p>|high|
|SIGNAL LOW rx 1310nm {#ONUDESC} (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:rx1310[{#SNMPINDEX}].last()}<=-30 and {Template SNMP Device GPON ZTE fw 1.2.5p3:rx1310[{#SNMPINDEX}].last()}<>-80</p><p>**Recovery expression**: </p>|information|
|SIGNAL LOW rx 1490nm {#ONUDESC} (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON ZTE fw 1.2.5p3:rx1490[{#SNMPINDEX}].last()}<=6 and {Template SNMP Device GPON ZTE fw 1.2.5p3:rx1490[{#SNMPINDEX}].last()}<>131.07</p><p>**Recovery expression**: </p>|information|
# Template ICMP Ping GPON
...
|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|Interface {#SNMPVALUE} operational status changed|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON PARKS:ifOperStatus[{#SNMPVALUE}].diff(0)}=1</p><p>**Recovery expression**: </p>|average|
|ONU {#SNMPVALUE} LOW SIGNAL|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON PARKS:onuDwRx[{#SNMPVALUE}].last()}>28</p><p>**Recovery expression**: </p>|information|
|Interface {#SNMPVALUE} operational status changed (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON PARKS:ifOperStatus[{#SNMPVALUE}].diff(0)}=1</p><p>**Recovery expression**: </p>|average|
|ONU {#SNMPVALUE} LOW SIGNAL (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Device GPON PARKS:onuDwRx[{#SNMPVALUE}].last()}>28</p><p>**Recovery expression**: </p>|information|
