# Teltonika RUT950 and RUT955 SNMP
...
|----|-----------|----------|--------|
|Interface {#IFNAME}({#IFALIAS}): Ethernet has changed to lower speed than it was before|<p>This Ethernet connection has transitioned down from its known maximum speed. This might be a sign of autonegotiation issues. Ack to close.</p>|<p>**Expression**: change(/Teltonika RUT950 and RUT955 SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])<0 and last(/Teltonika RUT950 and RUT955 SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])>0 and ( last(/Teltonika RUT950 and RUT955 SNMP/net.if.type[ifType.{#SNMPINDEX}])=6 or last(/Teltonika RUT950 and RUT955 SNMP/net.if.type[ifType.{#SNMPINDEX}])=7 or last(/Teltonika RUT950 and RUT955 SNMP/net.if.type[ifType.{#SNMPINDEX}])=11 or last(/Teltonika RUT950 and RUT955 SNMP/net.if.type[ifType.{#SNMPINDEX}])=62 or last(/Teltonika RUT950 and RUT955 SNMP/net.if.type[ifType.{#SNMPINDEX}])=69 or last(/Teltonika RUT950 and RUT955 SNMP/net.if.type[ifType.{#SNMPINDEX}])=117 ) and (last(/Teltonika RUT950 and RUT955 SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}])<>2)</p><p>**Recovery expression**: (change(/Teltonika RUT950 and RUT955 SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])>0 and last(/Teltonika RUT950 and RUT955 SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}],#2)>0) or (last(/Teltonika RUT950 and RUT955 SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}])=2)</p>|information|
|Interface {#IFNAME}({#IFALIAS}): High bandwidth usage (>{$IF.UTIL.MAX:"{#IFNAME}"}% )|<p>The network interface utilization is close to its estimated maximum bandwidth.</p>|<p>**Expression**: (avg(/Teltonika RUT950 and RUT955 SNMP/net.if.in[ifHCInOctets.{#SNMPINDEX}],15m)>(90/100)*last(/Teltonika RUT950 and RUT955 SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}]) or avg(/Teltonika RUT950 and RUT955 SNMP/net.if.out[ifHCOutOctets.{#SNMPINDEX}],15m)>(90/100)*last(/Teltonika RUT950 and RUT955 SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])) and last(/Teltonika RUT950 and RUT955 SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])>0</p><p>**Recovery expression**: avg(/Teltonika RUT950 and RUT955 SNMP/net.if.in[ifHCInOctets.{#SNMPINDEX}],15m)<((90-3)/100)*last(/Teltonika RUT950 and RUT955 SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}]) and avg(/Teltonika RUT950 and RUT955 SNMP/net.if.out[ifHCOutOctets.{#SNMPINDEX}],15m)<((90-3)/100)*last(/Teltonika RUT950 and RUT955 SNMP/net.if.speed[ifHighSpeed.{#SNMPINDEX}])</p>|warning|
|Interface {#IFNAME}({#IFALIAS}): High error rate (>{$IF.ERRORS.WARN:"{#IFNAME}"} for 5m)|<p>Recovers when below 80% of {$IF.ERRORS.WARN:"{#IFNAME}"} threshold</p>|<p>**Expression**: min(/Teltonika RUT950 and RUT955 SNMP/net.if.in.errors[ifInErrors.{#SNMPINDEX}],5m)>2 or min(/Teltonika RUT950 and RUT955 SNMP/net.if.out.errors[ifOutErrors.{#SNMPINDEX}],5m)>2</p><p>**Recovery expression**: max(/Teltonika RUT950 and RUT955 SNMP/net.if.in.errors[ifInErrors.{#SNMPINDEX}],5m)<2*0.8 and max(/Teltonika RUT950 and RUT955 SNMP/net.if.out.errors[ifOutErrors.{#SNMPINDEX}],5m)<2*0.8</p>|warning|
|Interface {#IFNAME}({#IFALIAS}): Link down|<p>This trigger expression works as follows: 1. Can be triggered if operations status is down. 2. {$IFCONTROL:"{#IFNAME}"}=1 - user can redefine Context macro to value - 0. That marks this interface as not important. No new trigger will be fired if this interface is down. 3. {TEMPLATE_NAME:METRIC.diff()}=1) - trigger fires only if operational status was up(1) sometime before. (So, do not fire 'ethernal off' interfaces.) WARNING: if closed manually - won't fire again on next poll, because of .diff.</p>|<p>**Expression**: 1=1 and last(/Teltonika RUT950 and RUT955 SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}])=2 and (last(/Teltonika RUT950 and RUT955 SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}],#1)<>last(/Teltonika RUT950 and RUT955 SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}],#2))</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/net.if.status[ifOperStatus.{#SNMPINDEX}])<>2 or 1=0</p>|average|
|Interface {#IFNAME}({#IFALIAS}): High daily traffic usage (>{$IF.UTIL.DAILY:"{#IFNAME}"} )|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/net.if.total[daily.{#SNMPINDEX}])>5G</p><p>**Recovery expression**: </p>|information|
|Interface {#IFNAME}({#IFALIAS}): High monthly traffic usage (>{$IF.UTIL.MONTHLY:"{#IFNAME}"} )|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/net.if.total[monthly.{#SNMPINDEX}])>15G</p><p>**Recovery expression**: </p>|information|
|Interface {#IFNAME}({#IFALIAS}): High weekly traffic usage (>{$IF.UTIL.WEEKLY:"{#IFNAME}"} )|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/net.if.total[weekly.{#SNMPINDEX}])>10G</p><p>**Recovery expression**: </p>|information|
|Modem not Connected|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mConnectionState[{#SNMPVALUE}])<>"Connected"</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/mConnectionState[{#SNMPVALUE}])="Connected"</p>|warning|
|IMSI changed|<p>-</p>|<p>**Expression**: change(/Teltonika RUT950 and RUT955 SNMP/mIMSI[{#SNMPVALUE}])=1</p><p>**Recovery expression**: </p>|information|
|Mobile operator changed|<p>-</p>|<p>**Expression**: change(/Teltonika RUT950 and RUT955 SNMP/mOperator[{#SNMPVALUE}])=1</p><p>**Recovery expression**: </p>|information|
|Simcard PIN not READY|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mPinState[{#SNMPVALUE}])<>"READY"</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/mPinState[{#SNMPVALUE}])="READY"</p>|warning|
|Low Signal RSRP|<p>Signal Strength RSRP < -109.</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mRSRP[{#SNMPVALUE}])<-109</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/mRSRP[{#SNMPVALUE}])>-110</p>|information|
|Low Signal RSSI|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mSignal[{#SNMPVALUE}])<-82</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/mSignal[{#SNMPVALUE}])>-80</p>|information|
|Router offline (SNMP timeout RSSI)|<p>No SNMP data was collected for 600 seconds</p>|<p>**Expression**: nodata(/Teltonika RUT950 and RUT955 SNMP/mSignal[{#SNMPVALUE}],600)=1</p><p>**Recovery expression**: </p>|warning|
|Simcard not inserted|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mSimState[{#SNMPVALUE}])<>"inserted"</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/mSimState[{#SNMPVALUE}])="inserted"</p>|warning|
|High monthly traffic usage for {#SNMPVALUE} operator {#OPERATOR} (>{$IF.UTIL.MONTHLY})|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mTraffic[{#SNMPVALUE}-{#OPERATORNUMBER}])>15G</p><p>**Recovery expression**: </p>|information|
|IP Changed on Interface {#IFINDEX}|<p>-</p>|<p>**Expression**: (last(/Teltonika RUT950 and RUT955 SNMP/netInterfaceIP[{#IFINDEX}],#1)<>last(/Teltonika RUT950 and RUT955 SNMP/netInterfaceIP[{#IFINDEX}],#2))>0</p><p>**Recovery expression**: </p>|not classified|
|Teltonika {#FSNAME}: Disk space is critically low (used > {$VFS.FS.PUSED.MAX.CRIT:"{#FSNAME}"}%)|<p>Two conditions should match: First, space utilization should be above {$VFS.FS.PUSED.MAX.CRIT:"{#FSNAME}"}. Second condition should be one of the following: - The disk free space is less than 5G. - The disk will be full in less than 24 hours.</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.pused[storageUsedPercentage.{#SNMPINDEX}])>90 and ((last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.total[hrStorageSize.{#SNMPINDEX}])-last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.used[hrStorageUsed.{#SNMPINDEX}]))<5G or timeleft(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.pused[storageUsedPercentage.{#SNMPINDEX}],1h,100)<1d) and {#FSNAME} <> "/rom"</p><p>**Recovery expression**: </p>|average|
|Teltonika {#FSNAME}: Disk space is low (used > {$VFS.FS.PUSED.MAX.WARN:"{#FSNAME}"}%)|<p>Two conditions should match: First, space utilization should be above {$VFS.FS.PUSED.MAX.WARN:"{#FSNAME}"}. Second condition should be one of the following: - The disk free space is less than 10G. - The disk will be full in less than 24 hours.</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.pused[storageUsedPercentage.{#SNMPINDEX}])>80 and ((last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.total[hrStorageSize.{#SNMPINDEX}])-last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.used[hrStorageUsed.{#SNMPINDEX}]))<10G or timeleft(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.pused[storageUsedPercentage.{#SNMPINDEX}],1h,100)<1d) and {#FSNAME} <> "/rom"</p><p>**Recovery expression**: </p>|warning|
|{#FSNAME}: Disk space is critically low (used > {$VFS.FS.PUSED.MAX.CRIT:"{#FSNAME}"}%)|<p>Two conditions should match: First, space utilization should be above {$VFS.FS.PUSED.MAX.CRIT:"{#FSNAME}"}. Second condition should be one of the following: - The disk free space is less than 5G. - The disk will be full in less than 24 hours.</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.pused[storageUsedPercentage.{#SNMPINDEX}])>90 and ((last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.total[hrStorageSize.{#SNMPINDEX}])-last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.used[hrStorageUsed.{#SNMPINDEX}]))<5G or timeleft(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.pused[storageUsedPercentage.{#SNMPINDEX}],1h,100)<1d)</p><p>**Recovery expression**: </p>|average|
|{#FSNAME}: Disk space is low (used > {$VFS.FS.PUSED.MAX.WARN:"{#FSNAME}"}%)|<p>Two conditions should match: First, space utilization should be above {$VFS.FS.PUSED.MAX.WARN:"{#FSNAME}"}. Second condition should be one of the following: - The disk free space is less than 10G. - The disk will be full in less than 24 hours.</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.pused[storageUsedPercentage.{#SNMPINDEX}])>80 and ((last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.total[hrStorageSize.{#SNMPINDEX}])-last(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.used[hrStorageUsed.{#SNMPINDEX}]))<10G or timeleft(/Teltonika RUT950 and RUT955 SNMP/vfs.fs.pused[storageUsedPercentage.{#SNMPINDEX}],1h,100)<1d)</p><p>**Recovery expression**: </p>|warning|
|{#MEMNAME}: High memory utilization (>{$MEMORY.UTIL.MAX}% for 5m)|<p>The system is running out of free memory.</p>|<p>**Expression**: min(/Teltonika RUT950 and RUT955 SNMP/vm.memory.util[memoryUsedPercentage.{#SNMPINDEX}],5m)>90</p><p>**Recovery expression**: </p>|average|
...
|{#MEMNAME}: High memory utilization (>{$MEMORY.UTIL.MAX}% for 5m) (LLD)|<p>The system is running out of free memory.</p>|<p>**Expression**: min(/Teltonika RUT950 and RUT955 SNMP/vm.memory.util[memoryUsedPercentage.{#SNMPINDEX}],5m)>90</p><p>**Recovery expression**: </p>|average|
|IP Changed on Interface {#IFINDEX} (LLD)|<p>-</p>|<p>**Expression**: (last(/Teltonika RUT950 and RUT955 SNMP/netInterfaceIP[{#IFINDEX}],#1)<>last(/Teltonika RUT950 and RUT955 SNMP/netInterfaceIP[{#IFINDEX}],#2))>0</p><p>**Recovery expression**: </p>|not classified|
|Modem not Connected (LLD)|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mConnectionState[{#SNMPVALUE}])<>"Connected"</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/mConnectionState[{#SNMPVALUE}])="Connected"</p>|warning|
|IMSI changed (LLD)|<p>-</p>|<p>**Expression**: change(/Teltonika RUT950 and RUT955 SNMP/mIMSI[{#SNMPVALUE}])=1</p><p>**Recovery expression**: </p>|information|
|Mobile operator changed (LLD)|<p>-</p>|<p>**Expression**: change(/Teltonika RUT950 and RUT955 SNMP/mOperator[{#SNMPVALUE}])=1</p><p>**Recovery expression**: </p>|information|
|Simcard PIN not READY (LLD)|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mPinState[{#SNMPVALUE}])<>"READY"</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/mPinState[{#SNMPVALUE}])="READY"</p>|warning|
|Low Signal RSRP (LLD)|<p>Signal Strength RSRP < -109.</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mRSRP[{#SNMPVALUE}])<-109</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/mRSRP[{#SNMPVALUE}])>-110</p>|information|
|Low Signal RSSI (LLD)|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mSignal[{#SNMPVALUE}])<-82</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/mSignal[{#SNMPVALUE}])>-80</p>|information|
|Router offline (SNMP timeout RSSI) (LLD)|<p>No SNMP data was collected for 600 seconds</p>|<p>**Expression**: nodata(/Teltonika RUT950 and RUT955 SNMP/mSignal[{#SNMPVALUE}],600)=1</p><p>**Recovery expression**: </p>|warning|
|Simcard not inserted (LLD)|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mSimState[{#SNMPVALUE}])<>"inserted"</p><p>**Recovery expression**: last(/Teltonika RUT950 and RUT955 SNMP/mSimState[{#SNMPVALUE}])="inserted"</p>|warning|
|High monthly traffic usage for {#SNMPVALUE} operator {#OPERATOR} (>{$IF.UTIL.MONTHLY}) (LLD)|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/mTraffic[{#SNMPVALUE}-{#OPERATORNUMBER}])>15G</p><p>**Recovery expression**: </p>|information|
...
|Interface {#IFNAME}({#IFALIAS}): High error rate (>{$IF.ERRORS.WARN:"{#IFNAME}"} for 5m) (LLD)|<p>Recovers when below 80% of {$IF.ERRORS.WARN:"{#IFNAME}"} threshold</p>|<p>**Expression**: min(/Teltonika RUT950 and RUT955 SNMP/net.if.in.errors[ifInErrors.{#SNMPINDEX}],5m)>2 or min(/Teltonika RUT950 and RUT955 SNMP/net.if.out.errors[ifOutErrors.{#SNMPINDEX}],5m)>2</p><p>**Recovery expression**: max(/Teltonika RUT950 and RUT955 SNMP/net.if.in.errors[ifInErrors.{#SNMPINDEX}],5m)<2*0.8 and max(/Teltonika RUT950 and RUT955 SNMP/net.if.out.errors[ifOutErrors.{#SNMPINDEX}],5m)<2*0.8</p>|warning|
...
|Interface {#IFNAME}({#IFALIAS}): High daily traffic usage (>{$IF.UTIL.DAILY:"{#IFNAME}"} ) (LLD)|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/net.if.total[daily.{#SNMPINDEX}])>5G</p><p>**Recovery expression**: </p>|information|
|Interface {#IFNAME}({#IFALIAS}): High monthly traffic usage (>{$IF.UTIL.MONTHLY:"{#IFNAME}"} ) (LLD)|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/net.if.total[monthly.{#SNMPINDEX}])>15G</p><p>**Recovery expression**: </p>|information|
|Interface {#IFNAME}({#IFALIAS}): High weekly traffic usage (>{$IF.UTIL.WEEKLY:"{#IFNAME}"} ) (LLD)|<p>-</p>|<p>**Expression**: last(/Teltonika RUT950 and RUT955 SNMP/net.if.total[weekly.{#SNMPINDEX}])>10G</p><p>**Recovery expression**: </p>|information|
