...
|{#PSU} - Status|<p>-</p>|`SNMP agent`|psu.status.[{#PSU}]<p>Update: 30s</p>|
|Components {#NAME} - Errors|<p>-</p>|`SNMP agent`|component.errors.[{#SNMPINDEX}]<p>Update: 30s</p>|
|{#FAN} - Speed|<p>-</p>|`SNMP agent`|fan.speed.[{#SNMPINDEX}]<p>Update: 30s</p>|
|{#FAN} - Status|<p>-</p>|`SNMP agent`|fan.status.[{#SNMPINDEX}]<p>Update: 30s</p>|
|{#VSENSOR} - Status|<p>-</p>|`SNMP agent`|voltage.sensor.[{#SNMPINDEX}]<p>Update: 30s</p>|
|Component {#NAME} - Status|<p>-</p>|`SNMP agent`|component.status.[{#SNMPINDEX}]<p>Update: 30s</p>|
|{#SENSOR} - Temperature|<p>-</p>|`SNMP agent`|sensor.temp.[{#SNMPINDEX}]<p>Update: 30s</p>|
## Triggers
...
|{HOST.NAME} -> {#PSU} not ok|<p>-</p>|high|
|{HOST.NAME} -> Component {#NAME} Errors: {ITEM.LASTVALUE}|<p>-</p>|high|
|{HOST.NAME} -> {#FAN} Speed: {ITEM.LASTVALUE}, threshold: {$FAN_SPEED_LIMIT}|<p>-</p>|high|
|{HOST.NAME} ->{#FAN} Status not ok|<p>-</p>|high|
|{HOST.NAME} -> {#VSENSOR} status not ok|<p>-</p>|high|
|{HOST.NAME} -> {#NAME} status is fail|<p>-</p>|high|
|{HOST.NAME} -> Temperature {#SENSOR}: {ITEM.LASTVALUE}, threshold: {#WARN_TEMP}|<p>-</p>|high|
