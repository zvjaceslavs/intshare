...
|Logical disk "{#LDNAME}" level|<p>-</p>|`Dependent item`|irst.raid.level.[{#LDNAME}]<p>Update: 0</p>|
|Logical disk "{#LDNAME}" disks count|<p>-</p>|`Dependent item`|irst.raid.pdcount.[{#LDNAME}]<p>Update: 0</p>|
|Logical disk "{#LDNAME}" state|<p>-</p>|`Dependent item`|irst.raid.state.[{#LDNAME}]<p>Update: 0</p>|
|Physical disk "{#SLOT}" serial number|<p>-</p>|`Dependent item`|irst.pd.sn.["{#SLOT}"]<p>Update: 0</p>|
|Physical disk "{#SLOT}" state|<p>-</p>|`Dependent item`|irst.pd.state.["{#SLOT}"]<p>Update: 0</p>|
|Physical disk "{#SLOT}" usage|<p>-</p>|`Dependent item`|irst.pd.usage.["{#SLOT}"]<p>Update: 0</p>|
## Triggers

|Name|Description|Priority|
|----|-----------|----|
|{ITEM.VALUE}|<p>Changing if driver version for Irst changed or if it's first check</p>|not classified|
|Intel RST: Logical disk "{#LDNAME}" is "{ITEM.VALUE1}". LD level: {ITEM.VALUE2} Disks count: {ITEM.VALUE3}|<p>-</p>|high|
|Intel RST: Logical disk "{#LDNAME}" is "{ITEM.VALUE}"|<p>-</p>|information|
|Intel RST: Logical disk "{#LDNAME}" is "{ITEM.VALUE}"|<p>-</p>|warning|
|Intel RST: Logical disk "{#LDNAME}" state was changed from "Degraded" state to  "{ITEM.VALUE}"|<p>-</p>|information|
|Intel RST: Logical disk "{#LDNAME}" state was changed from "Failed" state to  "{ITEM.VALUE}"|<p>-</p>|information|
|Intel RST: Physical disk "{#SLOT}" is "{ITEM.VALUE1}". Disk SN is "{ITEM.VALUE2}"|<p>-</p>|information|
|Intel RST: Physical disk "{#SLOT}" is "{ITEM.VALUE1}". Disk SN is "{ITEM.VALUE2}"|<p>-</p>|warning|
|Intel RST: Physical disk "{#SLOT}" is "{ITEM.VALUE}". Disk SN is "{ITEM.VALUE2}"|<p>-</p>|high|
|Intel RST: Physical disk "{#SLOT}" was replaced by  sn "{ITEM.VALUE}"|<p>-</p>|information|
