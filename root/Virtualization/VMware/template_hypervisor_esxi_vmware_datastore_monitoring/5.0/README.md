...
|Average read latency of the datastore $3|<p>-</p>|`Simple check`|vmware.hv.datastore.read[{$URL},{HOST.HOST},{#DATASTORE},latency]<p>Update: 600</p>|
|Datastore Free $3|<p>-</p>|`Simple check`|vmware.hv.datastore.size[{$URL},{HOST.HOST},{#DATASTORE},free]<p>Update: 600</p>|
|Datastore Free % $3|<p>-</p>|`Simple check`|vmware.hv.datastore.size[{$URL},{HOST.HOST},{#DATASTORE},pfree]<p>Update: 600</p>|
|Datastore Total % $3|<p>-</p>|`Simple check`|vmware.hv.datastore.size[{$URL},{HOST.HOST},{#DATASTORE},total]<p>Update: 600</p>|
|Average write latency of the datastore $3|<p>-</p>|`Simple check`|vmware.hv.datastore.write[{$URL},{HOST.HOST},{#DATASTORE},latency]<p>Update: 600</p>|
## Triggers

|Name|Description|Priority|
|----|-----------|----|
|Memory usage is above 95%|<p>-</p>|high|
|Overall status = {ITEM.VALUE}|<p>-</p>|high|
|{#DATASTORE} is  85% Used|<p>-</p>|average|
|{#DATASTORE} is  90% Used|<p>-</p>|high|
|{#DATASTORE} is  95% Used|<p>-</p>|disaster|
