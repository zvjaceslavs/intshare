...
|Number of bytes received on interface {#IFDESC}|<p>-</p>|`Simple check`|vmware.vm.net.if.in[{$URL},{$UUID},{#IFNAME},bps]<p>Update: 1m</p>|
|Number of packets received on interface {#IFDESC}|<p>-</p>|`Simple check`|vmware.vm.net.if.in[{$URL},{$UUID},{#IFNAME},pps]<p>Update: 1m</p>|
|Number of bytes transmitted on interface {#IFDESC}|<p>-</p>|`Simple check`|vmware.vm.net.if.out[{$URL},{$UUID},{#IFNAME},bps]<p>Update: 1m</p>|
|Number of packets transmitted on interface {#IFDESC}|<p>-</p>|`Simple check`|vmware.vm.net.if.out[{$URL},{$UUID},{#IFNAME},pps]<p>Update: 1m</p>|
|Average number of bytes read from the disk {#DISKDESC}|<p>-</p>|`Simple check`|vmware.vm.vfs.dev.read[{$URL},{$UUID},{#DISKNAME},bps]<p>Update: 1m</p>|
|Average number of reads from the disk {#DISKDESC}|<p>-</p>|`Simple check`|vmware.vm.vfs.dev.read[{$URL},{$UUID},{#DISKNAME},ops]<p>Update: 1m</p>|
|Average number of bytes written to the disk {#DISKDESC}|<p>-</p>|`Simple check`|vmware.vm.vfs.dev.write[{$URL},{$UUID},{#DISKNAME},bps]<p>Update: 1m</p>|
|Average number of writes to the disk {#DISKDESC}|<p>-</p>|`Simple check`|vmware.vm.vfs.dev.write[{$URL},{$UUID},{#DISKNAME},ops]<p>Update: 1m</p>|
|Free disk space on {#FSNAME}|<p>-</p>|`Simple check`|vmware.vm.vfs.fs.size[{$URL},{$UUID},{#FSNAME},free]<p>Update: 1m</p>|
|Free disk space on {#FSNAME} (percentage)|<p>-</p>|`Simple check`|vmware.vm.vfs.fs.size[{$URL},{$UUID},{#FSNAME},pfree]<p>Update: 1m</p>|
|Total disk space on {#FSNAME}|<p>-</p>|`Simple check`|vmware.vm.vfs.fs.size[{$URL},{$UUID},{#FSNAME},total]<p>Update: 1h</p>|
|Used disk space on {#FSNAME}|<p>-</p>|`Simple check`|vmware.vm.vfs.fs.size[{$URL},{$UUID},{#FSNAME},used]<p>Update: 1m</p>|
## Triggers
