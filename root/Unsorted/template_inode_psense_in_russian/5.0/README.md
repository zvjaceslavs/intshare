...
|----|-----------|----|
|High Alarm Current на {HOST.NAME}|<p>-</p>|high|
|High Alarm Frequency на {HOST.NAME}|<p>-</p>|high|
|High Alarm Summary Current на {HOST.NAME}|<p>-</p>|high|
|High Alarm Voltage на {HOST.NAME}|<p>-</p>|high|
|Low Alarm Current на {HOST.NAME}|<p>-</p>|average|
|Low Alarm Frequency на {HOST.NAME}|<p>-</p>|average|
|Low Alarm Summary Current на {HOST.NAME}|<p>-</p>|average|
|Low Alarm Voltage на {HOST.NAME}|<p>-</p>|average|
|POWER ON {HOST.NAME}|<p>-</p>|information|
|SNMP unavailable on {HOST.NAME}|<p>-</p>|average|
|Датчик электропитания отключен на {HOST.NAME}|<p>-</p>|warning|
|Нулевое напряжение на фазе L1|<p>-</p>|high|
|Нулевое напряжение на фазе L2|<p>-</p>|high|
|Нулевое напряжение на фазе L3|<p>-</p>|high|
|Потеряна связь с датчиком электропитания на {HOST.NAME}|<p>-</p>|high|
