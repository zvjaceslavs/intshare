...
|Device fan $1-1|<p>-</p>|`SNMP agent`|swFanSpeed.1.[{#SNMPVALUE}]<p>Update: 300</p>|
|Device fan $1-2|<p>-</p>|`SNMP agent`|swFanSpeed.2.[{#SNMPVALUE}]<p>Update: 300</p>|
...
|Device temperature, unit $1|<p>-</p>|`SNMP agent`|swTemperatureCurrent[{#SNMPVALUE}]<p>Update: 300</p>|
## Triggers

|Name|Description|Priority|
|----|-----------|----|
|{HOST.NAME} unit {#SNMPVALUE} - 1st fan failed|<p>-</p>|high|
|{HOST.NAME} unit {#SNMPVALUE} - 2nd fan failed|<p>-</p>|high|
|{HOST.NAME} unit {#SNMPVALUE} - temperature high|<p>-</p>|high|
