...
|----|-----------|----|
|Port #1 DES-3526 on {HOSTNAME} is DOWN|<p>-</p>|warning|
|Port #1 DES-3526  on {HOSTNAME} is HALFduplex|<p>-</p>|warning|
|Port #2 DES-3526 on {HOSTNAME} is DOWN|<p>-</p>|warning|
|sysName на {HOSTNAME} был изменен|<p>-</p>|information|
|Адрес {DES-3526:rmon.19.11.1.1.5121.last(0)} DES-3526 был изменен на {HOSTNAME}|<p>-</p>|information|
|Версия прошивки на {HOSTNAME} была изменена|<p>-</p>|information|
|Коммутатор DES-3526 {HOSTNAME} недоступен|<p>Нет Ping {HOSTNAME} более семи проверок</p>|high|
|Коммутатор перезагружен {HOST.NAME} | {HOST.IP}|<p>-</p>|high|
|На коммутаторе  DES-3526 перегружен CPU {HOSTNAME}|<p>-</p>|high|
|Ошибки на порту 1 DES-3526 {HOSTNAME}|<p>-</p>|warning|
|Превышена температура {HOST.NAME}|<p>-</p>|warning|
