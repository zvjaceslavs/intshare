...
|Incoming network traffic on $1|<p>-</p>|`Zabbix agent`|net.if.in[{#IFNAME}]<p>Update: 120</p>|
|Outgoing network traffic on $1|<p>-</p>|`Zabbix agent`|net.if.out[{#IFNAME}]<p>Update: 120</p>|
|Total network traffic on $1|<p>-</p>|`Zabbix agent`|net.if.total[{#IFNAME}]<p>Update: 120</p>|
## Triggers

|Name|Description|Priority|
|----|-----------|----|
|Clock sync problem on {HOST.NAME}|<p>-</p>|information|
|High CPU usage on {HOST.NAME}|<p>-</p>|warning|
|High LTE bandwidth consumption on {HOST.NAME}|<p>-</p>|warning|
|High memory usage on {HOST.NAME}|<p>-</p>|high|
|Hostname was changed on {HOST.NAME}|<p>-</p>|information|
|Low space in /upgflash on {HOST.NAME}|<p>-</p>|high|
|Processor load is too high on {HOST.NAME}|<p>-</p>|warning|
|Too many processes on {HOST.NAME}|<p>-</p>|warning|
|Zabbix agent memory usage on {HOST.NAME}|<p>-</p>|warning|
