...
|----|-----------|----|
|Cpu >= 50% {HOST.NAME}|<p>-</p>|average|
|Cpu >= 80% {HOST.NAME}|<p>-</p>|high|
|Fonte 1 Desconectada {HOST.NAME}|<p>-</p>|high|
|Fonte 1 Desligada {HOST.NAME}|<p>-</p>|high|
|Fonte 2 Desconectada {HOST.NAME}|<p>-</p>|high|
|Fonte 2 Desligada {HOST.NAME}|<p>-</p>|high|
|High Temperature on {HOST.NAME}|<p>-</p>|high|
|Operational status was changed on {HOST.NAME} interface 10giga-ethernet0/0|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface 10giga-ethernet0/1|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface 10giga-ethernet1/0|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface 10giga-ethernet1/1|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface giga-ethernet0/0|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface giga-ethernet0/1|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface giga-ethernet0/2|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface giga-ethernet0/3|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface giga-ethernet0/4|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface giga-ethernet0/5|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface giga-ethernet0/6|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface giga-ethernet0/7|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface gpon1/1|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface gpon1/2|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface gpon1/3|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface gpon1/4|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface gpon2/1|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface gpon2/2|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface gpon2/3|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface gpon2/4|<p>-</p>|information|
