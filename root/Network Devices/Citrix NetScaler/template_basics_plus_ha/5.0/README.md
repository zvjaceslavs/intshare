...
|Vserver {#SNMPVALUE} Client Connections|<p>-</p>|`SNMP agent`|vsvr.cl_conn.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} Health|<p>-</p>|`SNMP agent`|vsvr.health.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} Server Connections|<p>-</p>|`SNMP agent`|vsvr.sr_conn.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} State|<p>-</p>|`SNMP agent`|vsvr.state.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} Total Clients|<p>The total number of established client connections.</p>|`SNMP agent`|vsvr.TotalClients.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} Total Servers|<p>The total number of established server connections.</p>|`SNMP agent`|vsvr.TotalServers.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} vsvrCurServicesDown|<p>-</p>|`SNMP agent`|vsvr.vsvrCurServicesDown.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} vsvrCurServicesOutOfSvc|<p>-</p>|`SNMP agent`|vsvr.vsvrCurServicesOutOfSvc.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} vsvrCurServicesTransToOutOfSvc|<p>-</p>|`SNMP agent`|vsvr.vsvrCurServicesTransToOutOfSvc.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} vsvrCurServicesUnKnown|<p>-</p>|`SNMP agent`|vsvr.vsvrCurServicesUnKnown.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} vsvrCurServicesUp|<p>-</p>|`SNMP agent`|vsvr.vsvrCurServicesUp.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} RxBytesRate|<p>The total number of established client connections.</p>|`SNMP agent`|vsvr.vsvrRxBytesRate.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Vserver {#SNMPVALUE} TxBytesRate|<p>This represents the response rate in bytes per second for this service/vserver.</p>|`SNMP agent`|vsvr.vsvrTxBytesRate.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Interface {#SNMPVALUE} received bytes|<p>-</p>|`SNMP agent`|r_bytes.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Interface {#SNMPVALUE} received packets|<p>-</p>|`SNMP agent`|r_pks.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Interface {#SNMPVALUE} type|<p>-</p>|`SNMP agent`|type.[{#SNMPVALUE}]<p>Update: 1h</p>|
|Interface {#SNMPVALUE} transmitted bytes|<p>-</p>|`SNMP agent`|t_bytes.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Interface {#SNMPVALUE} transmitted packets|<p>-</p>|`SNMP agent`|t_pks.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Service {#SNMPVALUE} Act conn|<p>-</p>|`SNMP agent`|service.actconn.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Service {#SNMPVALUE} Est conn|<p>-</p>|`SNMP agent`|service.estconn.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Service {#SNMPVALUE} IP|<p>-</p>|`SNMP agent`|service.ip.[{#SNMPVALUE}]<p>Update: 1h</p>|
|Service {#SNMPVALUE} port|<p>-</p>|`SNMP agent`|service.port.[{#SNMPVALUE}]<p>Update: 1h</p>|
|Service {#SNMPVALUE} Total req|<p>-</p>|`SNMP agent`|service.totreq.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Service {#SNMPVALUE} Total req bytes|<p>-</p>|`SNMP agent`|service.totreqb.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Service {#SNMPVALUE} Total resp|<p>-</p>|`SNMP agent`|service.totresp.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Service {#SNMPVALUE} Total resp bytes|<p>-</p>|`SNMP agent`|service.totrespb.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Service {#SNMPVALUE} Total recvd pkts|<p>-</p>|`SNMP agent`|service.totresvdpkts.[{#SNMPVALUE}]<p>Update: 15s</p>|
|Service {#SNMPVALUE} Total sent pkts|<p>-</p>|`SNMP agent`|service.totrsentpkts.[{#SNMPVALUE}]<p>Update: 15s</p>|
## Triggers
