...
|UE{#NUMBER} DL MCS|<p>-</p>|`Zabbix trapper`|ue.dl.mcs[{#NUMBER}]<p>Update: 0</p>|
|UE{#NUMBER} DL RadioBearer|<p>-</p>|`Zabbix trapper`|ue.dl.rb[{#NUMBER}]<p>Update: 0</p>|
|UE{#NUMBER} DL|<p>-</p>|`Zabbix trapper`|ue.dl[{#NUMBER}]<p>Update: 0</p>|
|UE{#NUMBER} UL MCS|<p>-</p>|`Zabbix trapper`|ue.ul.mcs[{#NUMBER}]<p>Update: 0</p>|
|UE{#NUMBER} UL SR_BSR|<p>-</p>|`Zabbix trapper`|ue.ul.sr_bsr[{#NUMBER}]<p>Update: 0</p>|
|UE{#NUMBER} UL|<p>-</p>|`Zabbix trapper`|ue.ul[{#NUMBER}]<p>Update: 0</p>|
|CPU{#CPU.NUMBER}利用率|<p>-</p>|`Zabbix agent`|system.cpu.util[{#CPU.NUMBER},,]<p>Update: 10s</p>|
## Triggers

|Name|Description|Priority|
|----|-----------|----|
|aaad 内存泄漏|<p>-</p>|warning|
|cli_server 内存泄漏|<p>-</p>|warning|
|cu_oam_core 内存泄漏|<p>-</p>|warning|
|cwmp 内存泄漏|<p>-</p>|warning|
|cwmp_gsoap 内存泄漏|<p>-</p>|warning|
|dev_mgr 内存泄漏|<p>-</p>|warning|
|dhcpc 内存泄漏|<p>-</p>|warning|
|dhcpd 内存泄漏|<p>-</p>|warning|
|du_oam_core 内存泄漏|<p>-</p>|warning|
|fhmp-serverd 内存泄漏|<p>-</p>|warning|
|gnb_cu_pdcp 内存泄漏|<p>-</p>|warning|
|gnb_du_layer2 内存泄漏|<p>-</p>|warning|
|oam_apps 内存泄漏|<p>-</p>|warning|
|password_policy 内存泄漏|<p>-</p>|warning|
|redis-server 内存泄漏|<p>-</p>|warning|
|rg-bspinfo 内存泄漏|<p>-</p>|warning|
|rg-coredump-mon 内存泄漏|<p>-</p>|warning|
|rg-fsui 内存泄漏|<p>-</p>|warning|
|rg-sysmon 内存泄漏|<p>-</p>|warning|
|rgmomd 内存泄漏|<p>-</p>|warning|
|runsh 内存泄漏|<p>-</p>|warning|
|sysha 内存泄漏|<p>-</p>|warning|
|upgrade_mgmt 内存泄漏|<p>-</p>|warning|
|upgrade_proc 内存泄漏|<p>-</p>|warning|
|webagent 内存泄漏|<p>-</p>|warning|
|aaad进程重启|<p>-</p>|average|
|cli_server.elf进程重启|<p>-</p>|average|
|cu_oam_core进程重启|<p>-</p>|average|
|cwmp.elf进程重启|<p>-</p>|average|
|cwmp_gsoap.elf进程重启|<p>-</p>|average|
|dev_mgr.elf进程重启|<p>-</p>|average|
|dhcpc.elf进程重启|<p>-</p>|average|
|dhcpd.elf进程重启|<p>-</p>|average|
|du_oam_core进程重启|<p>-</p>|average|
|fhmp-serverd.elf进程重启|<p>-</p>|average|
|gnb_cu_pdcp进程重启|<p>-</p>|average|
|gnb_du_layer2进程重启|<p>-</p>|average|
|oam_apps进程重启|<p>-</p>|average|
|password_policy进程重启|<p>-</p>|average|
|redis-server进程重启|<p>-</p>|average|
|rg-bspinfo进程重启|<p>-</p>|average|
|rg-coredump-mon进程重启|<p>-</p>|average|
|rg-fsui进程重启|<p>-</p>|average|
|rg-sysmon进程重启|<p>-</p>|average|
|系统存在Coredump|<p>-</p>|high|
|系统CPU高|<p>-</p>|not classified|
|系统剩余内存不足|<p>-</p>|not classified|
|系统存在僵尸进程|<p>-</p>|high|
|UE {#NUMBER} RB ERROR|<p>-</p>|average|
