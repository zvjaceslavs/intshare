...
|----|-----------|----|
|CRC Errors Rx on port 1 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 2 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 3 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 4 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 5 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 6 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 7 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 8 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 9 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 10 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 11 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 12 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 13 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 14 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 15 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 16 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 17 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 18 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 19 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 20 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 21 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 22 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 23 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 24 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 25 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 26 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 27 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Rx on port 28 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 1 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 2 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 3 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 4 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 5 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 6 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 7 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 8 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 9 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 10 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 11 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 12 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 13 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 14 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 15 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 16 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 17 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 18 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 19 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 20 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 21 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 22 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 23 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 24 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 25 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 26 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 27 on {HOST.NAME}|<p>-</p>|high|
|CRC Errors Tx on port 28 on {HOST.NAME}|<p>-</p>|high|
|High CPU usage on {HOST.NAME}|<p>-</p>|warning|
|Low free memory on {HOST.NAME}|<p>-</p>|warning|
|Port 1 status down on {HOST.NAME}|<p>-</p>|information|
|Port 2 status down on {HOST.NAME}|<p>-</p>|information|
|Port 3 status down on {HOST.NAME}|<p>-</p>|information|
|Port 4 status down on {HOST.NAME}|<p>-</p>|information|
|Port 5 status down on {HOST.NAME}|<p>-</p>|information|
|Port 6 status down on {HOST.NAME}|<p>-</p>|information|
|Port 7 status down on {HOST.NAME}|<p>-</p>|information|
|Port 8 status down on {HOST.NAME}|<p>-</p>|information|
|Port 9 status down on {HOST.NAME}|<p>-</p>|information|
|Port 10 status down on {HOST.NAME}|<p>-</p>|information|
|Port 11 status down on {HOST.NAME}|<p>-</p>|information|
|Port 12 status down on {HOST.NAME}|<p>-</p>|information|
|Port 13 status down on {HOSTNAME}|<p>-</p>|information|
|Port 14 status down on {HOST.NAME}|<p>-</p>|information|
|Port 15 status down on {HOST.NAME}|<p>-</p>|information|
|Port 16 status down on {HOST.NAME}|<p>-</p>|information|
...
|Port 21 status down on {HOST.NAME}|<p>-</p>|information|
|Port 22 status down on {HOST.NAME}|<p>-</p>|information|
|Port 23 status down on {HOST.NAME}|<p>-</p>|information|
|Port 24 status down on {HOST.NAME}|<p>-</p>|information|
|Port 25 status down on {HOST.NAME}|<p>-</p>|information|
|Port 26 status down on {HOST.NAME}|<p>-</p>|information|
|Port 27 status down on {HOST.NAME}|<p>-</p>|information|
|Port 28 status down on {HOST.NAME}|<p>-</p>|information|
