...
|HA Problem Status [{#SNMPVALUE}]|<p>-</p>|`SNMP agent`|haProblemStatus[{#SNMPVALUE}]<p>Update: 120</p>|
...
|Temperature [{#SNMPVALUE}]|<p>-</p>|`SNMP agent`|tempertureSensorValue[{#SNMPVALUE}]<p>Update: 120</p>|
|Processor [{#SNMPVALUE}] Idle Time|<p>-</p>|`SNMP agent`|multiProcIdleTime[{#SNMPVALUE}]<p>Update: 90</p>|
|Processor [{#SNMPVALUE}] System Time|<p>-</p>|`SNMP agent`|multiProcSystemTime[{#SNMPVALUE}]<p>Update: 90</p>|
|Processor [{#SNMPVALUE}] User Time|<p>-</p>|`SNMP agent`|multiProcUserTime[{#SNMPVALUE}]<p>Update: 90</p>|
|FanStatus [{#SNMPVALUE}]|<p>-</p>|`SNMP agent`|fanSpeedSensorValue[{#SNMPVALUE}]<p>Update: 120</p>|
...
|----|-----------|----|
|{HOSTNAME} HA State Change|<p>-</p>|warning|
|{HOSTNAME} HA State not Active/Standby|<p>-</p>|average|
|{HOSTNAME} Low memory|<p>-</p>|average|
|{HOSTNAME} Policy installed|<p>-</p>|information|
|HA Status [{#SNMPVALUE}]|<p>-</p>|average|
|Free disk space is less than 20% on volume {#SNMPVALUE}|<p>-</p>|warning|
|{HOSTNAME} Processor usage high on CPU {#SNMPVALUE}|<p>-</p>|average|
