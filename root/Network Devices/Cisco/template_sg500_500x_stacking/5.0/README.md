...
|Environment fan status, unit $1|<p>The mandatory state of the FAN 1 being instrumented</p>|`SNMP agent`|rlPhdUnitEnvParamFan1Status[{#SNMPVALUE}]<p>Update: 3600</p>|
|Environment temp. status, unit $1|<p>Display environment monitoring chassis temperature status</p>|`SNMP agent`|rlPhdUnitEnvParamMonitorTemperatureStatus[{#SNMPVALUE}]<p>Update: 300</p>|
|Stack device id, unit $1|<p>Asset tag of the product.</p>|`SNMP agent`|rlPhdUnitGenParamServiceTag[{#SNMPVALUE}]<p>Update: 3600</p>|
|Stack device serial, unit $1|<p>Asset tag of the product.</p>|`SNMP agent`|rlPhdUnitGenParamSerialNum[{#SNMPVALUE}]<p>Update: 3600</p>|
|Stack device uptime, unit $1|<p>Up time of the unit in 100th of second (sec/100).</p>|`SNMP agent`|rlPhdUnitEnvParamUpTime[{#SNMPVALUE}]<p>Update: 3600</p>|
...
|----|-----------|----|
|CPU usage exceeded 50%|<p>-</p>|information|
|CPU usage exceeded 60%|<p>-</p>|warning|
|CPU usage exceeded 80%|<p>-</p>|high|
|{HOST.NAME} {#SNMPVALUE} fan critical|<p>-</p>|average|
|{HOST.NAME} {#SNMPVALUE} fan failed|<p>-</p>|high|
|{HOST.NAME} {#SNMPVALUE} fan warning|<p>-</p>|warning|
|{HOST.NAME} {#SNMPVALUE} temperature critical|<p>-</p>|disaster|
|{HOST.NAME} {#SNMPVALUE} temperature high|<p>-</p>|high|
|Incoming use on interface {#SNMPVALUE} exceed 80% for the last 5 minutes|<p>-</p>|warning|
|Outgoing use on interface {#SNMPVALUE} exceed 80% for the last 5 minutes|<p>-</p>|warning|
|{HOST.NAME} link changed on {#SNMPVALUE}: {ITEM.VALUE1}|<p>-</p>|disaster|
