...
|----|-----------|----|
|Alta Temperatura no {HOSTNAME}|<p>-</p>|high|
|Fan 2 Estado não é normal em {HOSTNAME}|<p>Valid fan states are: normal(1): warning(2): critical(3): shutdown(4): notPresent(5): notFunctioning(6): Anything other than 1 is problematic.</p>|average|
|Fan 3 state is not normal on {HOSTNAME}|<p>-</p>|average|
|Fan 4 state is not normal on {HOSTNAME}|<p>-</p>|average|
|{HOSTNAME} Esta Indisponível!!|<p>-</p>|disaster|
|{HOSTNAME} has been rebooted|<p>Uptime is less than 10 minutes.</p>|average|
