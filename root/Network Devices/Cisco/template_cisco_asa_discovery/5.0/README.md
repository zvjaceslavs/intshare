...
|{HOST.NAME} Connections In Use > 80 %|<p>Connections In Use > 80 %</p>|high|
...
|{HOST.NAME} Failover status as changed|<p>-</p>|high|
|{HOST.NAME} is unavailable by ICMP|<p>{HOST.IP} not responding to ICMP in 3 minutes</p>|disaster|
|{HOST.NAME} Memory Free < 5 %|<p>Memory Free < 5 %</p>|average|
|{HOST.NAME} reloaded|<p>{HOST.NAME} reloaded</p>|average|
