...
|Utilization on Memory Pool "$1"|<p>CISCO-MEMORY-POOL-MIB::ciscoMemoryPoolUtilization5Min This is the memory pool utilization for 5 minutes.</p>|`SNMP agent`|ciscoMemoryPoolUtilization5Min["{#SNMPVALUE}"]<p>Update: 300</p>|
...
|Speed of $2 Sensor "$1"/$3|<p>CISCO-ENTITY-SENSOR-MIB::entSensorValue This variable reports the most recent measurement seen by the sensor.</p>|`SNMP agent`|entSensorValue["{#SNMPVALUE}",FAN,{#SNMPINDEX}]<p>Update: 300</p>|
|Status of $2 Sensor "$1"/$3|<p>CISCO-ENTITY-SENSOR-MIB::entSensorStatus This variable indicates the present operational status of the sensor.</p>|`SNMP agent`|entSensorStatus["{#SNMPVALUE}",FAN,{#SNMPINDEX}]<p>Update: 300</p>|
...
|Status of $2 Sensor "$1"|<p>CISCO-ENTITY-SENSOR-MIB::entSensorStatus This variable indicates the present operational status of the sensor.</p>|`SNMP agent`|entSensorStatus["{#SNMPVALUE}",Load]<p>Update: 60</p>|
|Value of $2 Sensor "$1"|<p>CISCO-ENTITY-SENSOR-MIB::entSensorValue This variable reports the most recent measurement seen by the sensor.</p>|`SNMP agent`|entSensorValue["{#SNMPVALUE}",Load]<p>Update: 60</p>|
...
|$2 on Sensor "$1"/$3|<p>CISCO-ENTITY-SENSOR-MIB::entSensorValue This variable reports the most recent measurement seen by the sensor.</p>|`SNMP agent`|entSensorValue["{#SNMPVALUE}",Temperature,{#SNMPINDEX}]<p>Update: 60</p>|
|Status of $2 Sensor "$1"/$3|<p>CISCO-ENTITY-SENSOR-MIB::entSensorStatus This variable indicates the present operational status of the sensor.</p>|`SNMP agent`|entSensorStatus["{#SNMPVALUE}",Temperature,{#SNMPINDEX}]<p>Update: 60</p>|
|$2 on Sensor "$1"/$3|<p>CISCO-ENTITY-SENSOR-MIB::entSensorValue This variable reports the most recent measurement seen by the sensor.</p>|`SNMP agent`|entSensorValue["{#SNMPVALUE}",Voltage,{#SNMPINDEX}]<p>Update: 60</p>|
|Status of $2 Sensor "$1"/$3|<p>CISCO-ENTITY-SENSOR-MIB::entSensorStatus This variable indicates the present operational status of the sensor.</p>|`SNMP agent`|entSensorStatus["{#SNMPVALUE}",Voltage,{#SNMPINDEX}]<p>Update: 60</p>|
...
|FAN Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|high|
|FAN Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|average|
|Status of Fan Tray "{#SNMPVALUE}" is in partial failure|<p>-</p>|warning|
|Status of Fan Tray "{#SNMPVALUE}" is powered down|<p>-</p>|high|
|Load Sensor "{#SNMPVALUE}" is nonoperational|<p>-</p>|high|
|Load Sensor "{#SNMPVALUE}" is unavailable|<p>-</p>|average|
|Module "{#SNMPVALUE}" is disabled|<p>-</p>|warning|
