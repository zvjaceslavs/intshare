...
|IP SLA {#SNMPINDEX} sense|<p>A sense code for the completion status of the latest RTT operation.</p>|`SNMP agent`|rttMonCtrlAdminSense[{#SNMPINDEX}]<p>Update: 60</p>|
...
|----|-----------|----|
|IP SLA {#SNMPINDEX} on {HOST.NAME} is not OK|<p>-</p>|high|
