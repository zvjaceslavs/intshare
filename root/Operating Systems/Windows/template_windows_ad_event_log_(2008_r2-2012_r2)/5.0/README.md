...
|----|-----------|----|
|Changed domain policy|<p>Змінена політика домену</p>|average|
|Cleaned Security Log|<p>Очищений журнал безпеки</p>|high|
|Create User|<p>Обліковий запис користувача створено</p>|information|
|Delete User|<p>Обліковий запис користувача видалено</p>|information|
|Unlocked User|<p>Обліковий запис користувача розблоковано</p>|information|
|User Off|<p>Обліковий запис користувача відключено</p>|information|
|User On|<p>Обліковий запис користувача включено</p>|information|
|User Password Reset|<p>Пароль користувача скинуто</p>|information|
