...
|----|-----------|----|
|Active Directory Web Services Error on {HOST.NAME}|<p>-</p>|not classified|
|DFS Replication Events Error on {HOST.NAME}|<p>-</p>|not classified|
|Directory Service Events Error on {HOST.NAME}|<p>-</p>|not classified|
|DNS Server Events Error on {HOST.NAME}|<p>-</p>|not classified|
|I/O Database Reads/sec > 10 on {HOST.NAME}|<p>-</p>|warning|
|I/O Database Reads Average Latency > 15ms on {HOST.NAME}|<p>-</p>|warning|
|I/O Log Writes Average Latency > 10ms on {HOST.NAME}|<p>-</p>|warning|
