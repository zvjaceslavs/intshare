...
|----|-----------|----|
|Блок Питания  (1.1) - состояние: {ITEM.LASTVALUE}|<p>Обнаружена проблема с <b>Блоком питания (1)</b> Полки (1)!</p>|high|
|Блок Питания  (1.2) - состояние: {ITEM.LASTVALUE}|<p>Обнаружена проблема с <b>Блоком питания (2)</b> Полки (1)!</p>|high|
|Блок Питания  (2.1) - состояние: {ITEM.LASTVALUE}|<p>Обнаружена проблема с <b>Блоком питания (1)</b> Полки (2)!</p>|high|
|Блок Питания  (2.2) - состояние: {ITEM.LASTVALUE}|<p>Обнаружена проблема с <b>Блоком питания (2)</b> Полки (2)!</p>|high|
|Вентилятор БП (1.1) - состояние: {ITEM.LASTVALUE}|<p>Обнаружена проблема с <b>вентилятором</b> Блока питания (1) Полки (1)!</p>|warning|
|Вентилятор БП (1.2) - состояние: {ITEM.LASTVALUE}|<p>Обнаружена проблема с <b>вентилятором</b> Блока питания (2) Полки (1)!</p>|warning|
|Вентилятор БП (2.1) - состояние: {ITEM.LASTVALUE}|<p>Обнаружена проблема с <b>вентилятором</b> Блока питания (1) Полки (2)!</p>|warning|
|Вентилятор БП (2.2) - состояние: {ITEM.LASTVALUE}|<p>Обнаружена проблема с <b>вентилятором</b> Блока питания (2) Полки (2)!</p>|warning|
|Вирт. диск (1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружен проблема с <b>Виртуальным диском (1)</b>.</p>|average|
|Вирт. диск (1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружен критическая проблема с <b>Виртуальным диском (1)</b>!</p>|disaster|
|Вирт. диск (1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружен неизвестная проблема с <b>Виртуальным диском (1)</b>: состояние диска не определено!</p>|warning|
|Вирт. диск (2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружен проблема с <b>Виртуальным диском (2)</b>.</p>|average|
|Вирт. диск (2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружен критическая проблема с <b>Виртуальным диском (2)</b>!</p>|disaster|
|Вирт. диск (2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружен неизвестная проблема с <b>Виртуальным диском (2)</b>: состояние диска не определено!</p>|warning|
|Контроллер (A) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Контроллером (A)</b>.</p>|average|
|Контроллер (A) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Контроллером (A)</b>!</p>|disaster|
|Контроллер (B) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Контроллером (B)</b>.</p>|average|
|Контроллер (B) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Контроллером (B)</b>!</p>|disaster|
|Полка (1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Полкой (1)</b>!</p>|average|
|Полка (1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Полкой (1)</b>!</p>|disaster|
|Полка (2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Полкой (2)</b>!</p>|disaster|
|Порт (A1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>У Порта <b>(A1)</b> изменилось состояние!</p>|average|
|Порт (A2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>У Порта <b>(A2)</b> изменилось состояние!</p>|average|
|Порт (A3) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>У Порта <b>(A3)</b> изменилось состояние!</p>|average|
|Порт (A4) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>У Порта <b>(A4)</b> изменилось состояние!</p>|average|
|Порт (B1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>У Порта <b>(B1)</b> изменилось состояние!</p>|average|
|Порт (B1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>У Порта <b>(B1)</b> изменилось состояние!</p>|average|
|Порт (B2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>У Порта <b>(B2)</b> изменилось состояние!</p>|average|
|Порт (B2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>У Порта <b>(B2)</b> изменилось состояние!</p>|average|
|Порт (B3) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>У Порта <b>(B3)</b> изменилось состояние!</p>|average|
|Порт (B4) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>У Порта <b>(B4)</b> изменилось состояние!</p>|average|
|Устройство - общее состояние: {ITEM.LASTVALUE}|<p>Внутренний сводный мониторинг <b>СХД</b> сообщает о наличии некритических проблем.</p>|average|
|Устройство - общее состояние: {ITEM.LASTVALUE}|<p>Внутренний сводный мониторинг <b>СХД</b> сообщает о наличии критических проблем!</p>|disaster|
|Физ. диск (1.1) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.1) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (1)</b> в Полке (1).</p>|average|
|Физ. диск (1.1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (1)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (1)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.2) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.2) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (2)</b> в Полке (1).</p>|average|
|Физ. диск (1.2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (2)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (2)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.3) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.3) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.3) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (3)</b> в Полке (1).</p>|average|
|Физ. диск (1.3) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (3)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.3) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (3)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.4) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.4) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.4) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (4)</b> в Полке (1).</p>|average|
|Физ. диск (1.4) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (4)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.4) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (4)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.5) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.5) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.5) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (5)</b> в Полке (1).</p>|average|
|Физ. диск (1.5) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (5)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.5) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (5)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.6) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.6) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.6) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (6)</b> в Полке (1).</p>|average|
|Физ. диск (1.6) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (6)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.6) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (6)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.7) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.7) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.7) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (7)</b> в Полке (1).</p>|average|
|Физ. диск (1.7) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (7)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.7) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (7)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.8) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.8) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.8) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (8)</b> в Полке (1).</p>|average|
|Физ. диск (1.8) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (8)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.8) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (8)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.9) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (9)</b> в Полке (1).</p>|average|
|Физ. диск (1.9) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (9)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.9) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (9)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.10) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.10) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.10) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (10)</b> в Полке (1).</p>|average|
|Физ. диск (1.10) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (10)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.10) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (10)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.11) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.11) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.11) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (11)</b> в Полке (1).</p>|average|
|Физ. диск (1.11) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (11)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.11) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (11)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.12) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.12) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.12) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (12)</b> в Полке (1).</p>|average|
|Физ. диск (1.12) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (12)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.12) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (12)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.13) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.13) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.13) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (13)</b> в Полке (1).</p>|average|
|Физ. диск (1.13) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (13)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.13) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (13)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.14) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.14) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.14) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (14)</b> в Полке (1).</p>|average|
|Физ. диск (1.14) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (14)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.14) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (14)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.15) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.15) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.15) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (15)</b> в Полке (1).</p>|average|
|Физ. диск (1.15) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (15)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.15) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (15)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.16) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.16) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.16) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (16)</b> в Полке (1).</p>|average|
|Физ. диск (1.16) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (16)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.16) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (16)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.17) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.17) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.17) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (17)</b> в Полке (1).</p>|average|
|Физ. диск (1.17) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (17)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.17) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (17)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.18) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.18) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.18) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (18)</b> в Полке (1).</p>|average|
|Физ. диск (1.18) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (18)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.18) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (18)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.19) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.19) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.19) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (19)</b> в Полке (1).</p>|average|
|Физ. диск (1.19) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (19)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.19) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (19)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.20) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.20) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.20) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (20)</b> в Полке (1).</p>|average|
|Физ. диск (1.20) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (20)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.20) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (20)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.21) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.21) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.21) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (21)</b> в Полке (1).</p>|average|
|Физ. диск (1.21) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (21)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.21) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (21)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.22) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.22) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.22) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (22)</b> в Полке (1).</p>|average|
|Физ. диск (1.22) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (22)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.22) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (22)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.23) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.23) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.23) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (23)</b> в Полке (1).</p>|average|
|Физ. диск (1.23) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (23)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.23) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (23)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (1.24) - возросло кол-во ошибок: {ITEM.LASTVALUE}|<p>На <b>Физ. диске (1.24) </b> зафиксированы проблемы с операциями ввода вывода.</p>|high|
|Физ. диск (1.24) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (24)</b> в Полке (1).</p>|average|
|Физ. диск (1.24) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (24)</b> в Полке (1)!</p>|disaster|
|Физ. диск (1.24) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (24)</b> в Полке (1): состояние диска не определено!</p>|warning|
|Физ. диск (2.1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (1)</b> в Полке (2).</p>|average|
|Физ. диск (2.1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (1)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.1) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (1)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (2)</b> в Полке (2).</p>|average|
|Физ. диск (2.2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (2)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.2) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (2)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.3) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (3)</b> в Полке (2).</p>|average|
|Физ. диск (2.3) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (3)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.3) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (3)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.4) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (4)</b> в Полке (2).</p>|average|
|Физ. диск (2.4) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (4)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.4) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (4)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.5) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (5)</b> в Полке (2).</p>|average|
|Физ. диск (2.5) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (5)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.5) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (5)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.6) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (6)</b> в Полке (2).</p>|average|
|Физ. диск (2.6) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (6)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.6) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (6)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.7) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (7)</b> в Полке (2).</p>|average|
|Физ. диск (2.7) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (7)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.7) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (7)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.8) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (8)</b> в Полке (2).</p>|average|
|Физ. диск (2.8) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (8)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.8) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (8)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.9) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (9)</b> в Полке (2).</p>|average|
|Физ. диск (2.9) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (9)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.9) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (9)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.10) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (10)</b> в Полке (2).</p>|average|
|Физ. диск (2.10) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (10)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.10) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (10)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.11) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (11)</b> в Полке (2).</p>|average|
|Физ. диск (2.11) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (11)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.11) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (11)</b> в Полке (2): состояние диска не определено!</p>|warning|
|Физ. диск (2.12) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена проблема с <b>Физ. диском (12)</b> в Полке (2).</p>|average|
|Физ. диск (2.12) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена критическая проблема с <b>Физ. диском (12)</b> в Полке (2)!</p>|disaster|
|Физ. диск (2.12) - состояние: {ITEM.LASTVALUE} ({ITEM.LASTVALUE2})|<p>Обнаружена неизвестная проблема с <b>Физ. диском (12)</b> в Полке (2): состояние диска не определено!</p>|warning|
