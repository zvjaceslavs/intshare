...
|Cache Hit below 80%|<p>-</p>|average|
|High Storage Latency|<p>-</p>|warning|
|High Provisioned Space over (95%)|<p>-</p>|high|
|System SW version has changed|<p>System SW version has changed.</p>|information|
