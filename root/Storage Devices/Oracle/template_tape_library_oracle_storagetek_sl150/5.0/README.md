# Template SNMP Tape Library Oracle StorageTek SL150
...
|Controller {#SNMPINDEX} Status|<p>The controller's operational status in enumerated form</p>|`SNMP agent`|slControllerStatusEnum[{#SNMPINDEX}]<p>Update: 1m</p>|
|Cap {#SNMPINDEX} Accessibility|<p>The accessibility of a CAP (open allow/prevent)</p>|`SNMP agent`|slCapAccessibility[{#SNMPINDEX}]<p>Update: 1m</p>|
|Cap {#SNMPINDEX} Access State|<p>The access state of the cap presented as an enumeration</p>|`SNMP agent`|slCapAccessStateEnum[{#SNMPINDEX}]<p>Update: 1m</p>|
|Cap {#SNMPINDEX} is Enabled|<p>The Enabled state of the Cap false(0), true(1)</p>|`SNMP agent`|slCapEnabled[{#SNMPINDEX}]<p>Update: 1m</p>|
|Cap {#SNMPINDEX} Name|<p>The CAP name</p>|`SNMP agent`|slCapName[{#SNMPINDEX}]<p>Update: 1h</p>|
|Cap {#SNMPINDEX} Physical Address|<p>CAP physical address string. NOTE: SL500 returns a logical SCSI Element ID" -- NOTE: For backwards compatibility, the SL500 will continue to return a -- logical SCSI Element ID in lieu of a physical address.</p>|`SNMP agent`|slCapPhysicalAddressStr[{#SNMPINDEX}]<p>Update: 1h</p>|
|Cap {#SNMPINDEX} Rotation Count|<p>The Caps rotation count</p>|`SNMP agent`|slCapRotations[{#SNMPINDEX}]<p>Update: 1m</p>|
|Cap {#SNMPINDEX} Status|<p>The operational status of the CAP presented as an enumeration</p>|`SNMP agent`|slCapStatusEnum[{#SNMPINDEX}]<p>Update: 1m</p>|
|Controller {#SNMPINDEX} Code Version|<p>The controller's code version</p>|`SNMP agent`|slControllerCodeVer[{#SNMPINDEX}]<p>Update: 1h</p>|
|Controller {#SNMPINDEX} Fault LED|<p>The Controller's Fault LED state off=0, on=1</p>|`SNMP agent`|slControllerFaultLED[{#SNMPINDEX}]<p>Update: 1m</p>|
|Controller {#SNMPINDEX} Field Replaceable Unit (FRU)|<p>The controller's Field Replaceable Unit (FRU) based serial number</p>|`SNMP agent`|slControllerFru[{#SNMPINDEX}]<p>Update: 1h</p>|
|Controller {#SNMPINDEX} Safe To Remove LED|<p>The Controller's safe to remove LED state</p>|`SNMP agent`|slControllerSafeToRemoveLED[{#SNMPINDEX}]<p>Update: 1m</p>|
|Controller {#SNMPINDEX} Top Level Condition|<p>The Controller's top-level condition (normal, degraded, notoperative) normal(0), degraded(1), notoperative(2)</p>|`SNMP agent`|slControllerTopLevelCondition[{#SNMPINDEX}]<p>Update: 1m</p>|
|Controller {#SNMPINDEX} Hardware Version|<p>The controller's hardware version</p>|`SNMP agent`|slControllerVersion[{#SNMPINDEX}]<p>Update: 1h</p>|
|Drive {#SNMPINDEX} Cell Content Label|<p>The label of the cart in the drive (zero len string if empty, '??????' if unreadable)</p>|`SNMP agent`|slDriveCellContentLabel[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Cell Status|<p>he status of the drive's cell presented as an enumeration unknown(1), empty(2), full(3)</p>|`SNMP agent`|slDriveCellStatusEnum[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Command Clean|<p>Signal to clean/cancel cleaning of the drive enable(1), cancel(2)</p>|`SNMP agent`|slDriveCommandClean[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Fibre Node Name|<p>Drive's fibre node name (node WWN)</p>|`SNMP agent`|slDriveFibreNodeName[{#SNMPINDEX}]<p>Update: 5m</p>|
|Drive {#SNMPINDEX} Fibre Port A is Enabled|<p>Port A - is port enabled</p>|`SNMP agent`|slDriveFibrePortAPortEnabled[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Fibre Port B is Enabled|<p>Port B - is port enabled</p>|`SNMP agent`|slDriveFibrePortBPortEnabled[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Fibre Port Count|<p>The number of active ports in the drive single(1), dual(2)</p>|`SNMP agent`|slDriveFibrePortCount[{#SNMPINDEX}]<p>Update: 5m</p>|
|Drive {#SNMPINDEX} Get Retries|<p>The number of mount retries performed to the drive</p>|`SNMP agent`|slDriveGetRetries[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Hashed Physical Address|<p>Hashed Physical Address of the drive. NOTE: SL500 returns a logical SCSI Element ID" -- NOTE: For backwards compatibility, the SL500 will continue to return a -- logical SCSI Element ID in lieu of a physical address.</p>|`SNMP agent`|slDriveHashedPhysAddr[{#SNMPINDEX}]<p>Update: 1h</p>|
|Drive {#SNMPINDEX} Idle Seconds|<p>Number of seconds that the drive has been idle (unmounted)</p>|`SNMP agent`|slDriveIdleSeconds[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Interface Type|<p>The drive's physical data transport type</p>|`SNMP agent`|slDriveInterfaceType[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} LED|<p>The drive's Tray LED sate (1=on,0=off)</p>|`SNMP agent`|slDriveLED[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Num Mounts|<p>Number of mounts to the drive</p>|`SNMP agent`|slDriveNumMounts[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Put Retries|<p>The number of dismount retries performed to the drive</p>|`SNMP agent`|slDrivePutRetries[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Serial Number|<p>The drive's electronic serial number</p>|`SNMP agent`|slDriveSerialNum[{#SNMPINDEX}]<p>Update: 1h</p>|
|Drive {#SNMPINDEX} State|<p>The drive's state (empty, loaded, needs cleaning, etc)</p>|`SNMP agent`|slDriveState[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Type|<p>The drive's type, e.g. STK9840, HpUltrium4, etc." -- This text string is derived by the manufacturer and make of the drive. -- Please refer to the "Specification for Tape Cartridge Media Identification" -- Sun/Oracle Doc No. 3136715</p>|`SNMP agent`|slDriveType[{#SNMPINDEX}]<p>Update: 1h</p>|
|Fan Name {#SNMPINDEX}|<p>Name of the fan</p>|`SNMP agent`|slFanName[{#SNMPINDEX}]<p>Update: 1h</p>|
|Fan {#SNMPINDEX} Status|<p>Operational state of the fan failed(1), normal(2)</p>|`SNMP agent`|slFanOperational[{#SNMPINDEX}]<p>Update: 1m</p>|
|Cart {#SNMPINDEX} Host Accessible Status|<p>Indication of host accessible status</p>|`SNMP agent`|slLibCleanCartHostAccessible[{#SNMPINDEX}]<p>Update: 1m</p>|
|Clean Cartridge Label {#SNMPINDEX}|<p>The clean cartridge label</p>|`SNMP agent`|slLibCleanCartLabel[{#SNMPINDEX}]<p>Update: 1m</p>|
|ID of Cleaning Cartridge Location {#SNMPINDEX}|<p>The cleaning cartridge location - SCSI Element ID or translated HLI Address</p>|`SNMP agent`|slLibCleanCartLocationElementID[{#SNMPINDEX}]<p>Update: 1m</p>|
|Number of times that the cartridge {#SNMPINDEX} has been used to clean|<p>Number of times that the cartridge has been used to clean</p>|`SNMP agent`|slLibCleanCartUsageCount[{#SNMPINDEX}]<p>Update: 1m</p>|
|Cleaning cartridge type {#SNMPINDEX}|<p>Cleaning cartridge type (DLT, 9840, LTO, etc)</p>|`SNMP agent`|slLibCleanWarnCartType[{#SNMPINDEX}]<p>Update: 1m</p>|
|Configured warn count threshold {#SNMPINDEX}|<p>Configured warn count threshold</p>|`SNMP agent`|slLibCleanWarnCount[{#SNMPINDEX}]<p>Update: 1m</p>|
|LSM {#SNMPINDEX} Status|<p>The LSM operational state - reported as a string (online, offline, offlinePending). This is hardware-based state, derived from robot state</p>|`SNMP agent`|slLibLSMStatus[{#SNMPINDEX}]<p>Update: 1m</p>|
|Power Supply {#SNMPINDEX} is Installed|<p>Indicates if the supply is installed(2) or not(1)</p>|`SNMP agent`|slPowerSupplyInstalled[{#SNMPINDEX}]<p>Update: 1m</p>|
|Power Supply Name {#SNMPINDEX}|<p>Name of the power supply</p>|`SNMP agent`|slPowerSupplyName[{#SNMPINDEX}]<p>Update: 1h</p>|
|Power Supply {#SNMPINDEX} is Operational|<p>Indicates if the supply is OK(2), meaningless if not-installed</p>|`SNMP agent`|slPowerSupplyOperational[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot's {#SNMPINDEX} Code Version|<p>The robot's code version</p>|`SNMP agent`|slRobotCodeVer[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot {#SNMPINDEX} Fault LED|<p>The Robot's Fault LED status off=0, on=1</p>|`SNMP agent`|slRobotFaultLED[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot's {#SNMPINDEX} Firmware Version|<p>The robot's firmware version</p>|`SNMP agent`|slRobotFirmwareVer[{#SNMPINDEX}]<p>Update: 1h</p>|
|Number of Mount Retries by Robot {#SNMPINDEX}|<p>The number of mount retries performed by the robot</p>|`SNMP agent`|slRobotGetRetries[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot's Hand State {#SNMPINDEX}|<p>The Robot's hand state (cartridge=1, no cartridge=0)</p>|`SNMP agent`|slRobotHandCartStatus[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot Physical Address {#SNMPINDEX}|<p>Robot physical address string. NOTE: SL500 returns a logical SCSI Element ID</p>|`SNMP agent`|slRobotPhysicalAddressStr[{#SNMPINDEX}]<p>Update: 1m</p>|
|Number of Dismount Retries by Robot {#SNMPINDEX}|<p>The number of dismount retries performed by the robot</p>|`SNMP agent`|slRobotPutRetries[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot Serial Number {#SNMPINDEX}|<p>-</p>|`SNMP agent`|slRobotSerialNum[{#SNMPINDEX}]<p>Update: 1h</p>|
|Robot's {#SNMPINDEX} state|<p>The robot's state (empty, loaded, moving, etc)</p>|`SNMP agent`|slRobotState[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot {#SNMPINDEX} Operational Status|<p>The robot's operational status in enumerated form ok(0), error(1), warning(2), info(3), trace(4)</p>|`SNMP agent`|slRobotStatusEnum[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot {#SNMPINDEX} Version|<p>The robot's hardware version</p>|`SNMP agent`|slRobotVersion[{#SNMPINDEX}]<p>Update: 1h</p>|
|Tape {#SNMPINDEX} Host Accessible|<p>Indication of host accessible status</p>|`SNMP agent`|slTapeHostAccessible[{#SNMPINDEX}]<p>Update: 1m</p>|
|Tape {#SNMPINDEX} Location Element ID|<p>Element ID or translated logical HLI Address of the tape cartridge</p>|`SNMP agent`|slTapeLocationElementID[{#SNMPINDEX}]<p>Update: 1h</p>|
|Tape {#SNMPINDEX} Logical Address|<p>Tape Cartridge logical address string</p>|`SNMP agent`|slTapeLogicalAddressStr[{#SNMPINDEX}]<p>Update: 1h</p>|
|Tape {#SNMPINDEX} Partition ID|<p>Tape Cartridge partition ID</p>|`SNMP agent`|slTapePartition[{#SNMPINDEX}]<p>Update: 1d</p>|
|Tape {#SNMPINDEX} Partition Type|<p>Tape Cartridge partition type hli(1), scsi(2), other(3)</p>|`SNMP agent`|slTapePartitionType[{#SNMPINDEX}]<p>Update: 1d</p>|
|Tape {#SNMPINDEX} Physical Address|<p>Tape Cartridge physical address string</p>|`SNMP agent`|slTapePhysicalAddressStr[{#SNMPINDEX}]<p>Update: 1h</p>|
|Current temperature of {#SNMPINDEX}|<p>Current/Present temperature reading</p>|`SNMP agent`|slTempSensorCurrentTemp[{#SNMPINDEX}]<p>Update: 1m</p>|
|Temperature Threshold for Shutdown {#SNMPINDEX}|<p>Temp threshold for automated library activity shutdown</p>|`SNMP agent`|slTempSensorFailThreshold[{#SNMPINDEX}]<p>Update: 1m</p>|
|High Temperature since last boot {#SNMPINDEX}|<p>Storage area peak temp since last machine boot</p>|`SNMP agent`|slTempSensorHighTemp[{#SNMPINDEX}]<p>Update: 1m</p>|
|Temperature Sensor's Name {#SNMPINDEX}|<p>Name of the temperature sensor</p>|`SNMP agent`|slTempSensorName[{#SNMPINDEX}]<p>Update: 1m</p>|
|Warn Threshold {#SNMPINDEX}|<p>Temp threshold for automated warning</p>|`SNMP agent`|slTempSensorWarnThreshold[{#SNMPINDEX}]<p>Update: 1m</p>|
## Triggers

|Name|Description|Priority|
|----|-----------|----|
|Controller {#SNMPINDEX} has an Error Status|<p>-</p>|high|
|Controller {#SNMPINDEX} has an Info Status|<p>-</p>|information|
|Controller {#SNMPINDEX} has an Warning Status|<p>-</p>|warning|
|Controller {#SNMPINDEX} Fault Led is On|<p>-</p>|high|
|Drive {#SNMPINDEX} Needs Cleaning|<p>-</p>|high|
|Fan {#SNMPINDEX} has an Error Status|<p>-</p>|high|
|The cartridge {#SNMPINDEX} has been used to clean is over than 40 times|<p>-</p>|high|
|Robot {#SNMPINDEX} Fault Led is On|<p>-</p>|high|
|Error Operational Status by Robot {#SNMPINDEX}|<p>-</p>|high|
|Warning Operational Status by Robot {#SNMPINDEX}|<p>-</p>|average|
|Tape Library is Going to Shutdown Soon|<p>-</p>|disaster|
|The Current Temperature of Drive [{#SNMPINDEX}] is Very High|<p>-</p>|high|
