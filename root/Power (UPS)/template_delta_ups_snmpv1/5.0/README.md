...
|UPS Line {#SNMPINDEX} Output Voltage|<p>-</p>|`SNMP agent`|upsOutputCurrent.[{#SNMPVALUE}]<p>Update: 60</p>|
|UPS Line {#SNMPINDEX} Output Percent Load|<p>-</p>|`SNMP agent`|upsOutputPercentLoad.[{#SNMPVALUE}]<p>Update: 60</p>|
|UPS Line {#SNMPINDEX} Output Power|<p>-</p>|`SNMP agent`|upsOutputPower.[{#SNMPVALUE}]<p>Update: 60</p>|
|UPS Line {#SNMPINDEX} Output Current|<p>-</p>|`SNMP agent`|upsOutputVoltage.[{#SNMPVALUE}]<p>Update: 60</p>|
|UPS Input {#SNMPINDEX} Current|<p>-</p>|`SNMP agent`|upsInputCurrent.[{#SNMPVALUE}]<p>Update: 60</p>|
|UPS Input {#SNMPINDEX} Frequency|<p>-</p>|`SNMP agent`|upsInputFrequency.[{#SNMPVALUE}]<p>Update: 60</p>|
|UPS Input {#SNMPINDEX} Voltage|<p>-</p>|`SNMP agent`|upsInputVoltage.[{#SNMPVALUE}]<p>Update: 60</p>|
|UPS Line {#SNMPINDEX} Bypass Voltage|<p>-</p>|`SNMP agent`|upsBypassVoltage.[{#SNMPVALUE}]<p>Update: 60</p>|
## Triggers
...
|{HOST.NAME}: UPS Battery Charge Level < 10%|<p>-</p>|disaster|
|{HOST.NAME}: UPS Battery Charge Level < 50%|<p>{HOST.NAME}: UPS Battery Charge Level < 50%</p>|high|
|{HOST.NAME}: UPS Battery Charge Level < 90%|<p>-</p>|average|
|{HOST.NAME}: UPS Battery Charge Level was changed|<p>-</p>|average|
|{HOST.NAME}: UPS Battery Status was changed|<p>-</p>|average|
|{HOST.NAME}: UPS Power Source Type was changed|<p>-</p>|high|
|{HOST.NAME}: UPS was restarted|<p>-</p>|average|
|{HOST.NAME} is unavailable by ICMP|<p>-</p>|average|
|{HOST.NAME}: Line {#SNMPINDEX} load is greater than  > 60%|<p>-</p>|average|
|{HOST.NAME}: Line {#SNMPINDEX} load is greater than  > 80%|<p>-</p>|high|
