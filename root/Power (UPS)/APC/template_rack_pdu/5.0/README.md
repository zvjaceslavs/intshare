...
|----|-----------|----|
|E: Phase1 Overload ({ITEM.LASTVALUE1}A)|<p>-</p>|high|
|E: Phase2 Overload ({ITEM.LASTVALUE1}A)|<p>-</p>|high|
|E: Phase3 Overload ({ITEM.LASTVALUE1}A)|<p>-</p>|high|
|F: Phase1 Overload ({ITEM.LASTVALUE1}A)|<p>-</p>|disaster|
|F: Phase2 Overload ({ITEM.LASTVALUE1}A)|<p>-</p>|disaster|
|F: Phase3 Overload ({ITEM.LASTVALUE1}A)|<p>-</p>|disaster|
|I: No load: phase1 ({ITEM.LASTVALUE1}A)|<p>-</p>|information|
|I: No load: phase2 ({ITEM.LASTVALUE1}A)|<p>-</p>|information|
|I: No load: phase3 ({ITEM.LASTVALUE1}A)|<p>-</p>|information|
