...
|An alarm has been detected, please check|<p>Login to the ups Web UI and check for any alarms there.</p>|warning|
|Battery Depleted|<p>{unknown(1), batteryNormal(2), batteryLow(3), batteryDepleted(4) }</p>|average|
|Battery Low|<p>{unknown(1), batteryNormal(2), batteryLow(3), batteryDepleted(4) }</p>|warning|
|Battery will turn in 5 min|<p>-</p>|average|
|Battery will turn in 15 min|<p>-</p>|warning|
|Last test performed reported a warning, please check|<p>INTEGER {donePass(1), doneWarning(2), doneError(3), aborted(4), inProgress(5), noTestsInitiated(6) }</p>|warning|
|Last test performed reported with error, please check|<p>INTEGER {donePass(1), doneWarning(2), doneError(3), aborted(4), inProgress(5), noTestsInitiated(6) }</p>|average|
