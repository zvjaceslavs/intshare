...
|----|-----------|----|
|Battery 1 low remaining capacity < {$BATTERY_CAPACITY_LOW_CRITICAL}|<p>-</p>|high|
|Battery high temperature > {$BATTERY_TEMP_HIGH_CRITICAL}|<p>-</p>|high|
|Battery high temperature > {$BATTERY_TEMP_HIGH_WARNING}|<p>-</p>|warning|
|Battery low temperature < {$BATTERY_TEMP_LOW_CRITICAL}|<p>-</p>|high|
|Battery low temperature < {$BATTERY_TEMP_LOW_WARNING}|<p>-</p>|warning|
|Lost mains power L1|<p>-</p>|warning|
|Lost mains power L2|<p>-</p>|warning|
