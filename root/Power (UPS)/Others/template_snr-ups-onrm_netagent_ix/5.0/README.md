...
|UPS NetAgent - Batteries are unable to sustain the present load or are degraded|<p>-</p>|high|
|UPS NetAgent - Remaining battery run-time is poor|<p>Battery is low</p>|average|
