...
|----|-----------|----|
|{HOSTNAME} - Network unavailable|<p>-</p>|disaster|
|{HOSTNAME} - Fan Fault|<p>-</p>|average|
|{HOSTNAME} - On Battery Power|<p>-</p>|high|
|{HOSTNAME} - OnBypass Mode|<p>-</p>|average|
|{HOSTNAME} - Active Alarms|<p>Check on the UPS the issue</p>|high|
|{HOSTNAME} - Ambient temperature critical|<p>External Temperature Critical</p>|high|
|{HOSTNAME} - Ambient temperature High|<p>External Temperature High</p>|average|
|{HOSTNAME} - Ambient temperature low|<p>External Temperature Low</p>|average|
|{HOSTNAME} - Ambient temperature too low|<p>External Temperature Too Low</p>|high|
|{HOSTNAME} - Battery Error|<p>-</p>|high|
|{HOSTNAME} - Battery Charge Critical|<p>-</p>|high|
|{HOSTNAME} - Battery Charge Low|<p>-</p>|average|
|{HOSTNAME} - No Input Power|<p>-</p>|high|
|{HOSTNAME} - Output overloaded|<p>-</p>|average|
|{HOSTNAME} - Output status changed|<p>-</p>|average|
