...
|----|-----------|----|
|"Alarmes" on {HOSTNAME}|<p>-</p>|high|
|Humidade Relativa na UPS não está normal|<p>-</p>|high|
|Temperatura na UPS não está normal|<p>-</p>|high|
|{HOSTNAME} Checagem de Status da UPS!|<p>-</p>|warning|
|{HOSTNAME} está em Bypass|<p>-</p>|average|
|{HOSTNAME} está em Manual Bypass|<p>-</p>|warning|
|{HOSTNAME} está inacecível via Rede|<p>-</p>|high|
|{HOSTNAME} está no Automático Bypass|<p>-</p>|warning|
|{HOSTNAME} falha na fonte de Entrada|<p>-</p>|high|
|{HOSTNAME} na Bateria|<p>-</p>|average|
|{HOSTNAME} teste de Bateria Falhou|<p>-</p>|high|
