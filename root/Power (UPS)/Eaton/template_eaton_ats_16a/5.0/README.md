...
|Internal fault on {HOST.NAME} on input 1|<p>-</p>|high|
|Internal fault on {HOST.NAME} on input 2|<p>-</p>|high|
|The input voltage on {HOST.NAME} on input 1 is derated|<p>-</p>|warning|
|The input voltage on {HOST.NAME} on input 1 is missing|<p>-</p>|disaster|
|The input voltage on {HOST.NAME} on input 1 is out of range|<p>-</p>|average|
