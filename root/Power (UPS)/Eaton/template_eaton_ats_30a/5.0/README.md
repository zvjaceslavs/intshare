...
|----|-----------|----|
|There is no output on {HOST.NAME}|<p>-</p>|disaster|
|The output current on {HOST.NAME} is over the limit|<p>-</p>|high|
|The ambient temperature on {HOST.NAME} is over the limit|<p>-</p>|warning|
|The relay, SCR and thermal switch on {HOST.NAME} failed|<p>-</p>|disaster|
|Internal auxiliary power on {HOST.NAME} on input 1 is reported as failure|<p>-</p>|high|
|Internal auxiliary power on {HOST.NAME} on input 2 is reported as failure|<p>-</p>|high|
|A voltage brownout on {HOST.NAME} on input 1 was detected|<p>-</p>|high|
|A voltage brownout on {HOST.NAME} on input 2 was detected|<p>-</p>|high|
|A voltage drop on {HOST.NAME} on input 1 was detected|<p>-</p>|average|
|A voltage drop on {HOST.NAME} on input 2 was detected|<p>-</p>|average|
|The input frequency on {HOST.NAME} on input 1 is out of range|<p>-</p>|average|
|The input frequency on {HOST.NAME} on input 2 is out of range|<p>-</p>|average|
|The input 1 on {HOST.NAME} is not operable|<p>-</p>|disaster|
|The input 2 on {HOST.NAME} is not operable|<p>-</p>|disaster|
|The status of input relay on {HOST.NAME} on input 1 is OPEN|<p>-</p>|high|
|The status of input relay on {HOST.NAME} on input 2 is OPEN|<p>-</p>|high|
|The status of input relay on {HOST.NAME} on input 1 is SHORT|<p>-</p>|high|
|The status of input relay on {HOST.NAME} on input 2 is SHORT|<p>-</p>|high|
|The status of input SCR on {HOST.NAME} on input 1 is OPEN|<p>-</p>|high|
|The status of input SCR on {HOST.NAME} on input 2 is OPEN|<p>-</p>|high|
|The status of input SCR on {HOST.NAME} on input 1 is SHORT|<p>-</p>|high|
|The status of input SCR on {HOST.NAME} on input 2 is SHORT|<p>-</p>|high|
|The status of input SCR thermal on {HOST.NAME} on input 1 is over the limit|<p>-</p>|high|
|The status of input SCR thermal on {HOST.NAME} on input 2 is over the limit|<p>-</p>|high|
