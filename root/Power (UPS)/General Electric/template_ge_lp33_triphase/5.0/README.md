...
|----|-----------|----|
|Battery Extremely Low (<5min) on {HOST.NAME}|<p>-</p>|high|
|Battery Status {ITEM.VALUE} on {HOST.NAME}|<p>-</p>|high|
|ByPass Entered in ON State on {HOST.NAME}|<p>-</p>|high|
|Inverter is OFF on {HOST.NAME}|<p>-</p>|high|
|L1 Load Output is HIGH on {HOST.NAME} - Load: {ITEM.VALUE}|<p>-</p>|high|
|L2 Load Output is HIGH on {HOST.NAME} - Load: {ITEM.VALUE}|<p>-</p>|high|
|L3 Load Output is HIGH on {ITEM.LOAD} - Load: {ITEM.VALUE}|<p>-</p>|high|
|UPS Rectifier is OFF on {HOST.NAME}|<p>-</p>|average|
|{ITEM.VALUE} Alarm(s) Present(s) on {HOST.NAME}|<p>-</p>|average|
