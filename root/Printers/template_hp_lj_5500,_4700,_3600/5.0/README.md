...
|----|-----------|----|
|Door_open|<p>Check printer door!!!</p>|warning|
|HP_Paper_Jam|<p>Present Paper Jam!!! Clear Printer from stacked paper.</p>|high|
|HP_Paper_Out|<p>No Paper. Inserrt paper. Load Tray 2.</p>|warning|
|HP_PeripheralError|<p>Check the printer</p>|high|
|HP_Printer_Status|<p>Error staus. Check The printer.</p>|high|
|Replace Black toner|<p>Black toner empty Replace Black cartridge.</p>|high|
|Replace Cyan toner|<p>Cyan toner empty. Replace Cyan cartridge.</p>|high|
|Replace Image Fuser Kit|<p>Image Fuser Kit level low. Replace Image Fuser Kit unit.</p>|high|
|Replace Image Transfer Kit|<p>Image Transfer Kit level low. Replace Image Transfer Kit unit.</p>|high|
|Replace Yellow toner|<p>Yellow toner empty. Replace Yellow cartridge.</p>|high|
