...
|Media Path Description of supplies $1|<p>-</p>|`SNMP agent`|prtMediaPathDescription[{#SNMPVALUE}]<p>Update: 3600</p>|
|Media Path Status of supplies $1|<p>-</p>|`SNMP agent`|prtMediaPathStatus[{#SNMPVALUE}]<p>Update: 600</p>|
|Media Path Type of supplies $1|<p>-</p>|`SNMP agent`|prtMediaPathType[{#SNMPVALUE}]<p>Update: 3600</p>|
|Cover $1|<p>-</p>|`SNMP agent`|prtCoverDescription[{#SNMPVALUE}]<p>Update: 3600</p>|
|Cover Status of $1|<p>-</p>|`SNMP agent`|prtCoverStatus[{#SNMPVALUE}]<p>Update: 600</p>|
|Input Capacity $1|<p>-</p>|`Calculated`|prtInputCapacity[{#SNMPVALUE}]<p>Update: 600</p>|
|Input current level $1|<p>-</p>|`SNMP agent`|prtInputCurrentLevel[{#SNMPVALUE}]<p>Update: 600</p>|
|Input $1|<p>-</p>|`SNMP agent`|prtInputDescription[{#SNMPVALUE}]<p>Update: 3600</p>|
|Input max capacity $1|<p>-</p>|`SNMP agent`|prtInputMaxCapacity[{#SNMPVALUE}]<p>Update: 3600</p>|
|Input Media Name $1|<p>-</p>|`SNMP agent`|prtInputMediaName[{#SNMPVALUE}]<p>Update: 3600</p>|
|Input Model $1|<p>-</p>|`SNMP agent`|prtInputModel[{#SNMPVALUE}]<p>Update: 3600</p>|
|Input SerialNumber $1|<p>-</p>|`SNMP agent`|prtInputSerialNumber[{#SNMPVALUE}]<p>Update: 3600</p>|
|Input status $1|<p>-</p>|`SNMP agent`|prtInputStatus[{#SNMPVALUE}]<p>Update: 600</p>|
|Input Type $1|<p>-</p>|`SNMP agent`|prtInputType[{#SNMPVALUE}]<p>Update: 3600</p>|
|Output $1|<p>-</p>|`SNMP agent`|prtOutputDescription[{#SNMPVALUE}]<p>Update: 3600</p>|
|Output max Capacity $1|<p>-</p>|`SNMP agent`|prtOutputMaxCapacity[{#SNMPVALUE}]<p>Update: 3600</p>|
|Output remaining Capacity $1|<p>-</p>|`SNMP agent`|prtOutputRemainingCapacity[{#SNMPVALUE}]<p>Update: 600</p>|
|Output Status $1|<p>-</p>|`SNMP agent`|prtOutputStatus[{#SNMPVALUE}]<p>Update: 600</p>|
|Color Value of supplies $1|<p>-</p>|`SNMP agent`|prtMarkerColorantValue[{#SNMPVALUE}]<p>Update: 3600</p>|
|Capacity of supplies $1|<p>-</p>|`Calculated`|prtMarkerSuppliesCapacity[{#SNMPVALUE}]<p>Update: 600</p>|
|Description of supplies $1|<p>-</p>|`SNMP agent`|prtMarkerSuppliesDescription[{#SNMPVALUE}]<p>Update: 3600</p>|
|Level of supplies $1|<p>-</p>|`SNMP agent`|prtMarkerSuppliesLevel[{#SNMPVALUE}]<p>Update: 600</p>|
|max Capacity of supplies $1|<p>-</p>|`SNMP agent`|prtMarkerSuppliesMaxCapacity[{#SNMPVALUE}]<p>Update: 3600</p>|
