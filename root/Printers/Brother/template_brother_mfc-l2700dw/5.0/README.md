...
|$1 Current Capacity|<p>-</p>|`SNMP agent`|ConsumableCurrentCapacity[{#SNMPVALUE}]<p>Update: 30</p>|
|$1 Max Capacity|<p>-</p>|`SNMP agent`|ConsumableMaxCapacity[{#SNMPVALUE}]<p>Update: 30</p>|
...
|----|-----------|----|
|HTTP Service is Unreachable at {HOST.NAME}|<p>-</p>|high|
|JetDirect Service is Unreachable at {HOST.NAME}|<p>-</p>|high|
|Printer Spooler Service is Unreachable at {HOST.NAME}|<p>-</p>|high|
|Уровень тонера  {HOSTNAME} < 10 %|<p>-</p>|warning|
|Уровень тонера  {HOSTNAME} < 20 %|<p>-</p>|information|
|Operational status was changed on {HOST.NAME} interface {#SNMPVALUE}|<p>-</p>|information|
|{HOSTNAME} {#SNMPVALUE} - Critical: {ITEM.LASTVALUE}|<p>Checks if at "critical" level for Toners (code = 0) or drum/belt (<10%)</p>|high|
|{HOSTNAME} {#SNMPVALUE} - Low Warning: {ITEM.LASTVALUE}|<p>Checks if at "warning" level for Toners (code = -2) or drum/belt (>10% & <30%)</p>|warning|
