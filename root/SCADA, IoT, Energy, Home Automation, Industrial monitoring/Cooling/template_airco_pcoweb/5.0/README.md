...
|Inbound errors on interface $1|<p>-</p>|`SNMP agent`|ifInErrors[{#SNMPVALUE}]<p>Update: 60</p>|
...
|----|-----------|----|
|General Alarm Active on {HOST.HOST}|<p>-</p>|high|
|Human Maintenance Requested on {HOST.HOST}|<p>-</p>|average|
|Room Humidity @ {HOST.HOST} < 20%|<p>-</p>|warning|
|Room Humidity @ {HOST.HOST} > 80%|<p>-</p>|warning|
|Room Temperature @ {HOST.HOST} is < 16|<p>-</p>|warning|
|Room Temperature @ {HOST.HOST} is > 28|<p>-</p>|high|
|Set Point Temperature on {HOST.HOST} > 25°C|<p>-</p>|average|
|Supply Fan on {HOST.HOST} Runs > 80%|<p>-</p>|warning|
