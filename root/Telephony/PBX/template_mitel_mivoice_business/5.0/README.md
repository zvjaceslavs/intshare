...
|----|-----------|----|
|MCD alarm state on {HOSTNAME}|<p>The current overall alarm level for the call server. This trigger is constrained to only fire from 0730 to 1800</p>|average|
