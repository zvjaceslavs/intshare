...
|----|-----------|----|
|AV license days remaining less than 30 days|<p>-</p>|warning|
|Number of files scanned equal 0|<p>Кол-во отсканированных файлов за последние 5 минут равно 0.</p>|average|
|Processor load is too high|<p>-</p>|average|
