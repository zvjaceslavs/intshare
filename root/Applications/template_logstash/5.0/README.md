...
|----|-----------|----|
|Logstash check failed|<p>-</p>|average|
|Logstash discovery failed|<p>-</p>|warning|
|Logstash heartbeat|<p>-</p>|warning|
|Logstash JVM Heap used percent is high|<p>JVM heap used percent average is above 75% for 30m.</p>|average|
|Logstash JVM Heap used percent is TOO HIGH|<p>JVM heap used percent average is above 90% during 30m.</p>|high|
|Logstash Template and Script version mismatched|<p>-</p>|information|
