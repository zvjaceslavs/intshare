...
|----|-----------|----|
|Varnish: Service response time is too high (over {$VARNISH.RESPONSE_TIME.MAX.WARN}s for 5m)|<p>-</p>|warning|
|Varnish: Service is down|<p>-</p>|average|
|Varnish: Process is not running|<p>-</p>|high|
|Varnish: Failed to fetch stats (or no data for 10m)|<p>Zabbix has not received data for stats for the last 10m.</p>|warning|
|Varnish: Has been restarted (uptime < 10m)|<p>Uptime is less than 10 minutes</p>|information|
