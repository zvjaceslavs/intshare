...
|{#SNMPVALUE} Status|<p>-</p>|`SNMP agent`|ifOperStatus.[{#SNMPINDEX}]<p>Update: 1m</p>|
|CPU Load Placa {#SNMPINDEX}|<p>-</p>|`SNMP agent`|.1.3.6.1.4.1.3902.1015.2.1.1.3.1.9.[{#SNMPINDEX}]<p>Update: 1m</p>|
|Temperatura Placa {#SNMPINDEX}|<p>-</p>|`SNMP agent`|.1.3.6.1.4.1.3902.1015.2.1.3.13.5.1.1.[{#SNMPINDEX}]<p>Update: 1m</p>|
|Status Placa {#SNMPINDEX}|<p>-</p>|`SNMP agent`|1.3.6.1.4.1.3902.1015.2.1.1.3.1.5.[{#SNMPINDEX}]<p>Update: 1m</p>|
|{#SNMPVALUE}|<p>-</p>|`SNMP agent`|.1.3.6.1.4.1.3902.1012.3.13.1.1.13.[{#SNMPINDEX}]<p>Update: 1m</p>|
|Fan {#SNMPINDEX}|<p>-</p>|`SNMP agent`|.1.3.6.1.4.1.3902.1015.2.1.3.10.10.10.1.7.[{#SNMPINDEX}]<p>Update: 1m</p>|
## Triggers

|Name|Description|Priority|
|----|-----------|----|
|Interface Down|<p>-</p>|high|
