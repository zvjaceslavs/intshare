...
|----|-----------|----|
|Call failed caused by unexpected interaction from a gateway|<p>-</p>|warning|
|Call failed caused by unexpected interaction from a proxy|<p>-</p>|warning|
|Lync load call failure index too high|<p>-</p>|warning|
|Lync media connectiviti check failures too high|<p>-</p>|warning|
|Lync Server Mediation service stopped|<p>-</p>|average|
|Lync Server Replica Replicator Agent service stopped|<p>-</p>|average|
