...
|----|-----------|----|
|Misalignment of the upper NTP has exceeded the 5s [{$NTP_IP}]|<p>-</p>|average|
|Misalignment of the upper NTP has exceeded the 50ms [{$NTP_IP}]|<p>-</p>|warning|
|NTP servers are synchronized has been changed . [{$NTP_IP}]|<p>-</p>|information|
# NTP
