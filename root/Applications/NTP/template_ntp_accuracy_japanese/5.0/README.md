...
|----|-----------|----|
|上位NTPとのずれが5sを超えました({$NTP_IP})|<p>-</p>|average|
|上位NTPとのずれが50msを超えました({$NTP_IP})|<p>-</p>|warning|
|同期しているNTPサーバが変更されました。({$NTP_IP})|<p>-</p>|information|
# NTPテンプレート
...
|Name|Description|Priority|
|----|-----------|----|
|上位NTPとのずれが5sを超えました|<p>-</p>|average|
|上位NTPとのずれが50msを超えました|<p>-</p>|warning|
|同期しているNTPサーバが変更されました。|<p>-</p>|information|
