...
|Last day events URL №{#SNMPINDEX}|<p>-</p>|`SNMP agent`|lastday.attacks.events.url[{#SNMPINDEX}]<p>Update: 15m</p>|
|Last day attacks (attacked ip address №{#SNMPINDEX})|<p>-</p>|`SNMP agent`|lastday.attacks.attacked.ip[{#SNMPINDEX}]<p>Update: 15m</p>|
|Last day events name №{#SNMPINDEX}|<p>-</p>|`SNMP agent`|lastdayevents.events.name[{#SNMPINDEX}]<p>Update: 15m</p>|
|Detection interface name {#SNMPVALUE}|<p>-</p>|`SNMP agent`|detection.interface.name.[{#SNMPVALUE}]<p>Update: 1h</p>|
|Detection interface state discription {#SNMPVALUE}|<p>-</p>|`SNMP agent`|detection.interface.state.discription.[{#SNMPVALUE}]<p>Update: 2m</p>|
|Detection interface state {#SNMPVALUE}|<p>-</p>|`SNMP agent`|detection.interface.state.[{#SNMPVALUE}]<p>Update: 2m</p>|
|Last day attacks (events count) №{#SNMPINDEX}|<p>-</p>|`SNMP agent`|lastday.attacks.events.count[{#SNMPINDEX}]<p>Update: 15m</p>|
|Last day attacks (attacker ip addresses №{#SNMPINDEX})|<p>-</p>|`SNMP agent`|lastday.attacks.attacker.ip[{#SNMPINDEX}]<p>Update: 15m</p>|
## Triggers

|Name|Description|Priority|
|----|-----------|----|
|{HOST.NAME} software version changed|<p>-</p>|information|
|{HOST.NAME} high growth of high severity attacks (>{$ATCKS.HIGH} events from last time)|<p>-</p>|warning|
|{HOST.NAME} high growth of medium severity attacks (>{$ATCKS.MED} events from last time)|<p>-</p>|warning|
|{HOST.NAME} high CPU load (over {$CPU.LOAD}% for 5 min)|<p>-</p>|warning|
|{HOST.NAME} license expire soon ({#SNMPVALUE} days left)|<p>-</p>|warning|
|{HOST.NAME} high RAM usage (over {$RAM.USAGE}% for 5 min)|<p>-</p>|warning|
|{HOST.NAME} Sensor service status changed to down|<p>-</p>|warning|
|{HOST.NAME} services down|<p>-</p>|warning|
|{HOST.NAME} has been restarted (uptime < 10m)|<p>-</p>|warning|
|{HOST.NAME} high system partition usage (over {$CPU.LOAD}%)|<p>-</p>|warning|
|{HOST.NAME} {#SNMPVALUE} detection interface state changed to down|<p>-</p>|high|
