...
|----|-----------|----------|--------|
|{HOST.NAME} - Free space on datastore {#DATASTORE} is {ITEM.LASTVALUE1} - {ITEM.LASTVALUE2} remaining|<p>-</p>|<p>**Expression**: {Virt VMware Hypervisor:vmware.hv.datastore.size[{$URL},Virt VMware Hypervisor,{#DATASTORE},pfree].min(5m)}<=90 and {Virt VMware Hypervisor:vmware.hv.datastore.size[{$URL},Virt VMware Hypervisor,{#DATASTORE},free].min(5m)}<=0</p><p>**Recovery expression**: {Virt VMware Hypervisor:vmware.hv.datastore.size[{$URL},Virt VMware Hypervisor,{#DATASTORE},pfree].min(5m)}>=88</p>|average|
|{HOST.NAME} - Free space on datastore {#DATASTORE} is {ITEM.LASTVALUE1} - {ITEM.LASTVALUE2} remaining|<p>-</p>|<p>**Expression**: {Virt VMware Hypervisor:vmware.hv.datastore.size[{$URL},Virt VMware Hypervisor,{#DATASTORE},pfree].min(5m)}<=95 and {Virt VMware Hypervisor:vmware.hv.datastore.size[{$URL},Virt VMware Hypervisor,{#DATASTORE},free].min(5m)}<=0</p><p>**Recovery expression**: </p>|high|
|{HOST.NAME} - Free space on datastore {#DATASTORE} is {ITEM.LASTVALUE1} - {ITEM.LASTVALUE2} remaining (LLD)|<p>-</p>|<p>**Expression**: {Virt VMware Hypervisor:vmware.hv.datastore.size[{$URL},Virt VMware Hypervisor,{#DATASTORE},pfree].min(5m)}<=90 and {Virt VMware Hypervisor:vmware.hv.datastore.size[{$URL},Virt VMware Hypervisor,{#DATASTORE},free].min(5m)}<=0</p><p>**Recovery expression**: {Virt VMware Hypervisor:vmware.hv.datastore.size[{$URL},Virt VMware Hypervisor,{#DATASTORE},pfree].min(5m)}>=88</p>|average|
|{HOST.NAME} - Free space on datastore {#DATASTORE} is {ITEM.LASTVALUE1} - {ITEM.LASTVALUE2} remaining (LLD)|<p>-</p>|<p>**Expression**: {Virt VMware Hypervisor:vmware.hv.datastore.size[{$URL},Virt VMware Hypervisor,{#DATASTORE},pfree].min(5m)}<=95 and {Virt VMware Hypervisor:vmware.hv.datastore.size[{$URL},Virt VMware Hypervisor,{#DATASTORE},free].min(5m)}<=0</p><p>**Recovery expression**: </p>|high|
