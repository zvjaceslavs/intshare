...
|Interface [{#SNMPVALUE}] Admin Status (LLD)|<p>-</p>|`SNMP agent`|SNMP-Interface-Admin-Status.[{#SNMPVALUE}]<p>Update: 30</p>|
|Interface [{#SNMPVALUE}] Description (LLD)|<p>-</p>|`SNMP agent`|SNMP-Interface-Description.[{#SNMPVALUE}]<p>Update: 1800</p>|
|Interface [{#SNMPVALUE}] IN Error (LLD)|<p>-</p>|`SNMP agent`|SNMP-Interface-IN-Error.[{#SNMPVALUE}]<p>Update: 60</p>|
...
|Interface [{#SNMPVALUE}] Operation Status (LLD)|<p>-</p>|`SNMP agent`|SNMP-Interface-Operation-Status.[{#SNMPVALUE}]<p>Update: 30</p>|
