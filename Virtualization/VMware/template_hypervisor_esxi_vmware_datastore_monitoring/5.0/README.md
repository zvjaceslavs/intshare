...
|Average read latency of the datastore $3 (LLD)|<p>-</p>|`Simple check`|vmware.hv.datastore.read[{$URL},{HOST.HOST},{#DATASTORE},latency]<p>Update: 600</p>|
|Datastore Free $3 (LLD)|<p>-</p>|`Simple check`|vmware.hv.datastore.size[{$URL},{HOST.HOST},{#DATASTORE},free]<p>Update: 600</p>|
|Datastore Free % $3 (LLD)|<p>-</p>|`Simple check`|vmware.hv.datastore.size[{$URL},{HOST.HOST},{#DATASTORE},pfree]<p>Update: 600</p>|
|Datastore Total % $3 (LLD)|<p>-</p>|`Simple check`|vmware.hv.datastore.size[{$URL},{HOST.HOST},{#DATASTORE},total]<p>Update: 600</p>|
|Average write latency of the datastore $3 (LLD)|<p>-</p>|`Simple check`|vmware.hv.datastore.write[{$URL},{HOST.HOST},{#DATASTORE},latency]<p>Update: 600</p>|
## Triggers

|Name|Description|Expression|Priority|
|----|-----------|----------|--------|
|{#DATASTORE} is  85% Used|<p>-</p>|<p>**Expression**: {Template Virt VMware Hypervisor ESXi - Andre Bello:vmware.hv.datastore.size[{$URL},Template Virt VMware Hypervisor ESXi - Andre Bello,{#DATASTORE},pfree].last()}<15</p><p>**Recovery expression**: </p>|average|
|{#DATASTORE} is  90% Used|<p>-</p>|<p>**Expression**: {Template Virt VMware Hypervisor ESXi - Andre Bello:vmware.hv.datastore.size[{$URL},Template Virt VMware Hypervisor ESXi - Andre Bello,{#DATASTORE},pfree].last()}<10</p><p>**Recovery expression**: </p>|high|
|{#DATASTORE} is  95% Used|<p>-</p>|<p>**Expression**: {Template Virt VMware Hypervisor ESXi - Andre Bello:vmware.hv.datastore.size[{$URL},Template Virt VMware Hypervisor ESXi - Andre Bello,{#DATASTORE},pfree].last()}<5</p><p>**Recovery expression**: </p>|disaster|
|{#DATASTORE} is  85% Used (LLD)|<p>-</p>|<p>**Expression**: {Template Virt VMware Hypervisor ESXi - Andre Bello:vmware.hv.datastore.size[{$URL},Template Virt VMware Hypervisor ESXi - Andre Bello,{#DATASTORE},pfree].last()}<15</p><p>**Recovery expression**: </p>|average|
|{#DATASTORE} is  90% Used (LLD)|<p>-</p>|<p>**Expression**: {Template Virt VMware Hypervisor ESXi - Andre Bello:vmware.hv.datastore.size[{$URL},Template Virt VMware Hypervisor ESXi - Andre Bello,{#DATASTORE},pfree].last()}<10</p><p>**Recovery expression**: </p>|high|
|{#DATASTORE} is  95% Used (LLD)|<p>-</p>|<p>**Expression**: {Template Virt VMware Hypervisor ESXi - Andre Bello:vmware.hv.datastore.size[{$URL},Template Virt VMware Hypervisor ESXi - Andre Bello,{#DATASTORE},pfree].last()}<5</p><p>**Recovery expression**: </p>|disaster|
