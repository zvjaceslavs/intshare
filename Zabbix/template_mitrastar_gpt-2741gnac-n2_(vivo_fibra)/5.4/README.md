...
|----|-----------|----------|--------|
|Indisponibilidade - interface {#IFDESCR}|<p>-</p>|<p>**Expression**: ({TRIGGER.VALUE}=0 and last(/MitraStar - GPT-2741GNAC-N2/ifAdminStatus[{#IFDESCR}])=1 and last(/MitraStar - GPT-2741GNAC-N2/ifOperStatus[{#IFDESCR}])<>1 and last(/MitraStar - GPT-2741GNAC-N2/ifOperStatus[{#IFDESCR}],#2)=1) or ({TRIGGER.VALUE}=1 and last(/MitraStar - GPT-2741GNAC-N2/ifAdminStatus[{#IFDESCR}])=1 and last(/MitraStar - GPT-2741GNAC-N2/ifOperStatus[{#IFDESCR}])<>1)</p><p>**Recovery expression**: </p>|average|
|Descartes de pacote de entrada - interface {#IFDESCR}|<p>-</p>|<p>**Expression**: last(/MitraStar - GPT-2741GNAC-N2/ifInDiscards.[{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|warning|
|Erros de entrada - interface {#IFDESCR}|<p>-</p>|<p>**Expression**: last(/MitraStar - GPT-2741GNAC-N2/ifInErrors[{#IFDESCR}])>50</p><p>**Recovery expression**: </p>|warning|
|Descartes de pacote de saída - interface {#IFDESCR}|<p>-</p>|<p>**Expression**: last(/MitraStar - GPT-2741GNAC-N2/ifOutDiscards[{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|warning|
|Erros de saída - interface {#IFDESCR}|<p>-</p>|<p>**Expression**: last(/MitraStar - GPT-2741GNAC-N2/ifOutErrors[{#IFDESCR}])>50</p><p>**Recovery expression**: </p>|warning|
|Indisponibilidade - interface {#IFDESCR} (LLD)|<p>-</p>|<p>**Expression**: ({TRIGGER.VALUE}=0 and last(/MitraStar - GPT-2741GNAC-N2/ifAdminStatus[{#IFDESCR}])=1 and last(/MitraStar - GPT-2741GNAC-N2/ifOperStatus[{#IFDESCR}])<>1 and last(/MitraStar - GPT-2741GNAC-N2/ifOperStatus[{#IFDESCR}],#2)=1) or ({TRIGGER.VALUE}=1 and last(/MitraStar - GPT-2741GNAC-N2/ifAdminStatus[{#IFDESCR}])=1 and last(/MitraStar - GPT-2741GNAC-N2/ifOperStatus[{#IFDESCR}])<>1)</p><p>**Recovery expression**: </p>|average|
|Descartes de pacote de entrada - interface {#IFDESCR} (LLD)|<p>-</p>|<p>**Expression**: last(/MitraStar - GPT-2741GNAC-N2/ifInDiscards.[{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|warning|
|Erros de entrada - interface {#IFDESCR} (LLD)|<p>-</p>|<p>**Expression**: last(/MitraStar - GPT-2741GNAC-N2/ifInErrors[{#IFDESCR}])>50</p><p>**Recovery expression**: </p>|warning|
|Descartes de pacote de saída - interface {#IFDESCR} (LLD)|<p>-</p>|<p>**Expression**: last(/MitraStar - GPT-2741GNAC-N2/ifOutDiscards[{#IFDESCR}])>10</p><p>**Recovery expression**: </p>|warning|
|Erros de saída - interface {#IFDESCR} (LLD)|<p>-</p>|<p>**Expression**: last(/MitraStar - GPT-2741GNAC-N2/ifOutErrors[{#IFDESCR}])>50</p><p>**Recovery expression**: </p>|warning|
