...
|Temperature of {#SNMPVALUE} on {HOST.NAME} is over {$HD_TEMPERATURE_WARNING} for 2min|<p>-</p>|<p>**Expression**: {SNMP QNAP NAS:HdTemperatureEX[{#SNMPINDEX}].min(2m)}>45</p><p>**Recovery expression**: </p>|information|
