...
Each virtual_server requires a definition of a virtualhost name because it is used in Discovery as the {#SNMPVALUE} variable:
	...
	3.2 Value Mappings
The Value Mappings are included in the Zabbix 3+ templates.  These are identical to those specified for manual configuration in previous versions of these templates.
