...
|----|-----------|----------|--------|
|{#SERVICE.DISPLAYNAME} ({#SERVICE.NAME}) {#SERVICE.STATENAME} on {HOST.NAME} and be able to extract {#SERVICE.NAME} from it|<p>-</p>|<p>**Expression**: {Template Microsoft Exchange Server 2016 - Services:service_state[{#SERVICE.NAME},state].last()}<>0</p><p>**Recovery expression**: {Template Microsoft Exchange Server 2016 - Services:service_state[{#SERVICE.NAME},state].last()}<>0</p>|not classified|
|{#SERVICE.DISPLAYNAME} ({#SERVICE.NAME}) {#SERVICE.STATENAME} on {HOST.NAME} and be able to extract {#SERVICE.NAME} from it (LLD)|<p>-</p>|<p>**Expression**: {Template Microsoft Exchange Server 2016 - Services:service_state[{#SERVICE.NAME},state].last()}<>0</p><p>**Recovery expression**: {Template Microsoft Exchange Server 2016 - Services:service_state[{#SERVICE.NAME},state].last()}<>0</p>|not classified|
