...
|Drive {#SNMPINDEX} Serial Number (LLD)|<p>The drive's electronic serial number</p>|`SNMP agent`|slDriveSerialNum[{#SNMPINDEX}]<p>Update: 1h</p>|
|Drive {#SNMPINDEX} State (LLD)|<p>The drive's state (empty, loaded, needs cleaning, etc)</p>|`SNMP agent`|slDriveState[{#SNMPINDEX}]<p>Update: 1m</p>|
|Fan {#SNMPINDEX} Status (LLD)|<p>Operational state of the fan failed(1), normal(2)</p>|`SNMP agent`|slFanOperational[{#SNMPINDEX}]<p>Update: 1m</p>|
|Cleaning cartridge type {#SNMPINDEX} (LLD)|<p>Cleaning cartridge type (DLT, 9840, LTO, etc)</p>|`SNMP agent`|slLibCleanWarnCartType[{#SNMPINDEX}]<p>Update: 1m</p>|
|Power Supply Name {#SNMPINDEX} (LLD)|<p>Name of the power supply</p>|`SNMP agent`|slPowerSupplyName[{#SNMPINDEX}]<p>Update: 1h</p>|
|Power Supply {#SNMPINDEX} is Operational (LLD)|<p>Indicates if the supply is OK(2), meaningless if not-installed</p>|`SNMP agent`|slPowerSupplyOperational[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot's {#SNMPINDEX} Code Version (LLD)|<p>The robot's code version</p>|`SNMP agent`|slRobotCodeVer[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot {#SNMPINDEX} Fault LED (LLD)|<p>The Robot's Fault LED status off=0, on=1</p>|`SNMP agent`|slRobotFaultLED[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot {#SNMPINDEX} Version (LLD)|<p>The robot's hardware version</p>|`SNMP agent`|slRobotVersion[{#SNMPINDEX}]<p>Update: 1h</p>|
|Tape {#SNMPINDEX} Physical Address (LLD)|<p>Tape Cartridge physical address string</p>|`SNMP agent`|slTapePhysicalAddressStr[{#SNMPINDEX}]<p>Update: 1h</p>|
|Current temperature of {#SNMPINDEX} (LLD)|<p>Current/Present temperature reading</p>|`SNMP agent`|slTempSensorCurrentTemp[{#SNMPINDEX}]<p>Update: 1m</p>|
|Controller {#SNMPINDEX} Fault LED (LLD)|<p>The Controller's Fault LED state off=0, on=1</p>|`SNMP agent`|slControllerFaultLED[{#SNMPINDEX}]<p>Update: 1m</p>|
|Controller {#SNMPINDEX} Field Replaceable Unit (FRU) (LLD)|<p>The controller's Field Replaceable Unit (FRU) based serial number</p>|`SNMP agent`|slControllerFru[{#SNMPINDEX}]<p>Update: 1h</p>|
|Controller {#SNMPINDEX} Safe To Remove LED (LLD)|<p>The Controller's safe to remove LED state</p>|`SNMP agent`|slControllerSafeToRemoveLED[{#SNMPINDEX}]<p>Update: 1m</p>|
|Controller {#SNMPINDEX} Top Level Condition (LLD)|<p>The Controller's top-level condition (normal, degraded, notoperative) normal(0), degraded(1), notoperative(2)</p>|`SNMP agent`|slControllerTopLevelCondition[{#SNMPINDEX}]<p>Update: 1m</p>|
...
|Drive {#SNMPINDEX} Hashed Physical Address (LLD)|<p>Hashed Physical Address of the drive. NOTE: SL500 returns a logical SCSI Element ID" -- NOTE: For backwards compatibility, the SL500 will continue to return a -- logical SCSI Element ID in lieu of a physical address.</p>|`SNMP agent`|slDriveHashedPhysAddr[{#SNMPINDEX}]<p>Update: 1h</p>|
|Drive {#SNMPINDEX} Idle Seconds (LLD)|<p>Number of seconds that the drive has been idle (unmounted)</p>|`SNMP agent`|slDriveIdleSeconds[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Interface Type (LLD)|<p>The drive's physical data transport type</p>|`SNMP agent`|slDriveInterfaceType[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} LED (LLD)|<p>The drive's Tray LED sate (1=on,0=off)</p>|`SNMP agent`|slDriveLED[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Num Mounts (LLD)|<p>Number of mounts to the drive</p>|`SNMP agent`|slDriveNumMounts[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Put Retries (LLD)|<p>The number of dismount retries performed to the drive</p>|`SNMP agent`|slDrivePutRetries[{#SNMPINDEX}]<p>Update: 1m</p>|
|Drive {#SNMPINDEX} Type (LLD)|<p>The drive's type, e.g. STK9840, HpUltrium4, etc." -- This text string is derived by the manufacturer and make of the drive. -- Please refer to the "Specification for Tape Cartridge Media Identification" -- Sun/Oracle Doc No. 3136715</p>|`SNMP agent`|slDriveType[{#SNMPINDEX}]<p>Update: 1h</p>|
|Cart {#SNMPINDEX} Host Accessible Status (LLD)|<p>Indication of host accessible status</p>|`SNMP agent`|slLibCleanCartHostAccessible[{#SNMPINDEX}]<p>Update: 1m</p>|
|Clean Cartridge Label {#SNMPINDEX} (LLD)|<p>The clean cartridge label</p>|`SNMP agent`|slLibCleanCartLabel[{#SNMPINDEX}]<p>Update: 1m</p>|
...
|Tape {#SNMPINDEX} Host Accessible (LLD)|<p>Indication of host accessible status</p>|`SNMP agent`|slTapeHostAccessible[{#SNMPINDEX}]<p>Update: 1m</p>|
|Tape {#SNMPINDEX} Location Element ID (LLD)|<p>Element ID or translated logical HLI Address of the tape cartridge</p>|`SNMP agent`|slTapeLocationElementID[{#SNMPINDEX}]<p>Update: 1h</p>|
|Tape {#SNMPINDEX} Logical Address (LLD)|<p>Tape Cartridge logical address string</p>|`SNMP agent`|slTapeLogicalAddressStr[{#SNMPINDEX}]<p>Update: 1h</p>|
|Tape {#SNMPINDEX} Partition ID (LLD)|<p>Tape Cartridge partition ID</p>|`SNMP agent`|slTapePartition[{#SNMPINDEX}]<p>Update: 1d</p>|
|Tape {#SNMPINDEX} Partition Type (LLD)|<p>Tape Cartridge partition type hli(1), scsi(2), other(3)</p>|`SNMP agent`|slTapePartitionType[{#SNMPINDEX}]<p>Update: 1d</p>|
|Temperature Sensor's Name {#SNMPINDEX} (LLD)|<p>Name of the temperature sensor</p>|`SNMP agent`|slTempSensorName[{#SNMPINDEX}]<p>Update: 1m</p>|
|Warn Threshold {#SNMPINDEX} (LLD)|<p>Temp threshold for automated warning</p>|`SNMP agent`|slTempSensorWarnThreshold[{#SNMPINDEX}]<p>Update: 1m</p>|
|Cap {#SNMPINDEX} Name (LLD)|<p>The CAP name</p>|`SNMP agent`|slCapName[{#SNMPINDEX}]<p>Update: 1h</p>|
|Cap {#SNMPINDEX} Physical Address (LLD)|<p>CAP physical address string. NOTE: SL500 returns a logical SCSI Element ID" -- NOTE: For backwards compatibility, the SL500 will continue to return a -- logical SCSI Element ID in lieu of a physical address.</p>|`SNMP agent`|slCapPhysicalAddressStr[{#SNMPINDEX}]<p>Update: 1h</p>|
|Fan Name {#SNMPINDEX} (LLD)|<p>Name of the fan</p>|`SNMP agent`|slFanName[{#SNMPINDEX}]<p>Update: 1h</p>|
|Number of Mount Retries by Robot {#SNMPINDEX} (LLD)|<p>The number of mount retries performed by the robot</p>|`SNMP agent`|slRobotGetRetries[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot's Hand State {#SNMPINDEX} (LLD)|<p>The Robot's hand state (cartridge=1, no cartridge=0)</p>|`SNMP agent`|slRobotHandCartStatus[{#SNMPINDEX}]<p>Update: 1m</p>|
|Robot Physical Address {#SNMPINDEX} (LLD)|<p>Robot physical address string. NOTE: SL500 returns a logical SCSI Element ID</p>|`SNMP agent`|slRobotPhysicalAddressStr[{#SNMPINDEX}]<p>Update: 1m</p>|
...
|----|-----------|----------|--------|
|Controller {#SNMPINDEX} has an Error Status|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slControllerStatusEnum[{#SNMPINDEX}].last()}=1</p><p>**Recovery expression**: </p>|high|
|Controller {#SNMPINDEX} has an Info Status|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slControllerStatusEnum[{#SNMPINDEX}].last()}=3</p><p>**Recovery expression**: </p>|information|
|Controller {#SNMPINDEX} has an Warning Status|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slControllerStatusEnum[{#SNMPINDEX}].last()}=2</p><p>**Recovery expression**: </p>|warning|
|Controller {#SNMPINDEX} Fault Led is On|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slControllerFaultLED[{#SNMPINDEX}].last()}=1</p><p>**Recovery expression**: </p>|high|
|Drive {#SNMPINDEX} Needs Cleaning|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slDriveState[{#SNMPINDEX}].str("needs cleaning")}=1</p><p>**Recovery expression**: </p>|high|
|Fan {#SNMPINDEX} has an Error Status|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slFanOperational[{#SNMPINDEX}].last()}=1</p><p>**Recovery expression**: </p>|high|
|The cartridge {#SNMPINDEX} has been used to clean is over than 40 times|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slLibCleanCartUsageCount[{#SNMPINDEX}].last()}>=40</p><p>**Recovery expression**: </p>|high|
|Robot {#SNMPINDEX} Fault Led is On|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slRobotFaultLED[{#SNMPINDEX}].last()}=1</p><p>**Recovery expression**: </p>|high|
|Error Operational Status by Robot {#SNMPINDEX}|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slRobotStatusEnum[{#SNMPINDEX}].last()}=1</p><p>**Recovery expression**: </p>|high|
|Warning Operational Status by Robot {#SNMPINDEX}|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slRobotStatusEnum[{#SNMPINDEX}].last()}=2</p><p>**Recovery expression**: </p>|average|
|Tape Library is Going to Shutdown Soon|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slTempSensorCurrentTemp[{#SNMPINDEX}].last()}>=67</p><p>**Recovery expression**: </p>|disaster|
|The Current Temperature of Drive [{#SNMPINDEX}] is Very High|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slTempSensorCurrentTemp[{#SNMPINDEX}].last()}>=63</p><p>**Recovery expression**: </p>|high|
|Drive {#SNMPINDEX} Needs Cleaning (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slDriveState[{#SNMPINDEX}].str("needs cleaning")}=1</p><p>**Recovery expression**: </p>|high|
|Fan {#SNMPINDEX} has an Error Status (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slFanOperational[{#SNMPINDEX}].last()}=1</p><p>**Recovery expression**: </p>|high|
|Robot {#SNMPINDEX} Fault Led is On (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slRobotFaultLED[{#SNMPINDEX}].last()}=1</p><p>**Recovery expression**: </p>|high|
|Tape Library is Going to Shutdown Soon (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slTempSensorCurrentTemp[{#SNMPINDEX}].last()}>=67</p><p>**Recovery expression**: </p>|disaster|
|The Current Temperature of Drive [{#SNMPINDEX}] is Very High (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slTempSensorCurrentTemp[{#SNMPINDEX}].last()}>=63</p><p>**Recovery expression**: </p>|high|
|Controller {#SNMPINDEX} Fault Led is On (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slControllerFaultLED[{#SNMPINDEX}].last()}=1</p><p>**Recovery expression**: </p>|high|
|The cartridge {#SNMPINDEX} has been used to clean is over than 40 times (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slLibCleanCartUsageCount[{#SNMPINDEX}].last()}>=40</p><p>**Recovery expression**: </p>|high|
|Error Operational Status by Robot {#SNMPINDEX} (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slRobotStatusEnum[{#SNMPINDEX}].last()}=1</p><p>**Recovery expression**: </p>|high|
|Warning Operational Status by Robot {#SNMPINDEX} (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slRobotStatusEnum[{#SNMPINDEX}].last()}=2</p><p>**Recovery expression**: </p>|average|
|Controller {#SNMPINDEX} has an Error Status (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slControllerStatusEnum[{#SNMPINDEX}].last()}=1</p><p>**Recovery expression**: </p>|high|
|Controller {#SNMPINDEX} has an Info Status (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slControllerStatusEnum[{#SNMPINDEX}].last()}=3</p><p>**Recovery expression**: </p>|information|
|Controller {#SNMPINDEX} has an Warning Status (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP Tape Library Oracle StorageTek SL150:slControllerStatusEnum[{#SNMPINDEX}].last()}=2</p><p>**Recovery expression**: </p>|warning|
