...
|----|-----------|----------|--------|
|An Alarm has been detected: ID {last(/Template Schneider UPS/upsAlarmId[{#ALARM}])}|<p>{last(/Template Schneider UPS/upsAlarmDescr[{#ALARM}])} {last(/Template Schneider UPS/upsAlarmTime[{#ALARM}])}</p>|<p>**Expression**: last(/Schneider UPS/upsAlarmId[{#ALARM}])>0</p><p>**Recovery expression**: </p>|warning|
|No power has been detected on input n°{#INDEX}|<p>-</p>|<p>**Expression**: last(/Schneider UPS/upsInputVoltage[{#INDEX}])=0</p><p>**Recovery expression**: </p>|high|
|No power has been detected on input n°{#INDEX} (LLD)|<p>-</p>|<p>**Expression**: last(/Schneider UPS/upsInputVoltage[{#INDEX}])=0</p><p>**Recovery expression**: </p>|high|
|An Alarm has been detected: ID {last(/Template Schneider UPS/upsAlarmId[{#ALARM}])} (LLD)|<p>{last(/Template Schneider UPS/upsAlarmDescr[{#ALARM}])} {last(/Template Schneider UPS/upsAlarmTime[{#ALARM}])}</p>|<p>**Expression**: last(/Schneider UPS/upsAlarmId[{#ALARM}])>0</p><p>**Recovery expression**: </p>|warning|
