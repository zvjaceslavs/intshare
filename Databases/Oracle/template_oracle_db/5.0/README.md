...
|----|-----------|----------|--------|
|Session {#SID} is devouring CPU!|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.odbc.select[Host CPU Utilization,].last()}>=60 and {Template Oracle DB:db.odbc.select[session {#SID} CPU time,].last()}>=0.7</p><p>**Recovery expression**: </p>|high|
|Session {#SID} is eating CPU!|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.odbc.select[Host CPU Utilization,].last()}>=60 and {Template Oracle DB:db.odbc.select[session {#SID} CPU time,].last()}>=0.6</p><p>**Recovery expression**: </p>|average|
|Session {#SID} is hogging CPU!|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.odbc.select[Host CPU Utilization,].last()}>=50 and {Template Oracle DB:db.odbc.select[session {#SID} CPU time,].last()}>=0.5</p><p>**Recovery expression**: </p>|warning|
|ASM disk {#DISK_NAME} extremely low free space => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:oracle.db.disk.pct_free[{#DISK_NAME}].last()} * 1.0 <=5</p><p>**Recovery expression**: </p>|high|
|ASM disk {#DISK_NAME} is => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:oracle.asm.disk.state[{#DISK_NAME}].last()}<>1</p><p>**Recovery expression**: </p>|disaster|
|ASM disk {#DISK_NAME} low free space => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:oracle.db.disk.pct_free[{#DISK_NAME}].last()} * 1.0 <=15</p><p>**Recovery expression**: </p>|warning|
|ASM disk {#DISK_NAME} very low free space => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:oracle.db.disk.pct_free[{#DISK_NAME}].last()} * 1.0 <=10</p><p>**Recovery expression**: </p>|average|
|ASM disk {#DISK_NAME} zero free space|<p>-</p>|<p>**Expression**: {Template Oracle DB:oracle.db.disk.pct_free[{#DISK_NAME}].last()} <=0.01</p><p>**Recovery expression**: </p>|disaster|
|Session {#SID} is an intensive blocker|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.odbc.select[waiting time - {#SID},].last()}>20</p><p>**Recovery expression**: </p>|warning|
|FRA is almost full => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.fra.pct_used[{#NAME}].last()} * 1.0 >= 95</p><p>**Recovery expression**: </p>|high|
|FRA is full => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.fra.pct_used[{#NAME}].last()}=100</p><p>**Recovery expression**: </p>|disaster|
|FRA space usage is high => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.fra.pct_used[{#NAME}].last()} * 1.0 >=85</p><p>**Recovery expression**: </p>|warning|
|FRA space usage is very high => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.fra.pct_used[{#NAME}].last()} * 1.0 >=90</p><p>**Recovery expression**: </p>|average|
|Tablespace {#TABLESPACE_NAME} almost full => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.tablespace.pct_used[{#TABLESPACE_NAME}].last()} >= 95 * 1.0 and {Template Oracle DB:db.oracle.tablespace.contents[{#TABLESPACE_NAME}].last()}=1</p><p>**Recovery expression**: </p>|high|
|Tablespace {#TABLESPACE_NAME} full => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.tablespace.pct_used[{#TABLESPACE_NAME}].last()}=100 and {Template Oracle DB:db.oracle.tablespace.contents[{#TABLESPACE_NAME}].last()}=1</p><p>**Recovery expression**: </p>|disaster|
|Tablespace {#TABLESPACE_NAME} space usage is high => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.tablespace.pct_used[{#TABLESPACE_NAME}].last()} >= 85 * 1.0 and {Template Oracle DB:db.oracle.tablespace.contents[{#TABLESPACE_NAME}].last()}=1</p><p>**Recovery expression**: </p>|warning|
|Tablespace {#TABLESPACE_NAME} space usage is very high => {ITEM.VALUE1}|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.tablespace.pct_used[{#TABLESPACE_NAME}].last()} >= 90 * 1.0 and {Template Oracle DB:db.oracle.tablespace.contents[{#TABLESPACE_NAME}].last()}=1</p><p>**Recovery expression**: </p>|average|
|Long waiting session: {#SID} => {ITEM.LASTVALUE} seconds|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.odbc.select[session {#SID} wait time,].last()}>300</p><p>**Recovery expression**: </p>|warning|
|Session {#SID} is devouring CPU! (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.odbc.select[Host CPU Utilization,].last()}>=60 and {Template Oracle DB:db.odbc.select[session {#SID} CPU time,].last()}>=0.7</p><p>**Recovery expression**: </p>|high|
|Session {#SID} is eating CPU! (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.odbc.select[Host CPU Utilization,].last()}>=60 and {Template Oracle DB:db.odbc.select[session {#SID} CPU time,].last()}>=0.6</p><p>**Recovery expression**: </p>|average|
|Session {#SID} is hogging CPU! (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.odbc.select[Host CPU Utilization,].last()}>=50 and {Template Oracle DB:db.odbc.select[session {#SID} CPU time,].last()}>=0.5</p><p>**Recovery expression**: </p>|warning|
|ASM disk {#DISK_NAME} extremely low free space => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:oracle.db.disk.pct_free[{#DISK_NAME}].last()} * 1.0 <=5</p><p>**Recovery expression**: </p>|high|
|ASM disk {#DISK_NAME} is => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:oracle.asm.disk.state[{#DISK_NAME}].last()}<>1</p><p>**Recovery expression**: </p>|disaster|
|ASM disk {#DISK_NAME} low free space => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:oracle.db.disk.pct_free[{#DISK_NAME}].last()} * 1.0 <=15</p><p>**Recovery expression**: </p>|warning|
|ASM disk {#DISK_NAME} very low free space => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:oracle.db.disk.pct_free[{#DISK_NAME}].last()} * 1.0 <=10</p><p>**Recovery expression**: </p>|average|
|ASM disk {#DISK_NAME} zero free space (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:oracle.db.disk.pct_free[{#DISK_NAME}].last()} <=0.01</p><p>**Recovery expression**: </p>|disaster|
|Session {#SID} is an intensive blocker (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.odbc.select[waiting time - {#SID},].last()}>20</p><p>**Recovery expression**: </p>|warning|
|FRA is almost full => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.fra.pct_used[{#NAME}].last()} * 1.0 >= 95</p><p>**Recovery expression**: </p>|high|
|FRA is full => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.fra.pct_used[{#NAME}].last()}=100</p><p>**Recovery expression**: </p>|disaster|
|FRA space usage is high => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.fra.pct_used[{#NAME}].last()} * 1.0 >=85</p><p>**Recovery expression**: </p>|warning|
|FRA space usage is very high => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.fra.pct_used[{#NAME}].last()} * 1.0 >=90</p><p>**Recovery expression**: </p>|average|
|Tablespace {#TABLESPACE_NAME} almost full => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.tablespace.pct_used[{#TABLESPACE_NAME}].last()} >= 95 * 1.0 and {Template Oracle DB:db.oracle.tablespace.contents[{#TABLESPACE_NAME}].last()}=1</p><p>**Recovery expression**: </p>|high|
|Tablespace {#TABLESPACE_NAME} full => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.tablespace.pct_used[{#TABLESPACE_NAME}].last()}=100 and {Template Oracle DB:db.oracle.tablespace.contents[{#TABLESPACE_NAME}].last()}=1</p><p>**Recovery expression**: </p>|disaster|
|Tablespace {#TABLESPACE_NAME} space usage is high => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.tablespace.pct_used[{#TABLESPACE_NAME}].last()} >= 85 * 1.0 and {Template Oracle DB:db.oracle.tablespace.contents[{#TABLESPACE_NAME}].last()}=1</p><p>**Recovery expression**: </p>|warning|
|Tablespace {#TABLESPACE_NAME} space usage is very high => {ITEM.VALUE1} (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.oracle.tablespace.pct_used[{#TABLESPACE_NAME}].last()} >= 90 * 1.0 and {Template Oracle DB:db.oracle.tablespace.contents[{#TABLESPACE_NAME}].last()}=1</p><p>**Recovery expression**: </p>|average|
|Long waiting session: {#SID} => {ITEM.LASTVALUE} seconds (LLD)|<p>-</p>|<p>**Expression**: {Template Oracle DB:db.odbc.select[session {#SID} wait time,].last()}>300</p><p>**Recovery expression**: </p>|warning|
