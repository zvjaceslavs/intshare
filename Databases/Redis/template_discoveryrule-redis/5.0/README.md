...
|Check Redis Port {#PORT}|<p>-</p>|`Zabbix agent`|net.tcp.listen[{#PORT}]<p>Update: 60</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},role]<p>Update: 120</p><p>LLD</p>|
|Check Memory Usage {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},used_memory:]<p>Update: 60</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},used_cpu_user:]<p>Update: 60</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},used_cpu_sys:]<p>Update: 60</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},uptime_in_seconds]<p>Update: 120</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},total_connections_received]<p>Update: 120</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},total_commands_processed]<p>Update: 120</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},last_save_time]<p>Update: 120</p><p>LLD</p>|
|Number of DB {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[db,{#REDIS},{#IP},{#PORT}]<p>Update: 60</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},expired_keys]<p>Update: 120</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},evicted_keys]<p>Update: 120</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},connected_slave]<p>Update: 120</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},connected_clients]<p>Update: 120</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},blocked_clients]<p>Update: 120</p><p>LLD</p>|
|Number of DB record {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[size,{#REDIS},{#IP},{#PORT}]<p>Update: 60</p><p>LLD</p>|
|Ping {#REDIS} ip:{#IP} port:{#PORT}|<p>-</p>|`Zabbix agent`|REDIS[ping,{#REDIS},{#IP},{#PORT}]<p>Update: 60</p><p>LLD</p>|
|Check $5 {#REDIS}|<p>-</p>|`Zabbix agent`|REDIS[status,{#REDIS},{#IP},{#PORT},used_memory_rss:]<p>Update: 120</p><p>LLD</p>|
## Triggers
