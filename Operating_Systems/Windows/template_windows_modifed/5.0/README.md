...
|----|-----------|----------|--------|
|Service "{#SERVICE.NAME}" ({#SERVICE.DISPLAYNAME}) is not running (startup type {#SERVICE.STARTUPNAME})|<p>-</p>|<p>**Expression**: {OS Windows:service.info[{#SERVICE.NAME},state].min(#3)}<>0</p><p>**Recovery expression**: </p>|average|
...
|Service "{#SERVICE.NAME}" ({#SERVICE.DISPLAYNAME}) is not running (startup type {#SERVICE.STARTUPNAME}) (LLD)|<p>-</p>|<p>**Expression**: {OS Windows:service.info[{#SERVICE.NAME},state].min(#3)}<>0</p><p>**Recovery expression**: </p>|average|
