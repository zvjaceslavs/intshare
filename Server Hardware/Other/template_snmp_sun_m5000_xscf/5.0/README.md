...
|----|-----------|----------|--------|
|CPU {#BOARDID}-{#MODULEID} Faulted|<p>-</p>|<p>**Expression**: {Template SNMP XSCF Sun M5000:cpu.status[{#BOARDID}-{#MODULEID}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|Fan #{$BOARDID} Failed|<p>-</p>|<p>**Expression**: {Template SNMP XSCF Sun M5000:fan.status[{#BOARDID}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|Memory unit {#BOARDID} Faulted|<p>-</p>|<p>**Expression**: {Template SNMP XSCF Sun M5000:mem.statsu[{#BOARDID}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|Memory Board #{#ID} Faulted|<p>-</p>|<p>**Expression**: {Template SNMP XSCF Sun M5000:memb.status[{#ID}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|Power Supply #{#BOARDID} Faulted|<p>-</p>|<p>**Expression**: {Template SNMP XSCF Sun M5000:psu.status[{#BOARDID}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|Memory unit {#BOARDID} Faulted (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP XSCF Sun M5000:mem.statsu[{#BOARDID}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|Power Supply #{#BOARDID} Faulted (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP XSCF Sun M5000:psu.status[{#BOARDID}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|Memory Board #{#ID} Faulted (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP XSCF Sun M5000:memb.status[{#ID}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|CPU {#BOARDID}-{#MODULEID} Faulted (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP XSCF Sun M5000:cpu.status[{#BOARDID}-{#MODULEID}].last()}<>1</p><p>**Recovery expression**: </p>|high|
|Fan #{$BOARDID} Failed (LLD)|<p>-</p>|<p>**Expression**: {Template SNMP XSCF Sun M5000:fan.status[{#BOARDID}].last()}<>1</p><p>**Recovery expression**: </p>|high|
