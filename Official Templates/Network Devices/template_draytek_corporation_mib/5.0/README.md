...
|dskErrorMsg for {#SNMPINDEX} (LLD)|<p>A text description providing a warning and the space left on the disk.</p>|`SNMP agent`|dskErrorMsg[{#SNMPINDEX}]<p>Update: 60</p>|
|dskUsed for {#SNMPINDEX} (LLD)|<p>Used space on the disk. For large heavily-used disks (>2Tb), this value will latch at INT32_MAX (2147483647).</p>|`SNMP agent`|dskUsed[{#SNMPINDEX}]<p>Update: 60</p>|
|dskPath for {#SNMPINDEX} (LLD)|<p>Path where the disk is mounted.</p>|`SNMP agent`|dskPath[{#SNMPINDEX}]<p>Update: 60</p>|
|dskDevice for {#SNMPINDEX} (LLD)|<p>Path of the device for the partition</p>|`SNMP agent`|dskDevice[{#SNMPINDEX}]<p>Update: 60</p>|
|dskMinimum for {#SNMPINDEX} (LLD)|<p>Minimum space required on the disk (in kBytes) before the errors are triggered. Either this or dskMinPercent is configured via the agent's snmpd.conf file.</p>|`SNMP agent`|dskMinimum[{#SNMPINDEX}]<p>Update: 60</p>|
|dskMinPercent for {#SNMPINDEX} (LLD)|<p>Percentage of minimum space required on the disk before the errors are triggered. Either this or dskMinimum is configured via the agent's snmpd.conf file.</p>|`SNMP agent`|dskMinPercent[{#SNMPINDEX}]<p>Update: 60</p>|
|dskTotal for {#SNMPINDEX} (LLD)|<p>Total size of the disk/partion (kBytes). For large disks (>2Tb), this value will latch at INT32_MAX (2147483647).</p>|`SNMP agent`|dskTotal[{#SNMPINDEX}]<p>Update: 60</p>|
|dskAvail for {#SNMPINDEX} (LLD)|<p>Available space on the disk. For large lightly-used disks (>2Tb), this value will latch at INT32_MAX (2147483647).</p>|`SNMP agent`|dskAvail[{#SNMPINDEX}]<p>Update: 60</p>|
|dskPercent for {#SNMPINDEX} (LLD)|<p>Percentage of space used on disk</p>|`SNMP agent`|dskPercent[{#SNMPINDEX}]<p>Update: 60</p>|
|dskErrorFlag for {#SNMPINDEX} (LLD)|<p>Error flag signaling that the disk or partition is under the minimum required space configured for it.</p>|`SNMP agent`|dskErrorFlag[{#SNMPINDEX}]<p>Update: 60</p>|
|dskPercentNode for {#SNMPINDEX} (LLD)|<p>Percentage of inodes used on disk</p>|`SNMP agent`|dskPercentNode[{#SNMPINDEX}]<p>Update: 60</p>|
|dskTotalLow for {#SNMPINDEX} (LLD)|<p>Total size of the disk/partion (kBytes). Together with dskTotalHigh composes 64-bit number.</p>|`SNMP agent`|dskTotalLow[{#SNMPINDEX}]<p>Update: 60</p>|
|dskTotalHigh for {#SNMPINDEX} (LLD)|<p>Total size of the disk/partion (kBytes). Together with dskTotalLow composes 64-bit number.</p>|`SNMP agent`|dskTotalHigh[{#SNMPINDEX}]<p>Update: 60</p>|
|dskAvailLow for {#SNMPINDEX} (LLD)|<p>Available space on the disk (kBytes). Together with dskAvailHigh composes 64-bit number.</p>|`SNMP agent`|dskAvailLow[{#SNMPINDEX}]<p>Update: 60</p>|
|dskAvailHigh for {#SNMPINDEX} (LLD)|<p>Available space on the disk (kBytes). Together with dskAvailLow composes 64-bit number.</p>|`SNMP agent`|dskAvailHigh[{#SNMPINDEX}]<p>Update: 60</p>|
|dskUsedLow for {#SNMPINDEX} (LLD)|<p>Used space on the disk (kBytes). Together with dskUsedHigh composes 64-bit number.</p>|`SNMP agent`|dskUsedLow[{#SNMPINDEX}]<p>Update: 60</p>|
|dskUsedHigh for {#SNMPINDEX} (LLD)|<p>Used space on the disk (kBytes). Together with dskUsedLow composes 64-bit number.</p>|`SNMP agent`|dskUsedHigh[{#SNMPINDEX}]<p>Update: 60</p>|
|dskIndex for {#SNMPINDEX} (LLD)|<p>Integer reference number (row number) for the disk mib.</p>|`SNMP agent`|dskIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|prErrFixCmd for {#SNMPINDEX} (LLD)|<p>The command that gets run when the prErrFix column is set to 1.</p>|`SNMP agent`|prErrFixCmd[{#SNMPINDEX}]<p>Update: 60</p>|
|prErrFix for {#SNMPINDEX} (LLD)|<p>Setting this to one will try to fix the problem if the agent has been configured with a script to call to attempt to fix problems automatically using remote snmp operations.</p>|`SNMP agent`|prErrFix[{#SNMPINDEX}]<p>Update: 60</p>|
|prErrMessage for {#SNMPINDEX} (LLD)|<p>An error message describing the problem (if one exists).</p>|`SNMP agent`|prErrMessage[{#SNMPINDEX}]<p>Update: 60</p>|
|prErrorFlag for {#SNMPINDEX} (LLD)|<p>A Error flag to indicate trouble with a process. It goes to 1 if there is an error, 0 if no error.</p>|`SNMP agent`|prErrorFlag[{#SNMPINDEX}]<p>Update: 60</p>|
|prCount for {#SNMPINDEX} (LLD)|<p>The number of current processes running with the name in question.</p>|`SNMP agent`|prCount[{#SNMPINDEX}]<p>Update: 60</p>|
|prMax for {#SNMPINDEX} (LLD)|<p>The maximum number of processes that should be running. An error flag is generated if the number of running processes is > the maximum.</p>|`SNMP agent`|prMax[{#SNMPINDEX}]<p>Update: 60</p>|
|prMin for {#SNMPINDEX} (LLD)|<p>The minimum number of processes that should be running. An error flag is generated if the number of running processes is < the minimum.</p>|`SNMP agent`|prMin[{#SNMPINDEX}]<p>Update: 60</p>|
|prNames for {#SNMPINDEX} (LLD)|<p>The process name we're counting/checking on.</p>|`SNMP agent`|prNames[{#SNMPINDEX}]<p>Update: 60</p>|
|prIndex for {#SNMPINDEX} (LLD)|<p>Reference Index for each observed process.</p>|`SNMP agent`|prIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIOBusyTime for {#SNMPINDEX} (LLD)|<p>The number of usecs the drive has been busy since boot.</p>|`SNMP agent`|diskIOBusyTime[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIONWrittenX for {#SNMPINDEX} (LLD)|<p>The number of bytes written to this device since boot.</p>|`SNMP agent`|diskIONWrittenX[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIONReadX for {#SNMPINDEX} (LLD)|<p>The number of bytes read from this device since boot.</p>|`SNMP agent`|diskIONReadX[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIOLA15 for {#SNMPINDEX} (LLD)|<p>The 15 minute average load of disk (%)</p>|`SNMP agent`|diskIOLA15[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIOLA5 for {#SNMPINDEX} (LLD)|<p>The 5 minute average load of disk (%)</p>|`SNMP agent`|diskIOLA5[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIOLA1 for {#SNMPINDEX} (LLD)|<p>The 1 minute average load of disk (%)</p>|`SNMP agent`|diskIOLA1[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIOWrites for {#SNMPINDEX} (LLD)|<p>The number of write accesses to this device since boot.</p>|`SNMP agent`|diskIOWrites[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIOReads for {#SNMPINDEX} (LLD)|<p>The number of read accesses from this device since boot.</p>|`SNMP agent`|diskIOReads[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIONWritten for {#SNMPINDEX} (LLD)|<p>The number of bytes written to this device since boot.</p>|`SNMP agent`|diskIONWritten[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIONRead for {#SNMPINDEX} (LLD)|<p>The number of bytes read from this device since boot.</p>|`SNMP agent`|diskIONRead[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIODevice for {#SNMPINDEX} (LLD)|<p>The name of the device we are counting/checking.</p>|`SNMP agent`|diskIODevice[{#SNMPINDEX}]<p>Update: 60</p>|
|diskIOIndex for {#SNMPINDEX} (LLD)|<p>Reference index for each observed device.</p>|`SNMP agent`|diskIOIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|lmVoltSensorsValue for {#SNMPINDEX} (LLD)|<p>The voltage in mV.</p>|`SNMP agent`|lmVoltSensorsValue[{#SNMPINDEX}]<p>Update: 60</p>|
|lmVoltSensorsDevice for {#SNMPINDEX} (LLD)|<p>The name of the device we are reading.</p>|`SNMP agent`|lmVoltSensorsDevice[{#SNMPINDEX}]<p>Update: 60</p>|
|lmVoltSensorsIndex for {#SNMPINDEX} (LLD)|<p>Reference index for each observed device.</p>|`SNMP agent`|lmVoltSensorsIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|dlmodStatus for {#SNMPINDEX} (LLD)|<p>The current status of the loaded module.</p>|`SNMP agent`|dlmodStatus[{#SNMPINDEX}]<p>Update: 60</p>|
|dlmodError for {#SNMPINDEX} (LLD)|<p>The last error from dlmod_load_module.</p>|`SNMP agent`|dlmodError[{#SNMPINDEX}]<p>Update: 60</p>|
|dlmodPath for {#SNMPINDEX} (LLD)|<p>The path of the module executable file.</p>|`SNMP agent`|dlmodPath[{#SNMPINDEX}]<p>Update: 60</p>|
|dlmodName for {#SNMPINDEX} (LLD)|<p>The module name.</p>|`SNMP agent`|dlmodName[{#SNMPINDEX}]<p>Update: 60</p>|
|nsExtendOutLine for {#SNMPINDEX} (LLD)|<p>A single line of output from the extension command.</p>|`SNMP agent`|nsExtendOutLine[{#SNMPINDEX}]<p>Update: 60</p>|
|nsTransactionMode for {#SNMPINDEX} (LLD)|<p>The mode number for the current operation being performed.</p>|`SNMP agent`|nsTransactionMode[{#SNMPINDEX}]<p>Update: 60</p>|
|nsExtendResult for {#SNMPINDEX} (LLD)|<p>The return value of the command.</p>|`SNMP agent`|nsExtendResult[{#SNMPINDEX}]<p>Update: 60</p>|
|nsExtendOutNumLines for {#SNMPINDEX} (LLD)|<p>The number of lines of output (and hence the number of rows in nsExtendOutputTable relating to this particular entry).</p>|`SNMP agent`|nsExtendOutNumLines[{#SNMPINDEX}]<p>Update: 60</p>|
|nsExtendOutputFull for {#SNMPINDEX} (LLD)|<p>The full output from the command, as a single string</p>|`SNMP agent`|nsExtendOutputFull[{#SNMPINDEX}]<p>Update: 60</p>|
|nsExtendOutput1Line for {#SNMPINDEX} (LLD)|<p>The first line of output from the command</p>|`SNMP agent`|nsExtendOutput1Line[{#SNMPINDEX}]<p>Update: 60</p>|
|nsModuleTimeout for {#SNMPINDEX} (LLD)|<p>The registered timeout. This is only meaningful for handlers that expect to return results at a later date (subagents, etc)</p>|`SNMP agent`|nsModuleTimeout[{#SNMPINDEX}]<p>Update: 60</p>|
|nsModuleModes for {#SNMPINDEX} (LLD)|<p>The modes that the particular lower level handler can cope with directly.</p>|`SNMP agent`|nsModuleModes[{#SNMPINDEX}]<p>Update: 60</p>|
|nsModuleName for {#SNMPINDEX} (LLD)|<p>The module name that registered this OID.</p>|`SNMP agent`|nsModuleName[{#SNMPINDEX}]<p>Update: 60</p>|
|fileErrorMsg for {#SNMPINDEX} (LLD)|<p>Filesize error message</p>|`SNMP agent`|fileErrorMsg[{#SNMPINDEX}]<p>Update: 60</p>|
|fileErrorFlag for {#SNMPINDEX} (LLD)|<p>Limit exceeded flag</p>|`SNMP agent`|fileErrorFlag[{#SNMPINDEX}]<p>Update: 60</p>|
|fileMax for {#SNMPINDEX} (LLD)|<p>Limit of filesize (kB)</p>|`SNMP agent`|fileMax[{#SNMPINDEX}]<p>Update: 60</p>|
|fileSize for {#SNMPINDEX} (LLD)|<p>Size of file (kB)</p>|`SNMP agent`|fileSize[{#SNMPINDEX}]<p>Update: 60</p>|
|fileName for {#SNMPINDEX} (LLD)|<p>Filename</p>|`SNMP agent`|fileName[{#SNMPINDEX}]<p>Update: 60</p>|
|fileIndex for {#SNMPINDEX} (LLD)|<p>Index of file</p>|`SNMP agent`|fileIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|mrModuleName for {#SNMPINDEX} (LLD)|<p>The module name that registered this OID.</p>|`SNMP agent`|mrModuleName[{#SNMPINDEX}]<p>Update: 60</p>|
|mrIndex for {#SNMPINDEX} (LLD)|<p>The registry slot of a mibmodule.</p>|`SNMP agent`|mrIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|laErrMessage for {#SNMPINDEX} (LLD)|<p>An error message describing the load-average and its surpased watch-point value.</p>|`SNMP agent`|laErrMessage[{#SNMPINDEX}]<p>Update: 60</p>|
|laErrorFlag for {#SNMPINDEX} (LLD)|<p>A Error flag to indicate the load-average has crossed its threshold value defined in the snmpd.conf file. It is set to 1 if the threshold is crossed, 0 otherwise.</p>|`SNMP agent`|laErrorFlag[{#SNMPINDEX}]<p>Update: 60</p>|
|laLoadFloat for {#SNMPINDEX} (LLD)|<p>The 1,5 and 15 minute load averages as an opaquely wrapped floating point number.</p>|`SNMP agent`|laLoadFloat[{#SNMPINDEX}]<p>Update: 60</p>|
|laLoadInt for {#SNMPINDEX} (LLD)|<p>The 1,5 and 15 minute load averages as an integer. This is computed by taking the floating point loadaverage value and multiplying by 100, then converting the value to an integer.</p>|`SNMP agent`|laLoadInt[{#SNMPINDEX}]<p>Update: 60</p>|
|laConfig for {#SNMPINDEX} (LLD)|<p>The watch point for load-averages to signal an error. If the load averages rises above this value, the laErrorFlag below is set.</p>|`SNMP agent`|laConfig[{#SNMPINDEX}]<p>Update: 60</p>|
|laLoad for {#SNMPINDEX} (LLD)|<p>The 1,5 and 15 minute load averages (one per row).</p>|`SNMP agent`|laLoad[{#SNMPINDEX}]<p>Update: 60</p>|
|laNames for {#SNMPINDEX} (LLD)|<p>The list of loadave names we're watching.</p>|`SNMP agent`|laNames[{#SNMPINDEX}]<p>Update: 60</p>|
|laIndex for {#SNMPINDEX} (LLD)|<p>reference index/row number for each observed loadave.</p>|`SNMP agent`|laIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|nsCacheStatus for {#SNMPINDEX} (LLD)|<p>The current status of this particular cache entry. Acceptable values for Set requests are 'enabled(1)', 'disabled(2)' or 'empty(3)' (to clear all cached data). Requests to read the value of such an object will return 'disabled(2)' through to 'expired(5)'.</p>|`SNMP agent`|nsCacheStatus[{#SNMPINDEX}]<p>Update: 60</p>|
|nsCacheTimeout for {#SNMPINDEX} (LLD)|<p>The length of time (?in seconds) for which the data in this particular cache entry will remain valid.</p>|`SNMP agent`|nsCacheTimeout[{#SNMPINDEX}]<p>Update: 60</p>|
|netSnmpPassOID for {#SNMPINDEX} (LLD)|<p>Example OID (table) object.</p>|`SNMP agent`|netSnmpPassOID[{#SNMPINDEX}]<p>Update: 60</p>|
|netSnmpPassInteger for {#SNMPINDEX} (LLD)|<p>Example Integer (table) object.</p>|`SNMP agent`|netSnmpPassInteger[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchRegExCompilation for {#SNMPINDEX} (LLD)|<p>message of regex precompilation</p>|`SNMP agent`|logMatchRegExCompilation[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchErrorFlag for {#SNMPINDEX} (LLD)|<p>errorflag: is this line configured correctly?</p>|`SNMP agent`|logMatchErrorFlag[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchCycle for {#SNMPINDEX} (LLD)|<p>time between updates (if not queried) in seconds</p>|`SNMP agent`|logMatchCycle[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchCount for {#SNMPINDEX} (LLD)|<p>Description.</p>|`SNMP agent`|logMatchCount[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchCounter for {#SNMPINDEX} (LLD)|<p>Regex match counter. This counter will be reset with each read</p>|`SNMP agent`|logMatchCounter[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchCurrentCount for {#SNMPINDEX} (LLD)|<p>Description.</p>|`SNMP agent`|logMatchCurrentCount[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchCurrentCounter for {#SNMPINDEX} (LLD)|<p>Regex match counter. This counter will be reset with each logfile rotation.</p>|`SNMP agent`|logMatchCurrentCounter[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchGlobalCount for {#SNMPINDEX} (LLD)|<p>Description.</p>|`SNMP agent`|logMatchGlobalCount[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchGlobalCounter for {#SNMPINDEX} (LLD)|<p>global count of matches</p>|`SNMP agent`|logMatchGlobalCounter[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchRegEx for {#SNMPINDEX} (LLD)|<p>regular expression</p>|`SNMP agent`|logMatchRegEx[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchFilename for {#SNMPINDEX} (LLD)|<p>filename to be logmatched</p>|`SNMP agent`|logMatchFilename[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchName for {#SNMPINDEX} (LLD)|<p>logmatch instance name</p>|`SNMP agent`|logMatchName[{#SNMPINDEX}]<p>Update: 60</p>|
|logMatchIndex for {#SNMPINDEX} (LLD)|<p>Index of logmatch</p>|`SNMP agent`|logMatchIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|extErrFixCmd for {#SNMPINDEX} (LLD)|<p>The command that gets run when the extErrFix column is set to 1.</p>|`SNMP agent`|extErrFixCmd[{#SNMPINDEX}]<p>Update: 60</p>|
|extErrFix for {#SNMPINDEX} (LLD)|<p>Setting this to one will try to fix the problem if the agent has been configured with a script to call to attempt to fix problems automatically using remote snmp operations.</p>|`SNMP agent`|extErrFix[{#SNMPINDEX}]<p>Update: 60</p>|
|extOutput for {#SNMPINDEX} (LLD)|<p>The first line of output of the executed command.</p>|`SNMP agent`|extOutput[{#SNMPINDEX}]<p>Update: 60</p>|
|extResult for {#SNMPINDEX} (LLD)|<p>The result code (exit status) from the executed command.</p>|`SNMP agent`|extResult[{#SNMPINDEX}]<p>Update: 60</p>|
|extCommand for {#SNMPINDEX} (LLD)|<p>The command line to be executed.</p>|`SNMP agent`|extCommand[{#SNMPINDEX}]<p>Update: 60</p>|
|extNames for {#SNMPINDEX} (LLD)|<p>A Short, one name description of the extensible command.</p>|`SNMP agent`|extNames[{#SNMPINDEX}]<p>Update: 60</p>|
|extIndex for {#SNMPINDEX} (LLD)|<p>Reference Index for extensible scripts. Simply an integer row number.</p>|`SNMP agent`|extIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|lmMiscSensorsValue for {#SNMPINDEX} (LLD)|<p>The value of this sensor.</p>|`SNMP agent`|lmMiscSensorsValue[{#SNMPINDEX}]<p>Update: 60</p>|
|lmMiscSensorsDevice for {#SNMPINDEX} (LLD)|<p>The name of the device we are reading.</p>|`SNMP agent`|lmMiscSensorsDevice[{#SNMPINDEX}]<p>Update: 60</p>|
|lmMiscSensorsIndex for {#SNMPINDEX} (LLD)|<p>Reference index for each observed device.</p>|`SNMP agent`|lmMiscSensorsIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|lmFanSensorsValue for {#SNMPINDEX} (LLD)|<p>The rotation speed of the fan in RPM.</p>|`SNMP agent`|lmFanSensorsValue[{#SNMPINDEX}]<p>Update: 60</p>|
|lmFanSensorsDevice for {#SNMPINDEX} (LLD)|<p>The name of the fan sensor we are reading.</p>|`SNMP agent`|lmFanSensorsDevice[{#SNMPINDEX}]<p>Update: 60</p>|
|lmFanSensorsIndex for {#SNMPINDEX} (LLD)|<p>Reference index for each observed device.</p>|`SNMP agent`|lmFanSensorsIndex[{#SNMPINDEX}]<p>Update: 60</p>|
|lmTempSensorsValue for {#SNMPINDEX} (LLD)|<p>The temperature of this sensor in mC.</p>|`SNMP agent`|lmTempSensorsValue[{#SNMPINDEX}]<p>Update: 60</p>|
|lmTempSensorsDevice for {#SNMPINDEX} (LLD)|<p>The name of the temperature sensor we are reading.</p>|`SNMP agent`|lmTempSensorsDevice[{#SNMPINDEX}]<p>Update: 60</p>|
|lmTempSensorsIndex for {#SNMPINDEX} (LLD)|<p>Reference index for each observed device.</p>|`SNMP agent`|lmTempSensorsIndex[{#SNMPINDEX}]<p>Update: 60</p>|
## Triggers
